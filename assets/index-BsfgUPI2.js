...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Ed(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const Ke={},ui=[],$n=()=>{},TI=()=>!1,Sc=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),wd=n=>n.startsWith("onUpdate:"),Wt=Object.assign,Td=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},II=Object.prototype.hasOwnProperty,Ge=(n,e)=>II.call(n,e),we=Array.isArray,hi=n=>Ta(n)==="[object Map]",$i=n=>Ta(n)==="[object Set]",dg=n=>Ta(n)==="[object Date]",xe=n=>typeof n=="function",mt=n=>typeof n=="string",Qn=n=>typeof n=="symbol",Ze=n=>n!==null&&typeof n=="object",Iy=n=>(Ze(n)||xe(n))&&xe(n.then)&&xe(n.catch),by=Object.prototype.toString,Ta=n=>by.call(n),bI=n=>Ta(n).slice(8,-1),Cy=n=>Ta(n)==="[object Object]",Id=n=>mt(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,ko=Ed(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Rc=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},CI=/-(\w)/g,In=Rc(n=>n.replace(CI,(e,t)=>t?t.toUpperCase():"")),AI=/\B([A-Z])/g,pr=Rc(n=>n.replace(AI,"-$1").toLowerCase()),xc=Rc(n=>n.charAt(0).toUpperCase()+n.slice(1)),Hu=Rc(n=>n?`on${xc(n)}`:""),qs=(n,e)=>!Object.is(n,e),yl=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},Ay=(n,e,t,s=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:s,value:t})},Ml=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let fg;const Pc=()=>fg||(fg=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Yo(n){if(we(n)){const e={};for(let t=0;t<n.length;t++){const s=n[t],r=mt(s)?PI(s):Yo(s);if(r)for(const i in r)e[i]=r[i]}return e}else if(mt(n)||Ze(n))return n}const SI=/;(?![^(]*\))/g,RI=/:([^]+)/,xI=/\/\*[^]*?\*\//g;function PI(n){const e={};return n.replace(xI,"").split(SI).forEach(t=>{if(t){const s=t.split(RI);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function ut(n){let e="";if(mt(n))e=n;else if(we(n))for(let t=0;t<n.length;t++){const s=ut(n[t]);s&&(e+=s+" ")}else if(Ze(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const kI="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",NI=Ed(kI);function Sy(n){return!!n||n===""}function DI(n,e){if(n.length!==e.length)return!1;let t=!0;for(let s=0;t&&s<n.length;s++)t=Nr(n[s],e[s]);return t}function Nr(n,e){if(n===e)return!0;let t=dg(n),s=dg(e);if(t||s)return t&&s?n.getTime()===e.getTime():!1;if(t=Qn(n),s=Qn(e),t||s)return n===e;if(t=we(n),s=we(e),t||s)return t&&s?DI(n,e):!1;if(t=Ze(n),s=Ze(e),t||s){if(!t||!s)return!1;const r=Object.keys(n).length,i=Object.keys(e).length;if(r!==i)return!1;for(const o in n){const a=n.hasOwnProperty(o),c=e.hasOwnProperty(o);if(a&&!c||!a&&c||!Nr(n[o],e[o]))return!1}}return String(n)===String(e)}function bd(n,e){return n.findIndex(t=>Nr(t,e))}const Ry=n=>!!(n&&n.__v_isRef===!0),ye=n=>mt(n)?n:n==null?"":we(n)||Ze(n)&&(n.toString===by||!xe(n.toString))?Ry(n)?ye(n.value):JSON.stringify(n,xy,2):String(n),xy=(n,e)=>Ry(e)?xy(n,e.value):hi(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[s,r],i)=>(t[Gu(s,i)+" =>"]=r,t),{})}:$i(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>Gu(t))}:Qn(e)?Gu(e):Ze(e)&&!we(e)&&!Cy(e)?String(e):e,Gu=(n,e="")=>{var t;return Qn(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Zt;class OI{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=Zt,!e&&Zt&&(this.index=(Zt.scopes||(Zt.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=Zt;try{return Zt=this,e()}finally{Zt=t}}}on(){++this._on===1&&(this.prevScope=Zt,Zt=this)}off(){this._on>0&&--this._on===0&&(Zt=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let t,s;for(t=0,s=this.effects.length;t<s;t++)this.effects[t].stop();for(this.effects.length=0,t=0,s=this.cleanups.length;t<s;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function MI(){return Zt}let Je;const Wu=new WeakSet;class Py{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Zt&&Zt.active&&Zt.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Wu.has(this)&&(Wu.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Ny(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,pg(this),Dy(this);const e=Je,t=xn;Je=this,xn=!0;try{return this.fn()}finally{Oy(this),Je=e,xn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)Sd(e);this.deps=this.depsTail=void 0,pg(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Wu.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Eh(this)&&this.run()}get dirty(){return Eh(this)}}let ky=0,No,Do;function Ny(n,e=!1){if(n.flags|=8,e){n.next=Do,Do=n;return}n.next=No,No=n}function Cd(){ky++}function Ad(){if(--ky>0)return;if(Do){let e=Do;for(Do=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;No;){let e=No;for(No=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(s){n||(n=s)}e=t}}if(n)throw n}function Dy(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Oy(n){let e,t=n.depsTail,s=t;for(;s;){const r=s.prevDep;s.version===-1?(s===t&&(t=r),Sd(s),LI(s)):e=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=r}n.deps=e,n.depsTail=t}function Eh(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(My(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function My(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===Jo)||(n.globalVersion=Jo,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Eh(n))))return;n.flags|=2;const e=n.dep,t=Je,s=xn;Je=n,xn=!0;try{Dy(n);const r=n.fn(n._value);(e.version===0||qs(r,n._value))&&(n.flags|=128,n._value=r,e.version++)}catch(r){throw e.version++,r}finally{Je=t,xn=s,Oy(n),n.flags&=-3}}function Sd(n,e=!1){const{dep:t,prevSub:s,nextSub:r}=n;if(s&&(s.nextSub=r,n.prevSub=void 0),r&&(r.prevSub=s,n.nextSub=void 0),t.subs===n&&(t.subs=s,!s&&t.computed)){t.computed.flags&=-5;for(let i=t.computed.deps;i;i=i.nextDep)Sd(i,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function LI(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let xn=!0;const Ly=[];function Es(){Ly.push(xn),xn=!1}function ws(){const n=Ly.pop();xn=n===void 0?!0:n}function pg(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=Je;Je=void 0;try{e()}finally{Je=t}}}let Jo=0;class VI{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Rd{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0}track(e){if(!Je||!xn||Je===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==Je)t=this.activeLink=new VI(Je,this),Je.deps?(t.prevDep=Je.depsTail,Je.depsTail.nextDep=t,Je.depsTail=t):Je.deps=Je.depsTail=t,Vy(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const s=t.nextDep;s.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=s),t.prevDep=Je.depsTail,t.nextDep=void 0,Je.depsTail.nextDep=t,Je.depsTail=t,Je.deps===t&&(Je.deps=s)}return t}trigger(e){this.version++,Jo++,this.notify(e)}notify(e){Cd();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{Ad()}}}function Vy(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let s=e.deps;s;s=s.nextDep)Vy(s)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const wh=new WeakMap,kr=Symbol(""),Th=Symbol(""),Xo=Symbol("");function Ut(n,e,t){if(xn&&Je){let s=wh.get(n);s||wh.set(n,s=new Map);let r=s.get(t);r||(s.set(t,r=new Rd),r.map=s,r.key=t),r.track()}}function as(n,e,t,s,r,i){const o=wh.get(n);if(!o){Jo++;return}const a=c=>{c&&c.trigger()};if(Cd(),e==="clear")o.forEach(a);else{const c=we(n),u=c&&Id(t);if(c&&t==="length"){const h=Number(s);o.forEach((d,p)=>{(p==="length"||p===Xo||!Qn(p)&&p>=h)&&a(d)})}else switch((t!==void 0||o.has(void 0))&&a(o.get(t)),u&&a(o.get(Xo)),e){case"add":c?u&&a(o.get("length")):(a(o.get(kr)),hi(n)&&a(o.get(Th)));break;case"delete":c||(a(o.get(kr)),hi(n)&&a(o.get(Th)));break;case"set":hi(n)&&a(o.get(kr));break}}Ad()}function ei(n){const e=He(n);return e===n?e:(Ut(e,"iterate",Xo),En(n)?e:e.map(Pt))}function kc(n){return Ut(n=He(n),"iterate",Xo),n}const FI={__proto__:null,[Symbol.iterator](){return qu(this,Symbol.iterator,Pt)},concat(...n){return ei(this).concat(...n.map(e=>we(e)?ei(e):e))},entries(){return qu(this,"entries",n=>(n[1]=Pt(n[1]),n))},every(n,e){return ts(this,"every",n,e,void 0,arguments)},filter(n,e){return ts(this,"filter",n,e,t=>t.map(Pt),arguments)},find(n,e){return ts(this,"find",n,e,Pt,arguments)},findIndex(n,e){return ts(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return ts(this,"findLast",n,e,Pt,arguments)},findLastIndex(n,e){return ts(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return ts(this,"forEach",n,e,void 0,arguments)},includes(...n){return zu(this,"includes",n)},indexOf(...n){return zu(this,"indexOf",n)},join(n){return ei(this).join(n)},lastIndexOf(...n){return zu(this,"lastIndexOf",n)},map(n,e){return ts(this,"map",n,e,void 0,arguments)},pop(){return go(this,"pop")},push(...n){return go(this,"push",n)},reduce(n,...e){return gg(this,"reduce",n,e)},reduceRight(n,...e){return gg(this,"reduceRight",n,e)},shift(){return go(this,"shift")},some(n,e){return ts(this,"some",n,e,void 0,arguments)},splice(...n){return go(this,"splice",n)},toReversed(){return ei(this).toReversed()},toSorted(n){return ei(this).toSorted(n)},toSpliced(...n){return ei(this).toSpliced(...n)},unshift(...n){return go(this,"unshift",n)},values(){return qu(this,"values",Pt)}};function qu(n,e,t){const s=kc(n),r=s[e]();return s!==n&&!En(n)&&(r._next=r.next,r.next=()=>{const i=r._next();return i.value&&(i.value=t(i.value)),i}),r}const UI=Array.prototype;function ts(n,e,t,s,r,i){const o=kc(n),a=o!==n&&!En(n),c=o[e];if(c!==UI[e]){const d=c.apply(n,i);return a?Pt(d):d}let u=t;o!==n&&(a?u=function(d,p){return t.call(this,Pt(d),p,n)}:t.length>2&&(u=function(d,p){return t.call(this,d,p,n)}));const h=c.call(o,u,s);return a&&r?r(h):h}function gg(n,e,t,s){const r=kc(n);let i=t;return r!==n&&(En(n)?t.length>3&&(i=function(o,a,c){return t.call(this,o,a,c,n)}):i=function(o,a,c){return t.call(this,o,Pt(a),c,n)}),r[e](i,...s)}function zu(n,e,t){const s=He(n);Ut(s,"iterate",Xo);const r=s[e](...t);return(r===-1||r===!1)&&kd(t[0])?(t[0]=He(t[0]),s[e](...t)):r}function go(n,e,t=[]){Es(),Cd();const s=He(n)[e].apply(n,t);return Ad(),ws(),s}const BI=Ed("__proto__,__v_isRef,__isVue"),Fy=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(Qn));function $I(n){Qn(n)||(n=String(n));const e=He(this);return Ut(e,"has",n),e.hasOwnProperty(n)}class Uy{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,s){if(t==="__v_skip")return e.__v_skip;const r=this._isReadonly,i=this._isShallow;if(t==="__v_isReactive")return!r;if(t==="__v_isReadonly")return r;if(t==="__v_isShallow")return i;if(t==="__v_raw")return s===(r?i?JI:Hy:i?jy:$y).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(s)?e:void 0;const o=we(e);if(!r){let c;if(o&&(c=FI[t]))return c;if(t==="hasOwnProperty")return $I}const a=Reflect.get(e,t,Ht(e)?e:s);return(Qn(t)?Fy.has(t):BI(t))||(r||Ut(e,"get",t),i)?a:Ht(a)?o&&Id(t)?a:a.value:Ze(a)?r?Wy(a):Nc(a):a}}class By extends Uy{constructor(e=!1){super(!1,e)}set(e,t,s,r){let i=e[t];if(!this._isShallow){const c=er(i);if(!En(s)&&!er(s)&&(i=He(i),s=He(s)),!we(e)&&Ht(i)&&!Ht(s))return c?!1:(i.value=s,!0)}const o=we(e)&&Id(t)?Number(t)<e.length:Ge(e,t),a=Reflect.set(e,t,s,Ht(e)?e:r);return e===He(r)&&(o?qs(s,i)&&as(e,"set",t,s):as(e,"add",t,s)),a}deleteProperty(e,t){const s=Ge(e,t);e[t];const r=Reflect.deleteProperty(e,t);return r&&s&&as(e,"delete",t,void 0),r}has(e,t){const s=Reflect.has(e,t);return(!Qn(t)||!Fy.has(t))&&Ut(e,"has",t),s}ownKeys(e){return Ut(e,"iterate",we(e)?"length":kr),Reflect.ownKeys(e)}}class jI extends Uy{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const HI=new By,GI=new jI,WI=new By(!0);const Ih=n=>n,il=n=>Reflect.getPrototypeOf(n);function qI(n,e,t){return function(...s){const r=this.__v_raw,i=He(r),o=hi(i),a=n==="entries"||n===Symbol.iterator&&o,c=n==="keys"&&o,u=r[n](...s),h=t?Ih:e?Ll:Pt;return!e&&Ut(i,"iterate",c?Th:kr),{next(){const{value:d,done:p}=u.next();return p?{value:d,done:p}:{value:a?[h(d[0]),h(d[1])]:h(d),done:p}},[Symbol.iterator](){return this}}}}function ol(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function zI(n,e){const t={get(r){const i=this.__v_raw,o=He(i),a=He(r);n||(qs(r,a)&&Ut(o,"get",r),Ut(o,"get",a));const{has:c}=il(o),u=e?Ih:n?Ll:Pt;if(c.call(o,r))return u(i.get(r));if(c.call(o,a))return u(i.get(a));i!==o&&i.get(r)},get size(){const r=this.__v_raw;return!n&&Ut(He(r),"iterate",kr),Reflect.get(r,"size",r)},has(r){const i=this.__v_raw,o=He(i),a=He(r);return n||(qs(r,a)&&Ut(o,"has",r),Ut(o,"has",a)),r===a?i.has(r):i.has(r)||i.has(a)},forEach(r,i){const o=this,a=o.__v_raw,c=He(a),u=e?Ih:n?Ll:Pt;return!n&&Ut(c,"iterate",kr),a.forEach((h,d)=>r.call(i,u(h),u(d),o))}};return Wt(t,n?{add:ol("add"),set:ol("set"),delete:ol("delete"),clear:ol("clear")}:{add(r){!e&&!En(r)&&!er(r)&&(r=He(r));const i=He(this);return il(i).has.call(i,r)||(i.add(r),as(i,"add",r,r)),this},set(r,i){!e&&!En(i)&&!er(i)&&(i=He(i));const o=He(this),{has:a,get:c}=il(o);let u=a.call(o,r);u||(r=He(r),u=a.call(o,r));const h=c.call(o,r);return o.set(r,i),u?qs(i,h)&&as(o,"set",r,i):as(o,"add",r,i),this},delete(r){const i=He(this),{has:o,get:a}=il(i);let c=o.call(i,r);c||(r=He(r),c=o.call(i,r)),a&&a.call(i,r);const u=i.delete(r);return c&&as(i,"delete",r,void 0),u},clear(){const r=He(this),i=r.size!==0,o=r.clear();return i&&as(r,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=qI(r,n,e)}),t}function xd(n,e){const t=zI(n,e);return(s,r,i)=>r==="__v_isReactive"?!n:r==="__v_isReadonly"?n:r==="__v_raw"?s:Reflect.get(Ge(t,r)&&r in s?t:s,r,i)}const KI={get:xd(!1,!1)},QI={get:xd(!1,!0)},YI={get:xd(!0,!1)};const $y=new WeakMap,jy=new WeakMap,Hy=new WeakMap,JI=new WeakMap;function XI(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function ZI(n){return n.__v_skip||!Object.isExtensible(n)?0:XI(bI(n))}function Nc(n){return er(n)?n:Pd(n,!1,HI,KI,$y)}function Gy(n){return Pd(n,!1,WI,QI,jy)}function Wy(n){return Pd(n,!0,GI,YI,Hy)}function Pd(n,e,t,s,r){if(!Ze(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const i=ZI(n);if(i===0)return n;const o=r.get(n);if(o)return o;const a=new Proxy(n,i===2?s:t);return r.set(n,a),a}function di(n){return er(n)?di(n.__v_raw):!!(n&&n.__v_isReactive)}function er(n){return!!(n&&n.__v_isReadonly)}function En(n){return!!(n&&n.__v_isShallow)}function kd(n){return n?!!n.__v_raw:!1}function He(n){const e=n&&n.__v_raw;return e?He(e):n}function eb(n){return!Ge(n,"__v_skip")&&Object.isExtensible(n)&&Ay(n,"__v_skip",!0),n}const Pt=n=>Ze(n)?Nc(n):n,Ll=n=>Ze(n)?Wy(n):n;function Ht(n){return n?n.__v_isRef===!0:!1}function ie(n){return qy(n,!1)}function tb(n){return qy(n,!0)}function qy(n,e){return Ht(n)?n:new nb(n,e)}class nb{constructor(e,t){this.dep=new Rd,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:He(e),this._value=t?e:Pt(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,s=this.__v_isShallow||En(e)||er(e);e=s?e:He(e),qs(e,t)&&(this._rawValue=e,this._value=s?e:Pt(e),this.dep.trigger())}}function fi(n){return Ht(n)?n.value:n}const sb={get:(n,e,t)=>e==="__v_raw"?n:fi(Reflect.get(n,e,t)),set:(n,e,t,s)=>{const r=n[e];return Ht(r)&&!Ht(t)?(r.value=t,!0):Reflect.set(n,e,t,s)}};function zy(n){return di(n)?n:new Proxy(n,sb)}class rb{constructor(e,t,s){this.fn=e,this.setter=t,this._value=void 0,this.dep=new Rd(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Jo-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&Je!==this)return Ny(this,!0),!0}get value(){const e=this.dep.track();return My(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function ib(n,e,t=!1){let s,r;return xe(n)?s=n:(s=n.get,r=n.set),new rb(s,r,t)}const al={},Vl=new WeakMap;let Cr;function ob(n,e=!1,t=Cr){if(t){let s=Vl.get(t);s||Vl.set(t,s=[]),s.push(n)}}function ab(n,e,t=Ke){const{immediate:s,deep:r,once:i,scheduler:o,augmentJob:a,call:c}=t,u=j=>r?j:En(j)||r===!1||r===0?ls(j,1):ls(j);let h,d,p,m,v=!1,b=!1;if(Ht(n)?(d=()=>n.value,v=En(n)):di(n)?(d=()=>u(n),v=!0):we(n)?(b=!0,v=n.some(j=>di(j)||En(j)),d=()=>n.map(j=>{if(Ht(j))return j.value;if(di(j))return u(j);if(xe(j))return c?c(j,2):j()})):xe(n)?e?d=c?()=>c(n,2):n:d=()=>{if(p){Es();try{p()}finally{ws()}}const j=Cr;Cr=h;try{return c?c(n,3,[m]):n(m)}finally{Cr=j}}:d=$n,e&&r){const j=d,fe=r===!0?1/0:r;d=()=>ls(j(),fe)}const S=MI(),L=()=>{h.stop(),S&&S.active&&Td(S.effects,h)};if(i&&e){const j=e;e=(...fe)=>{j(...fe),L()}}let V=b?new Array(n.length).fill(al):al;const B=j=>{if(!(!(h.flags&1)||!h.dirty&&!j))if(e){const fe=h.run();if(r||v||(b?fe.some((ue,A)=>qs(ue,V[A])):qs(fe,V))){p&&p();const ue=Cr;Cr=h;try{const A=[fe,V===al?void 0:b&&V[0]===al?[]:V,m];V=fe,c?c(e,3,A):e(...A)}finally{Cr=ue}}}else h.run()};return a&&a(B),h=new Py(d),h.scheduler=o?()=>o(B,!1):B,m=j=>ob(j,!1,h),p=h.onStop=()=>{const j=Vl.get(h);if(j){if(c)c(j,4);else for(const fe of j)fe();Vl.delete(h)}},e?s?B(!0):V=h.run():o?o(B.bind(null,!0),!0):h.run(),L.pause=h.pause.bind(h),L.resume=h.resume.bind(h),L.stop=L,L}function ls(n,e=1/0,t){if(e<=0||!Ze(n)||n.__v_skip||(t=t||new Set,t.has(n)))return n;if(t.add(n),e--,Ht(n))ls(n.value,e,t);else if(we(n))for(let s=0;s<n.length;s++)ls(n[s],e,t);else if($i(n)||hi(n))n.forEach(s=>{ls(s,e,t)});else if(Cy(n)){for(const s in n)ls(n[s],e,t);for(const s of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,s)&&ls(n[s],e,t)}return n}/**
* @vue/runtime-core v3.5.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ia(n,e,t,s){try{return s?n(...s):n()}catch(r){Dc(r,e,t)}}function Yn(n,e,t,s){if(xe(n)){const r=Ia(n,e,t,s);return r&&Iy(r)&&r.catch(i=>{Dc(i,e,t)}),r}if(we(n)){const r=[];for(let i=0;i<n.length;i++)r.push(Yn(n[i],e,t,s));return r}}function Dc(n,e,t,s=!0){const r=e?e.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||Ke;if(e){let a=e.parent;const c=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${t}`;for(;a;){const h=a.ec;if(h){for(let d=0;d<h.length;d++)if(h[d](n,c,u)===!1)return}a=a.parent}if(i){Es(),Ia(i,null,10,[n,c,u]),ws();return}}lb(n,t,r,s,o)}function lb(n,e,t,s=!0,r=!1){if(r)throw n;console.error(n)}const Qt=[];let Vn=-1;const pi=[];let js=null,ni=0;const Ky=Promise.resolve();let Fl=null;function Zo(n){const e=Fl||Ky;return n?e.then(this?n.bind(this):n):e}function cb(n){let e=Vn+1,t=Qt.length;for(;e<t;){const s=e+t>>>1,r=Qt[s],i=ea(r);i<n||i===n&&r.flags&2?e=s+1:t=s}return e}function Nd(n){if(!(n.flags&1)){const e=ea(n),t=Qt[Qt.length-1];!t||!(n.flags&2)&&e>=ea(t)?Qt.push(n):Qt.splice(cb(e),0,n),n.flags|=1,Qy()}}function Qy(){Fl||(Fl=Ky.then(Jy))}function ub(n){we(n)?pi.push(...n):js&&n.id===-1?js.splice(ni+1,0,n):n.flags&1||(pi.push(n),n.flags|=1),Qy()}function mg(n,e,t=Vn+1){for(;t<Qt.length;t++){const s=Qt[t];if(s&&s.flags&2){if(n&&s.id!==n.uid)continue;Qt.splice(t,1),t--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function Yy(n){if(pi.length){const e=[...new Set(pi)].sort((t,s)=>ea(t)-ea(s));if(pi.length=0,js){js.push(...e);return}for(js=e,ni=0;ni<js.length;ni++){const t=js[ni];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}js=null,ni=0}}const ea=n=>n.id==null?n.flags&2?-1:1/0:n.id;function Jy(n){try{for(Vn=0;Vn<Qt.length;Vn++){const e=Qt[Vn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),Ia(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Vn<Qt.length;Vn++){const e=Qt[Vn];e&&(e.flags&=-2)}Vn=-1,Qt.length=0,Yy(),Fl=null,(Qt.length||pi.length)&&Jy()}}let hn=null,Xy=null;function Ul(n){const e=hn;return hn=n,Xy=n&&n.type.__scopeId||null,e}function cn(n,e=hn,t){if(!e||n._n)return n;const s=(...r)=>{s._d&&Ag(-1);const i=Ul(e);let o;try{o=n(...r)}finally{Ul(i),s._d&&Ag(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function vn(n,e){if(hn===null)return n;const t=Fc(hn),s=n.dirs||(n.dirs=[]);for(let r=0;r<e.length;r++){let[i,o,a,c=Ke]=e[r];i&&(xe(i)&&(i={mounted:i,updated:i}),i.deep&&ls(o),s.push({dir:i,instance:t,value:o,oldValue:void 0,arg:a,modifiers:c}))}return n}function Tr(n,e,t,s){const r=n.dirs,i=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];i&&(a.oldValue=i[o].value);let c=a.dir[s];c&&(Es(),Yn(c,t,8,[n.el,a,n,e]),ws())}}const hb=Symbol("_vte"),db=n=>n.__isTeleport;function Dd(n,e){n.shapeFlag&6&&n.component?(n.transition=e,Dd(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}/*! #__NO_SIDE_EFFECTS__ */function Zy(n,e){return xe(n)?Wt({name:n.name},e,{setup:n}):n}function ev(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function Bl(n,e,t,s,r=!1){if(we(n)){n.forEach((v,b)=>Bl(v,e&&(we(e)?e[b]:e),t,s,r));return}if(Oo(s)&&!r){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&Bl(n,e,t,s.component.subTree);return}const i=s.shapeFlag&4?Fc(s.component):s.el,o=r?null:i,{i:a,r:c}=n,u=e&&e.r,h=a.refs===Ke?a.refs={}:a.refs,d=a.setupState,p=He(d),m=d===Ke?()=>!1:v=>Ge(p,v);if(u!=null&&u!==c&&(mt(u)?(h[u]=null,m(u)&&(d[u]=null)):Ht(u)&&(u.value=null)),xe(c))Ia(c,a,12,[o,h]);else{const v=mt(c),b=Ht(c);if(v||b){const S=()=>{if(n.f){const L=v?m(c)?d[c]:h[c]:c.value;r?we(L)&&Td(L,i):we(L)?L.includes(i)||L.push(i):v?(h[c]=[i],m(c)&&(d[c]=h[c])):(c.value=[i],n.k&&(h[n.k]=c.value))}else v?(h[c]=o,m(c)&&(d[c]=o)):b&&(c.value=o,n.k&&(h[n.k]=o))};o?(S.id=-1,ln(S,t)):S()}}}Pc().requestIdleCallback;Pc().cancelIdleCallback;const Oo=n=>!!n.type.__asyncLoader,tv=n=>n.type.__isKeepAlive;function fb(n,e){nv(n,"a",e)}function pb(n,e){nv(n,"da",e)}function nv(n,e,t=jt){const s=n.__wdc||(n.__wdc=()=>{let r=t;for(;r;){if(r.isDeactivated)return;r=r.parent}return n()});if(Oc(e,s,t),t){let r=t.parent;for(;r&&r.parent;)tv(r.parent.vnode)&&gb(s,e,t,r),r=r.parent}}function gb(n,e,t,s){const r=Oc(e,n,s,!0);Mc(()=>{Td(s[e],r)},t)}function Oc(n,e,t=jt,s=!1){if(t){const r=t[n]||(t[n]=[]),i=e.__weh||(e.__weh=(...o)=>{Es();const a=ba(t),c=Yn(e,t,n,o);return a(),ws(),c});return s?r.unshift(i):r.push(i),i}}const xs=n=>(e,t=jt)=>{(!na||n==="sp")&&Oc(n,(...s)=>e(...s),t)},mb=xs("bm"),Mn=xs("m"),_b=xs("bu"),yb=xs("u"),Od=xs("bum"),Mc=xs("um"),vb=xs("sp"),Eb=xs("rtg"),wb=xs("rtc");function Tb(n,e=jt){Oc("ec",n,e)}const sv="components",Ib="directives";function ji(n,e){return rv(sv,n,!0,e)||n}const bb=Symbol.for("v-ndc");function Cb(n){return rv(Ib,n)}function rv(n,e,t=!0,s=!1){const r=hn||jt;if(r){const i=r.type;if(n===sv){const a=hC(i,!1);if(a&&(a===e||a===In(e)||a===xc(In(e))))return i}const o=_g(r[n]||i[n],e)||_g(r.appContext[n],e);return!o&&s?i:o}}function _g(n,e){return n&&(n[e]||n[In(e)]||n[xc(In(e))])}function kn(n,e,t,s){let r;const i=t,o=we(n);if(o||mt(n)){const a=o&&di(n);let c=!1,u=!1;a&&(c=!En(n),u=er(n),n=kc(n)),r=new Array(n.length);for(let h=0,d=n.length;h<d;h++)r[h]=e(c?u?Ll(Pt(n[h])):Pt(n[h]):n[h],h,void 0,i)}else if(typeof n=="number"){r=new Array(n);for(let a=0;a<n;a++)r[a]=e(a+1,a,void 0,i)}else if(Ze(n))if(n[Symbol.iterator])r=Array.from(n,(a,c)=>e(a,c,void 0,i));else{const a=Object.keys(n);r=new Array(a.length);for(let c=0,u=a.length;c<u;c++){const h=a[c];r[c]=e(n[h],h,c,i)}}else r=[];return r}const bh=n=>n?bv(n)?Fc(n):bh(n.parent):null,Mo=Wt(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>bh(n.parent),$root:n=>bh(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>ov(n),$forceUpdate:n=>n.f||(n.f=()=>{Nd(n.update)}),$nextTick:n=>n.n||(n.n=Zo.bind(n.proxy)),$watch:n=>qb.bind(n)}),Ku=(n,e)=>n!==Ke&&!n.__isScriptSetup&&Ge(n,e),Ab={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:s,data:r,props:i,accessCache:o,type:a,appContext:c}=n;let u;if(e[0]!=="$"){const m=o[e];if(m!==void 0)switch(m){case 1:return s[e];case 2:return r[e];case 4:return t[e];case 3:return i[e]}else{if(Ku(s,e))return o[e]=1,s[e];if(r!==Ke&&Ge(r,e))return o[e]=2,r[e];if((u=n.propsOptions[0])&&Ge(u,e))return o[e]=3,i[e];if(t!==Ke&&Ge(t,e))return o[e]=4,t[e];Ch&&(o[e]=0)}}const h=Mo[e];let d,p;if(h)return e==="$attrs"&&Ut(n.attrs,"get",""),h(n);if((d=a.__cssModules)&&(d=d[e]))return d;if(t!==Ke&&Ge(t,e))return o[e]=4,t[e];if(p=c.config.globalProperties,Ge(p,e))return p[e]},set({_:n},e,t){const{data:s,setupState:r,ctx:i}=n;return Ku(r,e)?(r[e]=t,!0):s!==Ke&&Ge(s,e)?(s[e]=t,!0):Ge(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(i[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:s,appContext:r,propsOptions:i}},o){let a;return!!t[o]||n!==Ke&&Ge(n,o)||Ku(e,o)||(a=i[0])&&Ge(a,o)||Ge(s,o)||Ge(Mo,o)||Ge(r.config.globalProperties,o)},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:Ge(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function yg(n){return we(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let Ch=!0;function Sb(n){const e=ov(n),t=n.proxy,s=n.ctx;Ch=!1,e.beforeCreate&&vg(e.beforeCreate,n,"bc");const{data:r,computed:i,methods:o,watch:a,provide:c,inject:u,created:h,beforeMount:d,mounted:p,beforeUpdate:m,updated:v,activated:b,deactivated:S,beforeDestroy:L,beforeUnmount:V,destroyed:B,unmounted:j,render:fe,renderTracked:ue,renderTriggered:A,errorCaptured:E,serverPrefetch:I,expose:R,inheritAttrs:P,components:N,directives:T,filters:Ye}=e;if(u&&Rb(u,s,null),o)for(const ve in o){const Te=o[ve];xe(Te)&&(s[ve]=Te.bind(t))}if(r){const ve=r.call(t,t);Ze(ve)&&(n.data=Nc(ve))}if(Ch=!0,i)for(const ve in i){const Te=i[ve],ot=xe(Te)?Te.bind(t,t):xe(Te.get)?Te.get.bind(t,t):$n,rt=!xe(Te)&&xe(Te.set)?Te.set.bind(t):$n,it=pt({get:ot,set:rt});Object.defineProperty(s,ve,{enumerable:!0,configurable:!0,get:()=>it.value,set:x=>it.value=x})}if(a)for(const ve in a)iv(a[ve],s,t,ve);if(c){const ve=xe(c)?c.call(t):c;Reflect.ownKeys(ve).forEach(Te=>{vl(Te,ve[Te])})}h&&vg(h,n,"c");function pe(ve,Te){we(Te)?Te.forEach(ot=>ve(ot.bind(t))):Te&&ve(Te.bind(t))}if(pe(mb,d),pe(Mn,p),pe(_b,m),pe(yb,v),pe(fb,b),pe(pb,S),pe(Tb,E),pe(wb,ue),pe(Eb,A),pe(Od,V),pe(Mc,j),pe(vb,I),we(R))if(R.length){const ve=n.exposed||(n.exposed={});R.forEach(Te=>{Object.defineProperty(ve,Te,{get:()=>t[Te],set:ot=>t[Te]=ot})})}else n.exposed||(n.exposed={});fe&&n.render===$n&&(n.render=fe),P!=null&&(n.inheritAttrs=P),N&&(n.components=N),T&&(n.directives=T),I&&ev(n)}function Rb(n,e,t=$n){we(n)&&(n=Ah(n));for(const s in n){const r=n[s];let i;Ze(r)?"default"in r?i=jn(r.from||s,r.default,!0):i=jn(r.from||s):i=jn(r),Ht(i)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[s]=i}}function vg(n,e,t){Yn(we(n)?n.map(s=>s.bind(e.proxy)):n.bind(e.proxy),e,t)}function iv(n,e,t,s){let r=s.includes(".")?vv(t,s):()=>t[s];if(mt(n)){const i=e[n];xe(i)&&El(r,i)}else if(xe(n))El(r,n.bind(t));else if(Ze(n))if(we(n))n.forEach(i=>iv(i,e,t,s));else{const i=xe(n.handler)?n.handler.bind(t):e[n.handler];xe(i)&&El(r,i,n)}}function ov(n){const e=n.type,{mixins:t,extends:s}=e,{mixins:r,optionsCache:i,config:{optionMergeStrategies:o}}=n.appContext,a=i.get(e);let c;return a?c=a:!r.length&&!t&&!s?c=e:(c={},r.length&&r.forEach(u=>$l(c,u,o,!0)),$l(c,e,o)),Ze(e)&&i.set(e,c),c}function $l(n,e,t,s=!1){const{mixins:r,extends:i}=e;i&&$l(n,i,t,!0),r&&r.forEach(o=>$l(n,o,t,!0));for(const o in e)if(!(s&&o==="expose")){const a=xb[o]||t&&t[o];n[o]=a?a(n[o],e[o]):e[o]}return n}const xb={data:Eg,props:wg,emits:wg,methods:bo,computed:bo,beforeCreate:Kt,created:Kt,beforeMount:Kt,mounted:Kt,beforeUpdate:Kt,updated:Kt,beforeDestroy:Kt,beforeUnmount:Kt,destroyed:Kt,unmounted:Kt,activated:Kt,deactivated:Kt,errorCaptured:Kt,serverPrefetch:Kt,components:bo,directives:bo,watch:kb,provide:Eg,inject:Pb};function Eg(n,e){return e?n?function(){return Wt(xe(n)?n.call(this,this):n,xe(e)?e.call(this,this):e)}:e:n}function Pb(n,e){return bo(Ah(n),Ah(e))}function Ah(n){if(we(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function Kt(n,e){return n?[...new Set([].concat(n,e))]:e}function bo(n,e){return n?Wt(Object.create(null),n,e):e}function wg(n,e){return n?we(n)&&we(e)?[...new Set([...n,...e])]:Wt(Object.create(null),yg(n),yg(e??{})):e}function kb(n,e){if(!n)return e;if(!e)return n;const t=Wt(Object.create(null),n);for(const s in e)t[s]=Kt(n[s],e[s]);return t}function av(){return{app:null,config:{isNativeTag:TI,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Nb=0;function Db(n,e){return function(s,r=null){xe(s)||(s=Wt({},s)),r!=null&&!Ze(r)&&(r=null);const i=av(),o=new WeakSet,a=[];let c=!1;const u=i.app={_uid:Nb++,_component:s,_props:r,_container:null,_context:i,_instance:null,version:fC,get config(){return i.config},set config(h){},use(h,...d){return o.has(h)||(h&&xe(h.install)?(o.add(h),h.install(u,...d)):xe(h)&&(o.add(h),h(u,...d))),u},mixin(h){return i.mixins.includes(h)||i.mixins.push(h),u},component(h,d){return d?(i.components[h]=d,u):i.components[h]},directive(h,d){return d?(i.directives[h]=d,u):i.directives[h]},mount(h,d,p){if(!c){const m=u._ceVNode||qe(s,r);return m.appContext=i,p===!0?p="svg":p===!1&&(p=void 0),n(m,h,p),c=!0,u._container=h,h.__vue_app__=u,Fc(m.component)}},onUnmount(h){a.push(h)},unmount(){c&&(Yn(a,u._instance,16),n(null,u._container),delete u._container.__vue_app__)},provide(h,d){return i.provides[h]=d,u},runWithContext(h){const d=gi;gi=u;try{return h()}finally{gi=d}}};return u}}let gi=null;function vl(n,e){if(jt){let t=jt.provides;const s=jt.parent&&jt.parent.provides;s===t&&(t=jt.provides=Object.create(s)),t[n]=e}}function jn(n,e,t=!1){const s=jt||hn;if(s||gi){let r=gi?gi._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(r&&n in r)return r[n];if(arguments.length>1)return t&&xe(e)?e.call(s&&s.proxy):e}}const lv={},cv=()=>Object.create(lv),uv=n=>Object.getPrototypeOf(n)===lv;function Ob(n,e,t,s=!1){const r={},i=cv();n.propsDefaults=Object.create(null),hv(n,e,r,i);for(const o in n.propsOptions[0])o in r||(r[o]=void 0);t?n.props=s?r:Gy(r):n.type.props?n.props=r:n.props=i,n.attrs=i}function Mb(n,e,t,s){const{props:r,attrs:i,vnode:{patchFlag:o}}=n,a=He(r),[c]=n.propsOptions;let u=!1;if((s||o>0)&&!(o&16)){if(o&8){const h=n.vnode.dynamicProps;for(let d=0;d<h.length;d++){let p=h[d];if(Lc(n.emitsOptions,p))continue;const m=e[p];if(c)if(Ge(i,p))m!==i[p]&&(i[p]=m,u=!0);else{const v=In(p);r[v]=Sh(c,a,v,m,n,!1)}else m!==i[p]&&(i[p]=m,u=!0)}}}else{hv(n,e,r,i)&&(u=!0);let h;for(const d in a)(!e||!Ge(e,d)&&((h=pr(d))===d||!Ge(e,h)))&&(c?t&&(t[d]!==void 0||t[h]!==void 0)&&(r[d]=Sh(c,a,d,void 0,n,!0)):delete r[d]);if(i!==a)for(const d in i)(!e||!Ge(e,d))&&(delete i[d],u=!0)}u&&as(n.attrs,"set","")}function hv(n,e,t,s){const[r,i]=n.propsOptions;let o=!1,a;if(e)for(let c in e){if(ko(c))continue;const u=e[c];let h;r&&Ge(r,h=In(c))?!i||!i.includes(h)?t[h]=u:(a||(a={}))[h]=u:Lc(n.emitsOptions,c)||(!(c in s)||u!==s[c])&&(s[c]=u,o=!0)}if(i){const c=He(t),u=a||Ke;for(let h=0;h<i.length;h++){const d=i[h];t[d]=Sh(r,c,d,u[d],n,!Ge(u,d))}}return o}function Sh(n,e,t,s,r,i){const o=n[t];if(o!=null){const a=Ge(o,"default");if(a&&s===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&xe(c)){const{propsDefaults:u}=r;if(t in u)s=u[t];else{const h=ba(r);s=u[t]=c.call(null,e),h()}}else s=c;r.ce&&r.ce._setProp(t,s)}o[0]&&(i&&!a?s=!1:o[1]&&(s===""||s===pr(t))&&(s=!0))}return s}const Lb=new WeakMap;function dv(n,e,t=!1){const s=t?Lb:e.propsCache,r=s.get(n);if(r)return r;const i=n.props,o={},a=[];let c=!1;if(!xe(n)){const h=d=>{c=!0;const[p,m]=dv(d,e,!0);Wt(o,p),m&&a.push(...m)};!t&&e.mixins.length&&e.mixins.forEach(h),n.extends&&h(n.extends),n.mixins&&n.mixins.forEach(h)}if(!i&&!c)return Ze(n)&&s.set(n,ui),ui;if(we(i))for(let h=0;h<i.length;h++){const d=In(i[h]);Tg(d)&&(o[d]=Ke)}else if(i)for(const h in i){const d=In(h);if(Tg(d)){const p=i[h],m=o[d]=we(p)||xe(p)?{type:p}:Wt({},p),v=m.type;let b=!1,S=!0;if(we(v))for(let L=0;L<v.length;++L){const V=v[L],B=xe(V)&&V.name;if(B==="Boolean"){b=!0;break}else B==="String"&&(S=!1)}else b=xe(v)&&v.name==="Boolean";m[0]=b,m[1]=S,(b||Ge(m,"default"))&&a.push(d)}}const u=[o,a];return Ze(n)&&s.set(n,u),u}function Tg(n){return n[0]!=="$"&&!ko(n)}const Md=n=>n[0]==="_"||n==="$stable",Ld=n=>we(n)?n.map(Un):[Un(n)],Vb=(n,e,t)=>{if(e._n)return e;const s=cn((...r)=>Ld(e(...r)),t);return s._c=!1,s},fv=(n,e,t)=>{const s=n._ctx;for(const r in n){if(Md(r))continue;const i=n[r];if(xe(i))e[r]=Vb(r,i,s);else if(i!=null){const o=Ld(i);e[r]=()=>o}}},pv=(n,e)=>{const t=Ld(e);n.slots.default=()=>t},gv=(n,e,t)=>{for(const s in e)(t||!Md(s))&&(n[s]=e[s])},Fb=(n,e,t)=>{const s=n.slots=cv();if(n.vnode.shapeFlag&32){const r=e._;r?(gv(s,e,t),t&&Ay(s,"_",r,!0)):fv(e,s)}else e&&pv(n,e)},Ub=(n,e,t)=>{const{vnode:s,slots:r}=n;let i=!0,o=Ke;if(s.shapeFlag&32){const a=e._;a?t&&a===1?i=!1:gv(r,e,t):(i=!e.$stable,fv(e,r)),o=e}else e&&(pv(n,e),o={default:1});if(i)for(const a in r)!Md(a)&&o[a]==null&&delete r[a]},ln=Zb;function Bb(n){return $b(n)}function $b(n,e){const t=Pc();t.__VUE__=!0;const{insert:s,remove:r,patchProp:i,createElement:o,createText:a,createComment:c,setText:u,setElementText:h,parentNode:d,nextSibling:p,setScopeId:m=$n,insertStaticContent:v}=n,b=(y,w,k,$=null,W=null,G=null,se=void 0,te=null,X=!!w.dynamicChildren)=>{if(y===w)return;y&&!mo(y,w)&&($=M(y),x(y,W,G,!0),y=null),w.patchFlag===-2&&(X=!1,w.dynamicChildren=null);const{type:K,ref:ge,shapeFlag:re}=w;switch(K){case Vc:S(y,w,k,$);break;case tr:L(y,w,k,$);break;case wl:y==null&&V(w,k,$,se);break;case ft:N(y,w,k,$,W,G,se,te,X);break;default:re&1?fe(y,w,k,$,W,G,se,te,X):re&6?T(y,w,k,$,W,G,se,te,X):(re&64||re&128)&&K.process(y,w,k,$,W,G,se,te,X,H)}ge!=null&&W&&Bl(ge,y&&y.ref,G,w||y,!w)},S=(y,w,k,$)=>{if(y==null)s(w.el=a(w.children),k,$);else{const W=w.el=y.el;w.children!==y.children&&u(W,w.children)}},L=(y,w,k,$)=>{y==null?s(w.el=c(w.children||""),k,$):w.el=y.el},V=(y,w,k,$)=>{[y.el,y.anchor]=v(y.children,w,k,$,y.el,y.anchor)},B=({el:y,anchor:w},k,$)=>{let W;for(;y&&y!==w;)W=p(y),s(y,k,$),y=W;s(w,k,$)},j=({el:y,anchor:w})=>{let k;for(;y&&y!==w;)k=p(y),r(y),y=k;r(w)},fe=(y,w,k,$,W,G,se,te,X)=>{w.type==="svg"?se="svg":w.type==="math"&&(se="mathml"),y==null?ue(w,k,$,W,G,se,te,X):I(y,w,W,G,se,te,X)},ue=(y,w,k,$,W,G,se,te)=>{let X,K;const{props:ge,shapeFlag:re,transition:de,dirs:Ae}=y;if(X=y.el=o(y.type,G,ge&&ge.is,ge),re&8?h(X,y.children):re&16&&E(y.children,X,null,$,W,Qu(y,G),se,te),Ae&&Tr(y,null,$,"created"),A(X,y,y.scopeId,se,$),ge){for(const Pe in ge)Pe!=="value"&&!ko(Pe)&&i(X,Pe,null,ge[Pe],G,$);"value"in ge&&i(X,"value",null,ge.value,G),(K=ge.onVnodeBeforeMount)&&Ln(K,$,y)}Ae&&Tr(y,null,$,"beforeMount");const Ee=jb(W,de);Ee&&de.beforeEnter(X),s(X,w,k),((K=ge&&ge.onVnodeMounted)||Ee||Ae)&&ln(()=>{K&&Ln(K,$,y),Ee&&de.enter(X),Ae&&Tr(y,null,$,"mounted")},W)},A=(y,w,k,$,W)=>{if(k&&m(y,k),$)for(let G=0;G<$.length;G++)m(y,$[G]);if(W){let G=W.subTree;if(w===G||wv(G.type)&&(G.ssContent===w||G.ssFallback===w)){const se=W.vnode;A(y,se,se.scopeId,se.slotScopeIds,W.parent)}}},E=(y,w,k,$,W,G,se,te,X=0)=>{for(let K=X;K<y.length;K++){const ge=y[K]=te?Hs(y[K]):Un(y[K]);b(null,ge,w,k,$,W,G,se,te)}},I=(y,w,k,$,W,G,se)=>{const te=w.el=y.el;let{patchFlag:X,dynamicChildren:K,dirs:ge}=w;X|=y.patchFlag&16;const re=y.props||Ke,de=w.props||Ke;let Ae;if(k&&Ir(k,!1),(Ae=de.onVnodeBeforeUpdate)&&Ln(Ae,k,w,y),ge&&Tr(w,y,k,"beforeUpdate"),k&&Ir(k,!0),(re.innerHTML&&de.innerHTML==null||re.textContent&&de.textContent==null)&&h(te,""),K?R(y.dynamicChildren,K,te,k,$,Qu(w,W),G):se||Te(y,w,te,null,k,$,Qu(w,W),G,!1),X>0){if(X&16)P(te,re,de,k,W);else if(X&2&&re.class!==de.class&&i(te,"class",null,de.class,W),X&4&&i(te,"style",re.style,de.style,W),X&8){const Ee=w.dynamicProps;for(let Pe=0;Pe<Ee.length;Pe++){const Ve=Ee[Pe],Dt=re[Ve],St=de[Ve];(St!==Dt||Ve==="value")&&i(te,Ve,Dt,St,W,k)}}X&1&&y.children!==w.children&&h(te,w.children)}else!se&&K==null&&P(te,re,de,k,W);((Ae=de.onVnodeUpdated)||ge)&&ln(()=>{Ae&&Ln(Ae,k,w,y),ge&&Tr(w,y,k,"updated")},$)},R=(y,w,k,$,W,G,se)=>{for(let te=0;te<w.length;te++){const X=y[te],K=w[te],ge=X.el&&(X.type===ft||!mo(X,K)||X.shapeFlag&198)?d(X.el):k;b(X,K,ge,null,$,W,G,se,!0)}},P=(y,w,k,$,W)=>{if(w!==k){if(w!==Ke)for(const G in w)!ko(G)&&!(G in k)&&i(y,G,w[G],null,W,$);for(const G in k){if(ko(G))continue;const se=k[G],te=w[G];se!==te&&G!=="value"&&i(y,G,te,se,W,$)}"value"in k&&i(y,"value",w.value,k.value,W)}},N=(y,w,k,$,W,G,se,te,X)=>{const K=w.el=y?y.el:a(""),ge=w.anchor=y?y.anchor:a("");let{patchFlag:re,dynamicChildren:de,slotScopeIds:Ae}=w;Ae&&(te=te?te.concat(Ae):Ae),y==null?(s(K,k,$),s(ge,k,$),E(w.children||[],k,ge,W,G,se,te,X)):re>0&&re&64&&de&&y.dynamicChildren?(R(y.dynamicChildren,de,k,W,G,se,te),(w.key!=null||W&&w===W.subTree)&&mv(y,w,!0)):Te(y,w,k,ge,W,G,se,te,X)},T=(y,w,k,$,W,G,se,te,X)=>{w.slotScopeIds=te,y==null?w.shapeFlag&512?W.ctx.activate(w,k,$,se,X):Ye(w,k,$,W,G,se,X):_e(y,w,X)},Ye=(y,w,k,$,W,G,se)=>{const te=y.component=oC(y,$,W);if(tv(y)&&(te.ctx.renderer=H),aC(te,!1,se),te.asyncDep){if(W&&W.registerDep(te,pe,se),!y.el){const X=te.subTree=qe(tr);L(null,X,w,k)}}else pe(te,y,w,k,W,G,se)},_e=(y,w,k)=>{const $=w.component=y.component;if(Jb(y,w,k))if($.asyncDep&&!$.asyncResolved){ve($,w,k);return}else $.next=w,$.update();else w.el=y.el,$.vnode=w},pe=(y,w,k,$,W,G,se)=>{const te=()=>{if(y.isMounted){let{next:re,bu:de,u:Ae,parent:Ee,vnode:Pe}=y;{const Ot=_v(y);if(Ot){re&&(re.el=Pe.el,ve(y,re,se)),Ot.asyncDep.then(()=>{y.isUnmounted||te()});return}}let Ve=re,Dt;Ir(y,!1),re?(re.el=Pe.el,ve(y,re,se)):re=Pe,de&&yl(de),(Dt=re.props&&re.props.onVnodeBeforeUpdate)&&Ln(Dt,Ee,re,Pe),Ir(y,!0);const St=bg(y),gn=y.subTree;y.subTree=St,b(gn,St,d(gn.el),M(gn),y,W,G),re.el=St.el,Ve===null&&Xb(y,St.el),Ae&&ln(Ae,W),(Dt=re.props&&re.props.onVnodeUpdated)&&ln(()=>Ln(Dt,Ee,re,Pe),W)}else{let re;const{el:de,props:Ae}=w,{bm:Ee,m:Pe,parent:Ve,root:Dt,type:St}=y,gn=Oo(w);Ir(y,!1),Ee&&yl(Ee),!gn&&(re=Ae&&Ae.onVnodeBeforeMount)&&Ln(re,Ve,w),Ir(y,!0);{Dt.ce&&Dt.ce._injectChildStyle(St);const Ot=y.subTree=bg(y);b(null,Ot,k,$,y,W,G),w.el=Ot.el}if(Pe&&ln(Pe,W),!gn&&(re=Ae&&Ae.onVnodeMounted)){const Ot=w;ln(()=>Ln(re,Ve,Ot),W)}(w.shapeFlag&256||Ve&&Oo(Ve.vnode)&&Ve.vnode.shapeFlag&256)&&y.a&&ln(y.a,W),y.isMounted=!0,w=k=$=null}};y.scope.on();const X=y.effect=new Py(te);y.scope.off();const K=y.update=X.run.bind(X),ge=y.job=X.runIfDirty.bind(X);ge.i=y,ge.id=y.uid,X.scheduler=()=>Nd(ge),Ir(y,!0),K()},ve=(y,w,k)=>{w.component=y;const $=y.vnode.props;y.vnode=w,y.next=null,Mb(y,w.props,$,k),Ub(y,w.children,k),Es(),mg(y),ws()},Te=(y,w,k,$,W,G,se,te,X=!1)=>{const K=y&&y.children,ge=y?y.shapeFlag:0,re=w.children,{patchFlag:de,shapeFlag:Ae}=w;if(de>0){if(de&128){rt(K,re,k,$,W,G,se,te,X);return}else if(de&256){ot(K,re,k,$,W,G,se,te,X);return}}Ae&8?(ge&16&&he(K,W,G),re!==K&&h(k,re)):ge&16?Ae&16?rt(K,re,k,$,W,G,se,te,X):he(K,W,G,!0):(ge&8&&h(k,""),Ae&16&&E(re,k,$,W,G,se,te,X))},ot=(y,w,k,$,W,G,se,te,X)=>{y=y||ui,w=w||ui;const K=y.length,ge=w.length,re=Math.min(K,ge);let de;for(de=0;de<re;de++){const Ae=w[de]=X?Hs(w[de]):Un(w[de]);b(y[de],Ae,k,null,W,G,se,te,X)}K>ge?he(y,W,G,!0,!1,re):E(w,k,$,W,G,se,te,X,re)},rt=(y,w,k,$,W,G,se,te,X)=>{let K=0;const ge=w.length;let re=y.length-1,de=ge-1;for(;K<=re&&K<=de;){const Ae=y[K],Ee=w[K]=X?Hs(w[K]):Un(w[K]);if(mo(Ae,Ee))b(Ae,Ee,k,null,W,G,se,te,X);else break;K++}for(;K<=re&&K<=de;){const Ae=y[re],Ee=w[de]=X?Hs(w[de]):Un(w[de]);if(mo(Ae,Ee))b(Ae,Ee,k,null,W,G,se,te,X);else break;re--,de--}if(K>re){if(K<=de){const Ae=de+1,Ee=Ae<ge?w[Ae].el:$;for(;K<=de;)b(null,w[K]=X?Hs(w[K]):Un(w[K]),k,Ee,W,G,se,te,X),K++}}else if(K>de)for(;K<=re;)x(y[K],W,G,!0),K++;else{const Ae=K,Ee=K,Pe=new Map;for(K=Ee;K<=de;K++){const Rt=w[K]=X?Hs(w[K]):Un(w[K]);Rt.key!=null&&Pe.set(Rt.key,K)}let Ve,Dt=0;const St=de-Ee+1;let gn=!1,Ot=0;const Ms=new Array(St);for(K=0;K<St;K++)Ms[K]=0;for(K=Ae;K<=re;K++){const Rt=y[K];if(Dt>=St){x(Rt,W,G,!0);continue}let mn;if(Rt.key!=null)mn=Pe.get(Rt.key);else for(Ve=Ee;Ve<=de;Ve++)if(Ms[Ve-Ee]===0&&mo(Rt,w[Ve])){mn=Ve;break}mn===void 0?x(Rt,W,G,!0):(Ms[mn-Ee]=K+1,mn>=Ot?Ot=mn:gn=!0,b(Rt,w[mn],k,null,W,G,se,te,X),Dt++)}const to=gn?Hb(Ms):ui;for(Ve=to.length-1,K=St-1;K>=0;K--){const Rt=Ee+K,mn=w[Rt],Ha=Rt+1<ge?w[Rt+1].el:$;Ms[K]===0?b(null,mn,k,Ha,W,G,se,te,X):gn&&(Ve<0||K!==to[Ve]?it(mn,k,Ha,2):Ve--)}}},it=(y,w,k,$,W=null)=>{const{el:G,type:se,transition:te,children:X,shapeFlag:K}=y;if(K&6){it(y.component.subTree,w,k,$);return}if(K&128){y.suspense.move(w,k,$);return}if(K&64){se.move(y,w,k,H);return}if(se===ft){s(G,w,k);for(let re=0;re<X.length;re++)it(X[re],w,k,$);s(y.anchor,w,k);return}if(se===wl){B(y,w,k);return}if($!==2&&K&1&&te)if($===0)te.beforeEnter(G),s(G,w,k),ln(()=>te.enter(G),W);else{const{leave:re,delayLeave:de,afterLeave:Ae}=te,Ee=()=>{y.ctx.isUnmounted?r(G):s(G,w,k)},Pe=()=>{re(G,()=>{Ee(),Ae&&Ae()})};de?de(G,Ee,Pe):Pe()}else s(G,w,k)},x=(y,w,k,$=!1,W=!1)=>{const{type:G,props:se,ref:te,children:X,dynamicChildren:K,shapeFlag:ge,patchFlag:re,dirs:de,cacheIndex:Ae}=y;if(re===-2&&(W=!1),te!=null&&(Es(),Bl(te,null,k,y,!0),ws()),Ae!=null&&(w.renderCache[Ae]=void 0),ge&256){w.ctx.deactivate(y);return}const Ee=ge&1&&de,Pe=!Oo(y);let Ve;if(Pe&&(Ve=se&&se.onVnodeBeforeUnmount)&&Ln(Ve,w,y),ge&6)ce(y.component,k,$);else{if(ge&128){y.suspense.unmount(k,$);return}Ee&&Tr(y,null,w,"beforeUnmount"),ge&64?y.type.remove(y,w,k,H,$):K&&!K.hasOnce&&(G!==ft||re>0&&re&64)?he(K,w,k,!1,!0):(G===ft&&re&384||!W&&ge&16)&&he(X,w,k),$&&O(y)}(Pe&&(Ve=se&&se.onVnodeUnmounted)||Ee)&&ln(()=>{Ve&&Ln(Ve,w,y),Ee&&Tr(y,null,w,"unmounted")},k)},O=y=>{const{type:w,el:k,anchor:$,transition:W}=y;if(w===ft){Q(k,$);return}if(w===wl){j(y);return}const G=()=>{r(k),W&&!W.persisted&&W.afterLeave&&W.afterLeave()};if(y.shapeFlag&1&&W&&!W.persisted){const{leave:se,delayLeave:te}=W,X=()=>se(k,G);te?te(y.el,G,X):X()}else G()},Q=(y,w)=>{let k;for(;y!==w;)k=p(y),r(y),y=k;r(w)},ce=(y,w,k)=>{const{bum:$,scope:W,job:G,subTree:se,um:te,m:X,a:K,parent:ge,slots:{__:re}}=y;Ig(X),Ig(K),$&&yl($),ge&&we(re)&&re.forEach(de=>{ge.renderCache[de]=void 0}),W.stop(),G&&(G.flags|=8,x(se,y,w,k)),te&&ln(te,w),ln(()=>{y.isUnmounted=!0},w),w&&w.pendingBranch&&!w.isUnmounted&&y.asyncDep&&!y.asyncResolved&&y.suspenseId===w.pendingId&&(w.deps--,w.deps===0&&w.resolve())},he=(y,w,k,$=!1,W=!1,G=0)=>{for(let se=G;se<y.length;se++)x(y[se],w,k,$,W)},M=y=>{if(y.shapeFlag&6)return M(y.component.subTree);if(y.shapeFlag&128)return y.suspense.next();const w=p(y.anchor||y.el),k=w&&w[hb];return k?p(k):w};let Y=!1;const F=(y,w,k)=>{y==null?w._vnode&&x(w._vnode,null,null,!0):b(w._vnode||null,y,w,null,null,null,k),w._vnode=y,Y||(Y=!0,mg(),Yy(),Y=!1)},H={p:b,um:x,m:it,r:O,mt:Ye,mc:E,pc:Te,pbc:R,n:M,o:n};return{render:F,hydrate:void 0,createApp:Db(F)}}function Qu({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function Ir({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function jb(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function mv(n,e,t=!1){const s=n.children,r=e.children;if(we(s)&&we(r))for(let i=0;i<s.length;i++){const o=s[i];let a=r[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[i]=Hs(r[i]),a.el=o.el),!t&&a.patchFlag!==-2&&mv(o,a)),a.type===Vc&&(a.el=o.el),a.type===tr&&!a.el&&(a.el=o.el)}}function Hb(n){const e=n.slice(),t=[0];let s,r,i,o,a;const c=n.length;for(s=0;s<c;s++){const u=n[s];if(u!==0){if(r=t[t.length-1],n[r]<u){e[s]=r,t.push(s);continue}for(i=0,o=t.length-1;i<o;)a=i+o>>1,n[t[a]]<u?i=a+1:o=a;u<n[t[i]]&&(i>0&&(e[s]=t[i-1]),t[i]=s)}}for(i=t.length,o=t[i-1];i-- >0;)t[i]=o,o=e[o];return t}function _v(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:_v(e)}function Ig(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}const Gb=Symbol.for("v-scx"),Wb=()=>jn(Gb);function El(n,e,t){return yv(n,e,t)}function yv(n,e,t=Ke){const{immediate:s,deep:r,flush:i,once:o}=t,a=Wt({},t),c=e&&s||!e&&i!=="post";let u;if(na){if(i==="sync"){const m=Wb();u=m.__watcherHandles||(m.__watcherHandles=[])}else if(!c){const m=()=>{};return m.stop=$n,m.resume=$n,m.pause=$n,m}}const h=jt;a.call=(m,v,b)=>Yn(m,h,v,b);let d=!1;i==="post"?a.scheduler=m=>{ln(m,h&&h.suspense)}:i!=="sync"&&(d=!0,a.scheduler=(m,v)=>{v?m():Nd(m)}),a.augmentJob=m=>{e&&(m.flags|=4),d&&(m.flags|=2,h&&(m.id=h.uid,m.i=h))};const p=ab(n,e,a);return na&&(u?u.push(p):c&&p()),p}function qb(n,e,t){const s=this.proxy,r=mt(n)?n.includes(".")?vv(s,n):()=>s[n]:n.bind(s,s);let i;xe(e)?i=e:(i=e.handler,t=e);const o=ba(this),a=yv(r,i.bind(s),t);return o(),a}function vv(n,e){const t=e.split(".");return()=>{let s=n;for(let r=0;r<t.length&&s;r++)s=s[t[r]];return s}}const zb=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${In(e)}Modifiers`]||n[`${pr(e)}Modifiers`];function Kb(n,e,...t){if(n.isUnmounted)return;const s=n.vnode.props||Ke;let r=t;const i=e.startsWith("update:"),o=i&&zb(s,e.slice(7));o&&(o.trim&&(r=t.map(h=>mt(h)?h.trim():h)),o.number&&(r=t.map(Ml)));let a,c=s[a=Hu(e)]||s[a=Hu(In(e))];!c&&i&&(c=s[a=Hu(pr(e))]),c&&Yn(c,n,6,r);const u=s[a+"Once"];if(u){if(!n.emitted)n.emitted={};else if(n.emitted[a])return;n.emitted[a]=!0,Yn(u,n,6,r)}}function Ev(n,e,t=!1){const s=e.emitsCache,r=s.get(n);if(r!==void 0)return r;const i=n.emits;let o={},a=!1;if(!xe(n)){const c=u=>{const h=Ev(u,e,!0);h&&(a=!0,Wt(o,h))};!t&&e.mixins.length&&e.mixins.forEach(c),n.extends&&c(n.extends),n.mixins&&n.mixins.forEach(c)}return!i&&!a?(Ze(n)&&s.set(n,null),null):(we(i)?i.forEach(c=>o[c]=null):Wt(o,i),Ze(n)&&s.set(n,o),o)}function Lc(n,e){return!n||!Sc(e)?!1:(e=e.slice(2).replace(/Once$/,""),Ge(n,e[0].toLowerCase()+e.slice(1))||Ge(n,pr(e))||Ge(n,e))}function bg(n){const{type:e,vnode:t,proxy:s,withProxy:r,propsOptions:[i],slots:o,attrs:a,emit:c,render:u,renderCache:h,props:d,data:p,setupState:m,ctx:v,inheritAttrs:b}=n,S=Ul(n);let L,V;try{if(t.shapeFlag&4){const j=r||s,fe=j;L=Un(u.call(fe,j,h,d,m,p,v)),V=a}else{const j=e;L=Un(j.length>1?j(d,{attrs:a,slots:o,emit:c}):j(d,null)),V=e.props?a:Qb(a)}}catch(j){Lo.length=0,Dc(j,n,1),L=qe(tr)}let B=L;if(V&&b!==!1){const j=Object.keys(V),{shapeFlag:fe}=B;j.length&&fe&7&&(i&&j.some(wd)&&(V=Yb(V,i)),B=Ti(B,V,!1,!0))}return t.dirs&&(B=Ti(B,null,!1,!0),B.dirs=B.dirs?B.dirs.concat(t.dirs):t.dirs),t.transition&&Dd(B,t.transition),L=B,Ul(S),L}const Qb=n=>{let e;for(const t in n)(t==="class"||t==="style"||Sc(t))&&((e||(e={}))[t]=n[t]);return e},Yb=(n,e)=>{const t={};for(const s in n)(!wd(s)||!(s.slice(9)in e))&&(t[s]=n[s]);return t};function Jb(n,e,t){const{props:s,children:r,component:i}=n,{props:o,children:a,patchFlag:c}=e,u=i.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&c>=0){if(c&1024)return!0;if(c&16)return s?Cg(s,o,u):!!o;if(c&8){const h=e.dynamicProps;for(let d=0;d<h.length;d++){const p=h[d];if(o[p]!==s[p]&&!Lc(u,p))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?Cg(s,o,u):!0:!!o;return!1}function Cg(n,e,t){const s=Object.keys(e);if(s.length!==Object.keys(n).length)return!0;for(let r=0;r<s.length;r++){const i=s[r];if(e[i]!==n[i]&&!Lc(t,i))return!0}return!1}function Xb({vnode:n,parent:e},t){for(;e;){const s=e.subTree;if(s.suspense&&s.suspense.activeBranch===n&&(s.el=n.el),s===n)(n=e.vnode).el=t,e=e.parent;else break}}const wv=n=>n.__isSuspense;function Zb(n,e){e&&e.pendingBranch?we(n)?e.effects.push(...n):e.effects.push(n):ub(n)}const ft=Symbol.for("v-fgt"),Vc=Symbol.for("v-txt"),tr=Symbol.for("v-cmt"),wl=Symbol.for("v-stc"),Lo=[];let dn=null;function J(n=!1){Lo.push(dn=n?null:[])}function eC(){Lo.pop(),dn=Lo[Lo.length-1]||null}let ta=1;function Ag(n,e=!1){ta+=n,n<0&&dn&&e&&(dn.hasOnce=!0)}function Tv(n){return n.dynamicChildren=ta>0?dn||ui:null,eC(),ta>0&&dn&&dn.push(n),n}function Z(n,e,t,s,r,i){return Tv(C(n,e,t,s,r,i,!0))}function jl(n,e,t,s,r){return Tv(qe(n,e,t,s,r,!0))}function Hl(n){return n?n.__v_isVNode===!0:!1}function mo(n,e){return n.type===e.type&&n.key===e.key}const Iv=({key:n})=>n??null,Tl=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?mt(n)||Ht(n)||xe(n)?{i:hn,r:n,k:e,f:!!t}:n:null);function C(n,e=null,t=null,s=0,r=null,i=n===ft?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&Iv(e),ref:e&&Tl(e),scopeId:Xy,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:s,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:hn};return a?(Vd(c,t),i&128&&n.normalize(c)):t&&(c.shapeFlag|=mt(t)?8:16),ta>0&&!o&&dn&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&dn.push(c),c}const qe=tC;function tC(n,e=null,t=null,s=0,r=null,i=!1){if((!n||n===bb)&&(n=tr),Hl(n)){const a=Ti(n,e,!0);return t&&Vd(a,t),ta>0&&!i&&dn&&(a.shapeFlag&6?dn[dn.indexOf(n)]=a:dn.push(a)),a.patchFlag=-2,a}if(dC(n)&&(n=n.__vccOpts),e){e=nC(e);let{class:a,style:c}=e;a&&!mt(a)&&(e.class=ut(a)),Ze(c)&&(kd(c)&&!we(c)&&(c=Wt({},c)),e.style=Yo(c))}const o=mt(n)?1:wv(n)?128:db(n)?64:Ze(n)?4:xe(n)?2:0;return C(n,e,t,s,r,o,i,!0)}function nC(n){return n?kd(n)||uv(n)?Wt({},n):n:null}function Ti(n,e,t=!1,s=!1){const{props:r,ref:i,patchFlag:o,children:a,transition:c}=n,u=e?sC(r||{},e):r,h={__v_isVNode:!0,__v_skip:!0,type:n.type,props:u,key:u&&Iv(u),ref:e&&e.ref?t&&i?we(i)?i.concat(Tl(e)):[i,Tl(e)]:Tl(e):i,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:a,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==ft?o===-1?16:o|16:o,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:c,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Ti(n.ssContent),ssFallback:n.ssFallback&&Ti(n.ssFallback),el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return c&&s&&Dd(h,c.clone(h)),h}function ht(n=" ",e=0){return qe(Vc,null,n,e)}function Hi(n,e){const t=qe(wl,null,n);return t.staticCount=e,t}function Be(n="",e=!1){return e?(J(),jl(tr,null,n)):qe(tr,null,n)}function Un(n){return n==null||typeof n=="boolean"?qe(tr):we(n)?qe(ft,null,n.slice()):Hl(n)?Hs(n):qe(Vc,null,String(n))}function Hs(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Ti(n)}function Vd(n,e){let t=0;const{shapeFlag:s}=n;if(e==null)e=null;else if(we(e))t=16;else if(typeof e=="object")if(s&65){const r=e.default;r&&(r._c&&(r._d=!1),Vd(n,r()),r._c&&(r._d=!0));return}else{t=32;const r=e._;!r&&!uv(e)?e._ctx=hn:r===3&&hn&&(hn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else xe(e)?(e={default:e,_ctx:hn},t=32):(e=String(e),s&64?(t=16,e=[ht(e)]):t=8);n.children=e,n.shapeFlag|=t}function sC(...n){const e={};for(let t=0;t<n.length;t++){const s=n[t];for(const r in s)if(r==="class")e.class!==s.class&&(e.class=ut([e.class,s.class]));else if(r==="style")e.style=Yo([e.style,s.style]);else if(Sc(r)){const i=e[r],o=s[r];o&&i!==o&&!(we(i)&&i.includes(o))&&(e[r]=i?[].concat(i,o):o)}else r!==""&&(e[r]=s[r])}return e}function Ln(n,e,t,s=null){Yn(n,e,7,[t,s])}const rC=av();let iC=0;function oC(n,e,t){const s=n.type,r=(e?e.appContext:n.appContext)||rC,i={uid:iC++,vnode:n,type:s,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new OI(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:dv(s,r),emitsOptions:Ev(s,r),emit:null,emitted:null,propsDefaults:Ke,inheritAttrs:s.inheritAttrs,ctx:Ke,data:Ke,props:Ke,attrs:Ke,slots:Ke,refs:Ke,setupState:Ke,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=Kb.bind(null,i),n.ce&&n.ce(i),i}let jt=null,Gl,Rh;{const n=Pc(),e=(t,s)=>{let r;return(r=n[t])||(r=n[t]=[]),r.push(s),i=>{r.length>1?r.forEach(o=>o(i)):r[0](i)}};Gl=e("__VUE_INSTANCE_SETTERS__",t=>jt=t),Rh=e("__VUE_SSR_SETTERS__",t=>na=t)}const ba=n=>{const e=jt;return Gl(n),n.scope.on(),()=>{n.scope.off(),Gl(e)}},Sg=()=>{jt&&jt.scope.off(),Gl(null)};function bv(n){return n.vnode.shapeFlag&4}let na=!1;function aC(n,e=!1,t=!1){e&&Rh(e);const{props:s,children:r}=n.vnode,i=bv(n);Ob(n,s,i,e),Fb(n,r,t||e);const o=i?lC(n,e):void 0;return e&&Rh(!1),o}function lC(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Ab);const{setup:s}=t;if(s){Es();const r=n.setupContext=s.length>1?uC(n):null,i=ba(n),o=Ia(s,n,0,[n.props,r]),a=Iy(o);if(ws(),i(),(a||n.sp)&&!Oo(n)&&ev(n),a){if(o.then(Sg,Sg),e)return o.then(c=>{Rg(n,c)}).catch(c=>{Dc(c,n,0)});n.asyncDep=o}else Rg(n,o)}else Cv(n)}function Rg(n,e,t){xe(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:Ze(e)&&(n.setupState=zy(e)),Cv(n)}function Cv(n,e,t){const s=n.type;n.render||(n.render=s.render||$n);{const r=ba(n);Es();try{Sb(n)}finally{ws(),r()}}}const cC={get(n,e){return Ut(n,"get",""),n[e]}};function uC(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,cC),slots:n.slots,emit:n.emit,expose:e}}function Fc(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(zy(eb(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in Mo)return Mo[t](n)},has(e,t){return t in e||t in Mo}})):n.proxy}function hC(n,e=!0){return xe(n)?n.displayName||n.name:n.name||e&&n.__name}function dC(n){return xe(n)&&"__vccOpts"in n}const pt=(n,e)=>ib(n,e,na);function Av(n,e,t){const s=arguments.length;return s===2?Ze(e)&&!we(e)?Hl(e)?qe(n,null,[e]):qe(n,e):qe(n,null,e):(s>3?t=Array.prototype.slice.call(arguments,2):s===3&&Hl(t)&&(t=[t]),qe(n,e,t))}const fC="3.5.15";/**
* @vue/runtime-dom v3.5.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let xh;const xg=typeof window<"u"&&window.trustedTypes;if(xg)try{xh=xg.createPolicy("vue",{createHTML:n=>n})}catch{}const Sv=xh?n=>xh.createHTML(n):n=>n,pC="http://www.w3.org/2000/svg",gC="http://www.w3.org/1998/Math/MathML",os=typeof document<"u"?document:null,Pg=os&&os.createElement("template"),mC={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,s)=>{const r=e==="svg"?os.createElementNS(pC,n):e==="mathml"?os.createElementNS(gC,n):t?os.createElement(n,{is:t}):os.createElement(n);return n==="select"&&s&&s.multiple!=null&&r.setAttribute("multiple",s.multiple),r},createText:n=>os.createTextNode(n),createComment:n=>os.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>os.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,s,r,i){const o=t?t.previousSibling:e.lastChild;if(r&&(r===i||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),t),!(r===i||!(r=r.nextSibling)););else{Pg.innerHTML=Sv(s==="svg"?`<svg>${n}</svg>`:s==="mathml"?`<math>${n}</math>`:n);const a=Pg.content;if(s==="svg"||s==="mathml"){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},_C=Symbol("_vtc");function yC(n,e,t){const s=n[_C];s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const kg=Symbol("_vod"),vC=Symbol("_vsh"),EC=Symbol(""),wC=/(^|;)\s*display\s*:/;function TC(n,e,t){const s=n.style,r=mt(t);let i=!1;if(t&&!r){if(e)if(mt(e))for(const o of e.split(";")){const a=o.slice(0,o.indexOf(":")).trim();t[a]==null&&Il(s,a,"")}else for(const o in e)t[o]==null&&Il(s,o,"");for(const o in t)o==="display"&&(i=!0),Il(s,o,t[o])}else if(r){if(e!==t){const o=s[EC];o&&(t+=";"+o),s.cssText=t,i=wC.test(t)}}else e&&n.removeAttribute("style");kg in n&&(n[kg]=i?s.display:"",n[vC]&&(s.display="none"))}const Ng=/\s*!important$/;function Il(n,e,t){if(we(t))t.forEach(s=>Il(n,e,s));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const s=IC(n,e);Ng.test(t)?n.setProperty(pr(s),t.replace(Ng,""),"important"):n[s]=t}}const Dg=["Webkit","Moz","ms"],Yu={};function IC(n,e){const t=Yu[e];if(t)return t;let s=In(e);if(s!=="filter"&&s in n)return Yu[e]=s;s=xc(s);for(let r=0;r<Dg.length;r++){const i=Dg[r]+s;if(i in n)return Yu[e]=i}return e}const Og="http://www.w3.org/1999/xlink";function Mg(n,e,t,s,r,i=NI(e)){s&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(Og,e.slice(6,e.length)):n.setAttributeNS(Og,e,t):t==null||i&&!Sy(t)?n.removeAttribute(e):n.setAttribute(e,i?"":Qn(t)?String(t):t)}function Lg(n,e,t,s,r){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?Sv(t):t);return}const i=n.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const a=i==="OPTION"?n.getAttribute("value")||"":n.value,c=t==null?n.type==="checkbox"?"on":"":String(t);(a!==c||!("_value"in n))&&(n.value=c),t==null&&n.removeAttribute(e),n._value=t;return}let o=!1;if(t===""||t==null){const a=typeof n[e];a==="boolean"?t=Sy(t):t==null&&a==="string"?(t="",o=!0):a==="number"&&(t=0,o=!0)}try{n[e]=t}catch{}o&&n.removeAttribute(r||e)}function cs(n,e,t,s){n.addEventListener(e,t,s)}function bC(n,e,t,s){n.removeEventListener(e,t,s)}const Vg=Symbol("_vei");function CC(n,e,t,s,r=null){const i=n[Vg]||(n[Vg]={}),o=i[e];if(s&&o)o.value=s;else{const[a,c]=AC(e);if(s){const u=i[e]=xC(s,r);cs(n,a,u,c)}else o&&(bC(n,a,o,c),i[e]=void 0)}}const Fg=/(?:Once|Passive|Capture)$/;function AC(n){let e;if(Fg.test(n)){e={};let s;for(;s=n.match(Fg);)n=n.slice(0,n.length-s[0].length),e[s[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):pr(n.slice(2)),e]}let Ju=0;const SC=Promise.resolve(),RC=()=>Ju||(SC.then(()=>Ju=0),Ju=Date.now());function xC(n,e){const t=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=t.attached)return;Yn(PC(s,t.value),e,5,[s])};return t.value=n,t.attached=RC(),t}function PC(n,e){if(we(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(s=>r=>!r._stopped&&s&&s(r))}else return e}const Ug=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,kC=(n,e,t,s,r,i)=>{const o=r==="svg";e==="class"?yC(n,s,o):e==="style"?TC(n,t,s):Sc(e)?wd(e)||CC(n,e,t,s,i):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):NC(n,e,s,o))?(Lg(n,e,s),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&Mg(n,e,s,o,i,e!=="value")):n._isVueCE&&(/[A-Z]/.test(e)||!mt(s))?Lg(n,In(e),s,i,e):(e==="true-value"?n._trueValue=s:e==="false-value"&&(n._falseValue=s),Mg(n,e,s,o))};function NC(n,e,t,s){if(s)return!!(e==="innerHTML"||e==="textContent"||e in n&&Ug(e)&&xe(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const r=n.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return Ug(e)&&mt(t)?!1:e in n}const nr=n=>{const e=n.props["onUpdate:modelValue"]||!1;return we(e)?t=>yl(e,t):e};function DC(n){n.target.composing=!0}function Bg(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const wn=Symbol("_assign"),Hn={created(n,{modifiers:{lazy:e,trim:t,number:s}},r){n[wn]=nr(r);const i=s||r.props&&r.props.type==="number";cs(n,e?"change":"input",o=>{if(o.target.composing)return;let a=n.value;t&&(a=a.trim()),i&&(a=Ml(a)),n[wn](a)}),t&&cs(n,"change",()=>{n.value=n.value.trim()}),e||(cs(n,"compositionstart",DC),cs(n,"compositionend",Bg),cs(n,"change",Bg))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:s,trim:r,number:i}},o){if(n[wn]=nr(o),n.composing)return;const a=(i||n.type==="number")&&!/^0\d/.test(n.value)?Ml(n.value):n.value,c=e??"";a!==c&&(document.activeElement===n&&n.type!=="range"&&(s&&e===t||r&&n.value.trim()===c)||(n.value=c))}},OC={deep:!0,created(n,e,t){n[wn]=nr(t),cs(n,"change",()=>{const s=n._modelValue,r=Ii(n),i=n.checked,o=n[wn];if(we(s)){const a=bd(s,r),c=a!==-1;if(i&&!c)o(s.concat(r));else if(!i&&c){const u=[...s];u.splice(a,1),o(u)}}else if($i(s)){const a=new Set(s);i?a.add(r):a.delete(r),o(a)}else o(xv(n,i))})},mounted:$g,beforeUpdate(n,e,t){n[wn]=nr(t),$g(n,e,t)}};function $g(n,{value:e,oldValue:t},s){n._modelValue=e;let r;if(we(e))r=bd(e,s.props.value)>-1;else if($i(e))r=e.has(s.props.value);else{if(e===t)return;r=Nr(e,xv(n,!0))}n.checked!==r&&(n.checked=r)}const MC={created(n,{value:e},t){n.checked=Nr(e,t.props.value),n[wn]=nr(t),cs(n,"change",()=>{n[wn](Ii(n))})},beforeUpdate(n,{value:e,oldValue:t},s){n[wn]=nr(s),e!==t&&(n.checked=Nr(e,s.props.value))}},Rv={deep:!0,created(n,{value:e,modifiers:{number:t}},s){const r=$i(e);cs(n,"change",()=>{const i=Array.prototype.filter.call(n.options,o=>o.selected).map(o=>t?Ml(Ii(o)):Ii(o));n[wn](n.multiple?r?new Set(i):i:i[0]),n._assigning=!0,Zo(()=>{n._assigning=!1})}),n[wn]=nr(s)},mounted(n,{value:e}){jg(n,e)},beforeUpdate(n,e,t){n[wn]=nr(t)},updated(n,{value:e}){n._assigning||jg(n,e)}};function jg(n,e){const t=n.multiple,s=we(e);if(!(t&&!s&&!$i(e))){for(let r=0,i=n.options.length;r<i;r++){const o=n.options[r],a=Ii(o);if(t)if(s){const c=typeof a;c==="string"||c==="number"?o.selected=e.some(u=>String(u)===String(a)):o.selected=bd(e,a)>-1}else o.selected=e.has(a);else if(Nr(Ii(o),e)){n.selectedIndex!==r&&(n.selectedIndex=r);return}}!t&&n.selectedIndex!==-1&&(n.selectedIndex=-1)}}function Ii(n){return"_value"in n?n._value:n.value}function xv(n,e){const t=e?"_trueValue":"_falseValue";return t in n?n[t]:e}const Pv={created(n,e,t){ll(n,e,t,null,"created")},mounted(n,e,t){ll(n,e,t,null,"mounted")},beforeUpdate(n,e,t,s){ll(n,e,t,s,"beforeUpdate")},updated(n,e,t,s){ll(n,e,t,s,"updated")}};function LC(n,e){switch(n){case"SELECT":return Rv;case"TEXTAREA":return Hn;default:switch(e){case"checkbox":return OC;case"radio":return MC;default:return Hn}}}function ll(n,e,t,s,r){const o=LC(n.tagName,t.props&&t.props.type)[r];o&&o(n,e,t,s)}const VC=["ctrl","shift","alt","meta"],FC={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>VC.some(t=>n[`${t}Key`]&&!e.includes(t))},Uc=(n,e)=>{const t=n._withMods||(n._withMods={}),s=e.join(".");return t[s]||(t[s]=(r,...i)=>{for(let o=0;o<e.length;o++){const a=FC[e[o]];if(a&&a(r,e))return}return n(r,...i)})},UC={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},BC=(n,e)=>{const t=n._withKeys||(n._withKeys={}),s=e.join(".");return t[s]||(t[s]=r=>{if(!("key"in r))return;const i=pr(r.key);if(e.some(o=>o===i||UC[o]===i))return n(r)})},$C=Wt({patchProp:kC},mC);let Hg;function jC(){return Hg||(Hg=Bb($C))}const HC=(...n)=>{const e=jC().createApp(...n),{mount:t}=e;return e.mount=s=>{const r=WC(s);if(!r)return;const i=e._component;!xe(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const o=t(r,!1,GC(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e};function GC(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function WC(n){return mt(n)?document.querySelector(n):n}const qC=()=>{};var Gg={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ee=function(n,e){if(!n)throw Gi(e)},Gi=function(n){return new Error("Firebase Database ("+kv.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uv(n,e){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},s=e||"demo-project",r=n.iat||0,i=n.sub||n.user_id;if(!i)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:r,exp:r+3600,auth_time:r,sub:i,user_id:i,firebase:{sign_in_provider:"custom",identities:{}}},n);return[Wl(JSON.stringify(t)),Wl(JSON.stringify(o)),""].join(".")}const Vo={};function tA(){const n={prod:[],emulator:[]};for(const e of Object.keys(Vo))Vo[e]?n.emulator.push(e):n.prod.push(e);return n}function nA(n){let e=document.getElementById(n),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",n),t=!0),{created:t,element:e}}let Wg=!1;function Bd(n,e){if(typeof window>"u"||typeof document>"u"||!$r(window.location.host)||Vo[n]===e||Vo[n]||Wg)return;Vo[n]=e;function t(p){return`__firebase__banner__${p}`}const s="__firebase__banner",i=tA().prod.length>0;function o(){const p=document.getElementById(s);p&&p.remove()}function a(p){p.style.display="flex",p.style.background="#7faaf0",p.style.position="fixed",p.style.bottom="5px",p.style.left="5px",p.style.padding=".5em",p.style.borderRadius="5px",p.style.alignItems="center"}function c(p,m){p.setAttribute("width","24"),p.setAttribute("id",m),p.setAttribute("height","24"),p.setAttribute("viewBox","0 0 24 24"),p.setAttribute("fill","none"),p.style.marginLeft="-6px"}function u(){const p=document.createElement("span");return p.style.cursor="pointer",p.style.marginLeft="16px",p.style.fontSize="24px",p.innerHTML=" &times;",p.onclick=()=>{Wg=!0,o()},p}function h(p,m){p.setAttribute("id",m),p.innerText="Learn more",p.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",p.setAttribute("target","__blank"),p.style.paddingLeft="5px",p.style.textDecoration="underline"}function d(){const p=nA(s),m=t("text"),v=document.getElementById(m)||document.createElement("span"),b=t("learnmore"),S=document.getElementById(b)||document.createElement("a"),L=t("preprendIcon"),V=document.getElementById(L)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(p.created){const B=p.element;a(B),h(S,b);const j=u();c(V,L),B.append(V,v,S,j),document.body.appendChild(B)}i?(v.innerText="Preview backend disconnected.",V.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $v=function(n){let e={},t={},s={},r="";try{const i=n.split(".");e=sa(ql(i[0])||""),t=sa(ql(i[1])||""),r=i[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:r}},pA=function(n){const e=$v(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},gA=function(n){const e=$v(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BA{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if($A(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function $A(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Dh="@firebase/app",Yg="0.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vS="firebase-heartbeat-database",ES=1,ra="firebase-heartbeat-store";let nh=null;function Wv(){return nh||(nh=VA(vS,ES,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(ra)}catch(t){console.warn(t)}}}}).catch(n=>{throw Ks.create("idb-open",{originalErrorMessage:n.message})})),nh}async function wS(n){try{const t=(await Wv()).transaction(ra),s=await t.objectStore(ra).get(qv(n));return await t.done,s}catch(e){if(e instanceof Ps)Is.warn(e.message);else{const t=Ks.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Is.warn(t.message)}}}async function Xg(n,e){try{const s=(await Wv()).transaction(ra,"readwrite");await s.objectStore(ra).put(e,qv(n)),await s.done}catch(t){if(t instanceof Ps)Is.warn(t.message);else{const s=Ks.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Is.warn(s.message)}}}function qv(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TS=1024,IS=30;class bS{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new AS(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,t;try{const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Zg();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(o=>o.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:r}),this._heartbeatsCache.heartbeats.length>IS){const o=SS(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(s){Is.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Zg(),{heartbeatsToSend:s,unsentEntries:r}=CS(this._heartbeatsCache.heartbeats),i=Wl(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(t){return Is.warn(t),""}}}function Zg(){return new Date().toISOString().substring(0,10)}function CS(n,e=TS){const t=[];let s=n.slice();for(const r of n){const i=t.find(o=>o.agent===r.agent);if(i){if(i.dates.push(r.date),em(t)>e){i.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),em(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class AS{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return cA()?uA().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await wS(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Xg(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Xg(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function em(n){return Wl(JSON.stringify({version:2,heartbeats:n})).length}function SS(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let s=1;s<n.length;s++)n[s].date<t&&(t=n[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lh(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function PS(){return tm()==="http:"||tm()==="https:"}function tm(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GS(n,e){const t=await Xv(n,{},async()=>{const s=Wi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:i}=n.config,o=await Zv(n,r,"/v1/token",`key=${i}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Jv.fetch()(o,{method:"POST",headers:a,body:s})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function WS(n,e){return Ns(n,"POST","/v2/accounts:revokeToken",gr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mi{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Ie(e.idToken,"internal-error"),Ie(typeof e.idToken<"u","internal-error"),Ie(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):sm(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){Ie(e.length!==0,"internal-error");const t=sm(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(Ie(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:r,expiresIn:i}=await GS(e,t);this.updateTokensAndExpiration(s,r,Number(i))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:r,expirationTime:i}=t,o=new mi;return s&&(Ie(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),r&&(Ie(typeof r=="string","internal-error",{appName:e}),o.accessToken=r),i&&(Ie(typeof i=="number","internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new mi,this.toJSON())}_performRefresh(){return ps("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rm=new Map;function gs(n){bs(n instanceof Function,"Expected a class definition");let e=rm.get(n);return e?(bs(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,rm.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function d0(n,e=[]){let t;switch(n){case"Browser":t=im(qt());break;case"Worker":t=`${im(qt())}-${n}`;break;default:t=n}const s=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${jr}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QS(n,e={}){return Ns(n,"GET","/v2/passwordPolicy",gr(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Wc={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function ZS(n){Wc=n}function f0(n){return Wc.loadJS(n)}function eR(){return Wc.recaptchaEnterpriseScript}function tR(){return Wc.gapiScript}function nR(n){return`__${n}${Math.floor(Math.random()*1e6)}`}class sR{constructor(){this.enterprise=new rR}ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}class rR{ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}const iR="recaptcha-enterprise",p0="NO_RECAPTCHA";class oR{constructor(e){this.type=iR,this.auth=Hr(e)}async verify(e="verify",t=!1){async function s(i){if(!t){if(i.tenantId==null&&i._agentRecaptchaConfig!=null)return i._agentRecaptchaConfig.siteKey;if(i.tenantId!=null&&i._tenantRecaptchaConfigs[i.tenantId]!==void 0)return i._tenantRecaptchaConfigs[i.tenantId].siteKey}return new Promise(async(o,a)=>{US(i,{clientType:"CLIENT_TYPE_WEB",version:"RECAPTCHA_ENTERPRISE"}).then(c=>{if(c.recaptchaKey===void 0)a(new Error("recaptcha Enterprise site key undefined"));else{const u=new FS(c);return i.tenantId==null?i._agentRecaptchaConfig=u:i._tenantRecaptchaConfigs[i.tenantId]=u,o(u.siteKey)}}).catch(c=>{a(c)})})}function r(i,o,a){const c=window.grecaptcha;nm(c)?c.enterprise.ready(()=>{c.enterprise.execute(i,{action:e}).then(u=>{o(u)}).catch(()=>{o(p0)})}):a(Error("No reCAPTCHA enterprise script loaded."))}return this.auth.settings.appVerificationDisabledForTesting?new sR().execute("siteKey",{action:"verify"}):new Promise((i,o)=>{s(this.auth).then(a=>{if(!t&&nm(window.grecaptcha))r(a,i,o);else{if(typeof window>"u"){o(new Error("RecaptchaVerifier is only supported in browser"));return}let c=eR();c.length!==0&&(c+=a),f0(c).then(()=>{r(a,i,o)}).catch(u=>{o(u)})}}).catch(a=>{o(a)})})}}async function am(n,e,t,s=!1,r=!1){const i=new oR(n);let o;if(r)o=p0;else try{o=await i.verify(t)}catch{o=await i.verify(t,!0)}const a=Object.assign({},e);if(t==="mfaSmsEnrollment"||t==="mfaSmsSignIn"){if("phoneEnrollmentInfo"in a){const c=a.phoneEnrollmentInfo.phoneNumber,u=a.phoneEnrollmentInfo.recaptchaToken;Object.assign(a,{phoneEnrollmentInfo:{phoneNumber:c,recaptchaToken:u,captchaResponse:o,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}else if("phoneSignInInfo"in a){const c=a.phoneSignInInfo.recaptchaToken;Object.assign(a,{phoneSignInInfo:{recaptchaToken:c,captchaResponse:o,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}return a}return s?Object.assign(a,{captchaResp:o}):Object.assign(a,{captchaResponse:o}),Object.assign(a,{clientType:"CLIENT_TYPE_WEB"}),Object.assign(a,{recaptchaVersion:"RECAPTCHA_ENTERPRISE"}),a}async function Uh(n,e,t,s,r){var i;if(!((i=n._getRecaptchaConfig())===null||i===void 0)&&i.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")){const o=await am(n,e,t,t==="getOobCode");return s(n,o)}else return s(n,e).catch(async o=>{if(o.code==="auth/missing-recaptcha-token"){console.log(`${t} is protected by reCAPTCHA Enterprise for this project. Automatically triggering the reCAPTCHA flow and restarting the flow.`);const a=await am(n,e,t,t==="getOobCode");return s(n,a)}else return Promise.reject(o)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function g0(n,e){const t=Gc(n,"auth");if(t.isInitialized()){const r=t.getImmediate(),i=t.getOptions();if(Ts(i,e??{}))return r;Nn(r,"already-initialized")}return t.initialize({options:e})}function aR(n,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(gs);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function m0(n,e,t){const s=Hr(n);Ie(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const r=!1,i=_0(e),{host:o,port:a}=lR(e),c=a===null?"":`:${a}`,u={url:`${i}//${o}${c}/`},h=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:r})});if(!s._canInitEmulator){Ie(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),Ie(Ts(u,s.config.emulator)&&Ts(h,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=u,s.emulatorConfig=h,s.settings.appVerificationDisabledForTesting=!0,$r(o)?(Ud(`${i}//${o}${c}`),Bd("Auth",!0)):cR()}function _0(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function lR(n){const e=_0(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",r=/^(\[[^\]]+\])(:|$)/.exec(s);if(r){const i=r[1];return{host:i,port:lm(s.substr(i.length+1))}}else{const[i,o]=s.split(":");return{host:i,port:lm(o)}}}function lm(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function cR(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hR(n,e){return Sa(n,"POST","/v1/accounts:signInWithPassword",gr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dR(n,e){return Sa(n,"POST","/v1/accounts:signInWithEmailLink",gr(n,e))}async function fR(n,e){return Sa(n,"POST","/v1/accounts:signInWithEmailLink",gr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yi(n,e){return Sa(n,"POST","/v1/accounts:signInWithIdp",gr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gR(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function mR(n){const e=Co(Ao(n)).link,t=e?Co(Ao(e)).deep_link_id:null,s=Co(Ao(n)).deep_link_id;return(s?Co(Ao(s)).link:null)||s||t||e||n}class zc{constructor(e){var t,s,r,i,o,a;const c=Co(Ao(e)),u=(t=c.apiKey)!==null&&t!==void 0?t:null,h=(s=c.oobCode)!==null&&s!==void 0?s:null,d=gR((r=c.mode)!==null&&r!==void 0?r:null);Ie(u&&h&&d,"argument-error"),this.apiKey=u,this.operation=d,this.code=h,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.lang)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=mR(e);try{return new zc(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(){this.providerId=Gr.PROVIDER_ID}static credential(e,t){return Ai._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const s=zc.parseLink(t);return Ie(s,"argument-error"),Ai._fromEmailAndCode(e,s.code,s.tenantId)}}Gr.PROVIDER_ID="password";Gr.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Gr.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _R(n,e){return Sa(n,"POST","/v1/accounts:signUp",gr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Or{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,s,r=!1){const i=await An._fromIdTokenResponse(e,s,r),o=cm(s);return new Or({user:i,providerId:o,_tokenResponse:s,operationType:t})}static async _forOperation(e,t,s){await e._updateTokensIfNecessary(s,!0);const r=cm(s);return new Or({user:e,providerId:r,_tokenResponse:s,operationType:t})}}function cm(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function T0(n){const e=Hr(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function I0(n,e,t){if(un(n.app))return Promise.reject(_s(n));const s=Hr(n),o=await Uh(s,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",_R).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&T0(n),c}),a=await Or._fromIdTokenResponse(s,"signIn",o);return await s._updateCurrentUser(a.user),a}function b0(n,e,t){return un(n.app)?Promise.reject(_s(n)):w0(et(n),Gr.credential(e,t)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&T0(n),s})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function OR(n,e){return e?gs(e):(Ie(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ex=new Aa(3e4,6e4);function fm(){const n=qn().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function tx(n){return new Promise((e,t)=>{var s,r,i;function o(){fm(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{fm(),t(Wn(n,"network-request-failed"))},timeout:ex.get()})}if(!((r=(s=qn().gapi)===null||s===void 0?void 0:s.iframes)===null||r===void 0)&&r.Iframe)e(gapi.iframes.getContext());else if(!((i=qn().gapi)===null||i===void 0)&&i.load)o();else{const a=nR("iframefcb");return qn()[a]=()=>{gapi.load?o():t(Wn(n,"network-request-failed"))},f0(`${tR()}?onload=${a}`).catch(c=>t(c))}}).catch(e=>{throw Sl=null,e})}let Sl=null;function nx(n){return Sl=Sl||tx(n),Sl}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ux={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},hx=500,dx=600,fx="_blank",px="http://localhost";class pm{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function gx(n,e,t,s=hx,r=dx){const i=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-s)/2,0).toString();let a="";const c=Object.assign(Object.assign({},ux),{width:s.toString(),height:r.toString(),top:i,left:o}),u=qt().toLowerCase();t&&(a=o0(u)?fx:t),r0(u)&&(e=e||px,c.scrollbars="yes");const h=Object.entries(c).reduce((p,[m,v])=>`${p}${m}=${v},`,"");if(qS(u)&&a!=="_self")return mx(e||"",a),new pm(null);const d=window.open(e||"",a,h);Ie(d,n,"popup-blocked");try{d.focus()}catch{}return new pm(d)}function mx(n,e){const t=document.createElement("a");t.href=n,t.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _x="__/auth/handler",yx="emulator/auth/handler",vx=encodeURIComponent("fac");async function gm(n,e,t,s,r,i){Ie(n.config.authDomain,n,"auth-domain-config-required"),Ie(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:jr,eventId:r};if(e instanceof y0){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Ph(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[h,d]of Object.entries({}))o[h]=d}if(e instanceof Ra){const h=e.getScopes().filter(d=>d!=="");h.length>0&&(o.scopes=h.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const h of Object.keys(a))a[h]===void 0&&delete a[h];const c=await n._getAppCheckToken(),u=c?`#${vx}=${encodeURIComponent(c)}`:"";return`${Ex(n)}?${Wi(a).slice(1)}${u}`}function Ex({config:n}){return n.emulator?zd(n,yx):`https://${n.authDomain}/${_x}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cx=5*60,Ax=Fv("authIdTokenMaxAge")||Cx;let ym=null;const Sx=n=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>Ax)return;const r=t==null?void 0:t.token;ym!==r&&(ym=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Wr(n=Gd()){const e=Gc(n,"auth");if(e.isInitialized())return e.getImmediate();const t=g0(n,{popupRedirectResolver:F0,persistence:[M0,x0,Xd]}),s=Fv("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(s,location.origin);if(location.origin===i.origin){const o=Sx(i.toString());A0(t,o,()=>o(t.currentUser)),C0(t,a=>o(a))}}const r=Mv("auth");return r&&m0(t,`http://${r}`),t}function Rx(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}ZS({loadJS(n){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",n),s.onload=e,s.onerror=r=>{const i=Wn("internal-error");i.customData=r,t(i)},s.type="text/javascript",s.charset="UTF-8",Rx().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});bx("Browser");const xx=Object.freeze(Object.defineProperty({__proto__:null,ActionCodeURL:zc,AuthCredential:qc,EmailAuthCredential:Ai,EmailAuthProvider:Gr,FacebookAuthProvider:us,GithubAuthProvider:ds,GoogleAuthProvider:hs,OAuthCredential:rr,TwitterAuthProvider:fs,beforeAuthStateChanged:A0,browserLocalPersistence:x0,browserPopupRedirectResolver:F0,browserSessionPersistence:Xd,connectAuthEmulator:m0,createUserWithEmailAndPassword:I0,getAuth:Wr,getIdTokenResult:e0,inMemoryPersistence:Fh,indexedDBLocalPersistence:M0,initializeAuth:g0,onAuthStateChanged:qi,onIdTokenChanged:C0,prodErrorMap:Kv,reload:t0,signInWithCredential:w0,signInWithEmailAndPassword:b0,signOut:Jd,updateProfile:Yd},Symbol.toStringTag,{value:"Module"}));var Px="firebase",kx="11.8.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Gn(Px,kx,"app");var vm=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Qs,U0;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(A,E){function I(){}I.prototype=E.prototype,A.D=E.prototype,A.prototype=new I,A.prototype.constructor=A,A.C=function(R,P,N){for(var T=Array(arguments.length-2),Ye=2;Ye<arguments.length;Ye++)T[Ye-2]=arguments[Ye];return E.prototype[P].apply(R,T)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function r(A,E,I){I||(I=0);var R=Array(16);if(typeof E=="string")for(var P=0;16>P;++P)R[P]=E.charCodeAt(I++)|E.charCodeAt(I++)<<8|E.charCodeAt(I++)<<16|E.charCodeAt(I++)<<24;else for(P=0;16>P;++P)R[P]=E[I++]|E[I++]<<8|E[I++]<<16|E[I++]<<24;E=A.g[0],I=A.g[1],P=A.g[2];var N=A.g[3],T=E+(N^I&(P^N))+R[0]+3614090360&4294967295;E=I+(T<<7&4294967295|T>>>25),T=N+(P^E&(I^P))+R[1]+3905402710&4294967295,N=E+(T<<12&4294967295|T>>>20),T=P+(I^N&(E^I))+R[2]+606105819&4294967295,P=N+(T<<17&4294967295|T>>>15),T=I+(E^P&(N^E))+R[3]+3250441966&4294967295,I=P+(T<<22&4294967295|T>>>10),T=E+(N^I&(P^N))+R[4]+4118548399&4294967295,E=I+(T<<7&4294967295|T>>>25),T=N+(P^E&(I^P))+R[5]+1200080426&4294967295,N=E+(T<<12&4294967295|T>>>20),T=P+(I^N&(E^I))+R[6]+2821735955&4294967295,P=N+(T<<17&4294967295|T>>>15),T=I+(E^P&(N^E))+R[7]+4249261313&4294967295,I=P+(T<<22&4294967295|T>>>10),T=E+(N^I&(P^N))+R[8]+1770035416&4294967295,E=I+(T<<7&4294967295|T>>>25),T=N+(P^E&(I^P))+R[9]+2336552879&4294967295,N=E+(T<<12&4294967295|T>>>20),T=P+(I^N&(E^I))+R[10]+4294925233&4294967295,P=N+(T<<17&4294967295|T>>>15),T=I+(E^P&(N^E))+R[11]+2304563134&4294967295,I=P+(T<<22&4294967295|T>>>10),T=E+(N^I&(P^N))+R[12]+1804603682&4294967295,E=I+(T<<7&4294967295|T>>>25),T=N+(P^E&(I^P))+R[13]+4254626195&4294967295,N=E+(T<<12&4294967295|T>>>20),T=P+(I^N&(E^I))+R[14]+2792965006&4294967295,P=N+(T<<17&4294967295|T>>>15),T=I+(E^P&(N^E))+R[15]+1236535329&4294967295,I=P+(T<<22&4294967295|T>>>10),T=E+(P^N&(I^P))+R[1]+4129170786&4294967295,E=I+(T<<5&4294967295|T>>>27),T=N+(I^P&(E^I))+R[6]+3225465664&4294967295,N=E+(T<<9&4294967295|T>>>23),T=P+(E^I&(N^E))+R[11]+643717713&4294967295,P=N+(T<<14&4294967295|T>>>18),T=I+(N^E&(P^N))+R[0]+3921069994&4294967295,I=P+(T<<20&4294967295|T>>>12),T=E+(P^N&(I^P))+R[5]+3593408605&4294967295,E=I+(T<<5&4294967295|T>>>27),T=N+(I^P&(E^I))+R[10]+38016083&4294967295,N=E+(T<<9&4294967295|T>>>23),T=P+(E^I&(N^E))+R[15]+3634488961&4294967295,P=N+(T<<14&4294967295|T>>>18),T=I+(N^E&(P^N))+R[4]+3889429448&4294967295,I=P+(T<<20&4294967295|T>>>12),T=E+(P^N&(I^P))+R[9]+568446438&4294967295,E=I+(T<<5&4294967295|T>>>27),T=N+(I^P&(E^I))+R[14]+3275163606&4294967295,N=E+(T<<9&4294967295|T>>>23),T=P+(E^I&(N^E))+R[3]+4107603335&4294967295,P=N+(T<<14&4294967295|T>>>18),T=I+(N^E&(P^N))+R[8]+1163531501&4294967295,I=P+(T<<20&4294967295|T>>>12),T=E+(P^N&(I^P))+R[13]+2850285829&4294967295,E=I+(T<<5&4294967295|T>>>27),T=N+(I^P&(E^I))+R[2]+4243563512&4294967295,N=E+(T<<9&4294967295|T>>>23),T=P+(E^I&(N^E))+R[7]+1735328473&4294967295,P=N+(T<<14&4294967295|T>>>18),T=I+(N^E&(P^N))+R[12]+2368359562&4294967295,I=P+(T<<20&4294967295|T>>>12),T=E+(I^P^N)+R[5]+4294588738&4294967295,E=I+(T<<4&4294967295|T>>>28),T=N+(E^I^P)+R[8]+2272392833&4294967295,N=E+(T<<11&4294967295|T>>>21),T=P+(N^E^I)+R[11]+1839030562&4294967295,P=N+(T<<16&4294967295|T>>>16),T=I+(P^N^E)+R[14]+4259657740&4294967295,I=P+(T<<23&4294967295|T>>>9),T=E+(I^P^N)+R[1]+2763975236&4294967295,E=I+(T<<4&4294967295|T>>>28),T=N+(E^I^P)+R[4]+1272893353&4294967295,N=E+(T<<11&4294967295|T>>>21),T=P+(N^E^I)+R[7]+4139469664&4294967295,P=N+(T<<16&4294967295|T>>>16),T=I+(P^N^E)+R[10]+3200236656&4294967295,I=P+(T<<23&4294967295|T>>>9),T=E+(I^P^N)+R[13]+681279174&4294967295,E=I+(T<<4&4294967295|T>>>28),T=N+(E^I^P)+R[0]+3936430074&4294967295,N=E+(T<<11&4294967295|T>>>21),T=P+(N^E^I)+R[3]+3572445317&4294967295,P=N+(T<<16&4294967295|T>>>16),T=I+(P^N^E)+R[6]+76029189&4294967295,I=P+(T<<23&4294967295|T>>>9),T=E+(I^P^N)+R[9]+3654602809&4294967295,E=I+(T<<4&4294967295|T>>>28),T=N+(E^I^P)+R[12]+3873151461&4294967295,N=E+(T<<11&4294967295|T>>>21),T=P+(N^E^I)+R[15]+530742520&4294967295,P=N+(T<<16&4294967295|T>>>16),T=I+(P^N^E)+R[2]+3299628645&4294967295,I=P+(T<<23&4294967295|T>>>9),T=E+(P^(I|~N))+R[0]+4096336452&4294967295,E=I+(T<<6&4294967295|T>>>26),T=N+(I^(E|~P))+R[7]+1126891415&4294967295,N=E+(T<<10&4294967295|T>>>22),T=P+(E^(N|~I))+R[14]+2878612391&4294967295,P=N+(T<<15&4294967295|T>>>17),T=I+(N^(P|~E))+R[5]+4237533241&4294967295,I=P+(T<<21&4294967295|T>>>11),T=E+(P^(I|~N))+R[12]+1700485571&4294967295,E=I+(T<<6&4294967295|T>>>26),T=N+(I^(E|~P))+R[3]+2399980690&4294967295,N=E+(T<<10&4294967295|T>>>22),T=P+(E^(N|~I))+R[10]+4293915773&4294967295,P=N+(T<<15&4294967295|T>>>17),T=I+(N^(P|~E))+R[1]+2240044497&4294967295,I=P+(T<<21&4294967295|T>>>11),T=E+(P^(I|~N))+R[8]+1873313359&4294967295,E=I+(T<<6&4294967295|T>>>26),T=N+(I^(E|~P))+R[15]+4264355552&4294967295,N=E+(T<<10&4294967295|T>>>22),T=P+(E^(N|~I))+R[6]+2734768916&4294967295,P=N+(T<<15&4294967295|T>>>17),T=I+(N^(P|~E))+R[13]+1309151649&4294967295,I=P+(T<<21&4294967295|T>>>11),T=E+(P^(I|~N))+R[4]+4149444226&4294967295,E=I+(T<<6&4294967295|T>>>26),T=N+(I^(E|~P))+R[11]+3174756917&4294967295,N=E+(T<<10&4294967295|T>>>22),T=P+(E^(N|~I))+R[2]+718787259&4294967295,P=N+(T<<15&4294967295|T>>>17),T=I+(N^(P|~E))+R[9]+3951481745&4294967295,A.g[0]=A.g[0]+E&4294967295,A.g[1]=A.g[1]+(P+(T<<21&4294967295|T>>>11))&4294967295,A.g[2]=A.g[2]+P&4294967295,A.g[3]=A.g[3]+N&4294967295}s.prototype.u=function(A,E){E===void 0&&(E=A.length);for(var I=E-this.blockSize,R=this.B,P=this.h,N=0;N<E;){if(P==0)for(;N<=I;)r(this,A,N),N+=this.blockSize;if(typeof A=="string"){for(;N<E;)if(R[P++]=A.charCodeAt(N++),P==this.blockSize){r(this,R),P=0;break}}else for(;N<E;)if(R[P++]=A[N++],P==this.blockSize){r(this,R),P=0;break}}this.h=P,this.o+=E},s.prototype.v=function(){var A=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);A[0]=128;for(var E=1;E<A.length-8;++E)A[E]=0;var I=8*this.o;for(E=A.length-8;E<A.length;++E)A[E]=I&255,I/=256;for(this.u(A),A=Array(16),E=I=0;4>E;++E)for(var R=0;32>R;R+=8)A[I++]=this.g[E]>>>R&255;return A};function i(A,E){var I=a;return Object.prototype.hasOwnProperty.call(I,A)?I[A]:I[A]=E(A)}function o(A,E){this.h=E;for(var I=[],R=!0,P=A.length-1;0<=P;P--){var N=A[P]|0;R&&N==E||(I[P]=N,R=!1)}this.g=I}var a={};function c(A){return-128<=A&&128>A?i(A,function(E){return new o([E|0],0>E?-1:0)}):new o([A|0],0>A?-1:0)}function u(A){if(isNaN(A)||!isFinite(A))return d;if(0>A)return S(u(-A));for(var E=[],I=1,R=0;A>=I;R++)E[R]=A/I|0,I*=4294967296;return new o(E,0)}function h(A,E){if(A.length==0)throw Error("number format error: empty string");if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(A.charAt(0)=="-")return S(h(A.substring(1),E));if(0<=A.indexOf("-"))throw Error('number format error: interior "-" character');for(var I=u(Math.pow(E,8)),R=d,P=0;P<A.length;P+=8){var N=Math.min(8,A.length-P),T=parseInt(A.substring(P,P+N),E);8>N?(N=u(Math.pow(E,N)),R=R.j(N).add(u(T))):(R=R.j(I),R=R.add(u(T)))}return R}var d=c(0),p=c(1),m=c(16777216);n=o.prototype,n.m=function(){if(b(this))return-S(this).m();for(var A=0,E=1,I=0;I<this.g.length;I++){var R=this.i(I);A+=(0<=R?R:4294967296+R)*E,E*=4294967296}return A},n.toString=function(A){if(A=A||10,2>A||36<A)throw Error("radix out of range: "+A);if(v(this))return"0";if(b(this))return"-"+S(this).toString(A);for(var E=u(Math.pow(A,6)),I=this,R="";;){var P=j(I,E).g;I=L(I,P.j(E));var N=((0<I.g.length?I.g[0]:I.h)>>>0).toString(A);if(I=P,v(I))return N+R;for(;6>N.length;)N="0"+N;R=N+R}},n.i=function(A){return 0>A?0:A<this.g.length?this.g[A]:this.h};function v(A){if(A.h!=0)return!1;for(var E=0;E<A.g.length;E++)if(A.g[E]!=0)return!1;return!0}function b(A){return A.h==-1}n.l=function(A){return A=L(this,A),b(A)?-1:v(A)?0:1};function S(A){for(var E=A.g.length,I=[],R=0;R<E;R++)I[R]=~A.g[R];return new o(I,~A.h).add(p)}n.abs=function(){return b(this)?S(this):this},n.add=function(A){for(var E=Math.max(this.g.length,A.g.length),I=[],R=0,P=0;P<=E;P++){var N=R+(this.i(P)&65535)+(A.i(P)&65535),T=(N>>>16)+(this.i(P)>>>16)+(A.i(P)>>>16);R=T>>>16,N&=65535,T&=65535,I[P]=T<<16|N}return new o(I,I[I.length-1]&-2147483648?-1:0)};function L(A,E){return A.add(S(E))}n.j=function(A){if(v(this)||v(A))return d;if(b(this))return b(A)?S(this).j(S(A)):S(S(this).j(A));if(b(A))return S(this.j(S(A)));if(0>this.l(m)&&0>A.l(m))return u(this.m()*A.m());for(var E=this.g.length+A.g.length,I=[],R=0;R<2*E;R++)I[R]=0;for(R=0;R<this.g.length;R++)for(var P=0;P<A.g.length;P++){var N=this.i(R)>>>16,T=this.i(R)&65535,Ye=A.i(P)>>>16,_e=A.i(P)&65535;I[2*R+2*P]+=T*_e,V(I,2*R+2*P),I[2*R+2*P+1]+=N*_e,V(I,2*R+2*P+1),I[2*R+2*P+1]+=T*Ye,V(I,2*R+2*P+1),I[2*R+2*P+2]+=N*Ye,V(I,2*R+2*P+2)}for(R=0;R<E;R++)I[R]=I[2*R+1]<<16|I[2*R];for(R=E;R<2*E;R++)I[R]=0;return new o(I,0)};function V(A,E){for(;(A[E]&65535)!=A[E];)A[E+1]+=A[E]>>>16,A[E]&=65535,E++}function B(A,E){this.g=A,this.h=E}function j(A,E){if(v(E))throw Error("division by zero");if(v(A))return new B(d,d);if(b(A))return E=j(S(A),E),new B(S(E.g),S(E.h));if(b(E))return E=j(A,S(E)),new B(S(E.g),E.h);if(30<A.g.length){if(b(A)||b(E))throw Error("slowDivide_ only works with positive integers.");for(var I=p,R=E;0>=R.l(A);)I=fe(I),R=fe(R);var P=ue(I,1),N=ue(R,1);for(R=ue(R,2),I=ue(I,2);!v(R);){var T=N.add(R);0>=T.l(A)&&(P=P.add(I),N=T),R=ue(R,1),I=ue(I,1)}return E=L(A,P.j(E)),new B(P,E)}for(P=d;0<=A.l(E);){for(I=Math.max(1,Math.floor(A.m()/E.m())),R=Math.ceil(Math.log(I)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),N=u(I),T=N.j(E);b(T)||0<T.l(A);)I-=R,N=u(I),T=N.j(E);v(N)&&(N=p),P=P.add(N),A=L(A,T)}return new B(P,A)}n.A=function(A){return j(this,A).h},n.and=function(A){for(var E=Math.max(this.g.length,A.g.length),I=[],R=0;R<E;R++)I[R]=this.i(R)&A.i(R);return new o(I,this.h&A.h)},n.or=function(A){for(var E=Math.max(this.g.length,A.g.length),I=[],R=0;R<E;R++)I[R]=this.i(R)|A.i(R);return new o(I,this.h|A.h)},n.xor=function(A){for(var E=Math.max(this.g.length,A.g.length),I=[],R=0;R<E;R++)I[R]=this.i(R)^A.i(R);return new o(I,this.h^A.h)};function fe(A){for(var E=A.g.length+1,I=[],R=0;R<E;R++)I[R]=A.i(R)<<1|A.i(R-1)>>>31;return new o(I,A.h)}function ue(A,E){var I=E>>5;E%=32;for(var R=A.g.length-I,P=[],N=0;N<R;N++)P[N]=0<E?A.i(N+I)>>>E|A.i(N+I+1)<<32-E:A.i(N+I);return new o(P,A.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,U0=s,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=h,Qs=o}).apply(typeof vm<"u"?vm:typeof self<"u"?self:typeof window<"u"?window:{});var ul=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var B0,So,$0,Rl,$h,j0,H0,G0;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,f,g){return l==Array.prototype||l==Object.prototype||(l[f]=g.value),l};function t(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof ul=="object"&&ul];for(var f=0;f<l.length;++f){var g=l[f];if(g&&g.Math==Math)return g}throw Error("Cannot find global object")}var s=t(this);function r(l,f){if(f)e:{var g=s;l=l.split(".");for(var _=0;_<l.length-1;_++){var D=l[_];if(!(D in g))break e;g=g[D]}l=l[l.length-1],_=g[l],f=f(_),f!=_&&f!=null&&e(g,l,{configurable:!0,writable:!0,value:f})}}function i(l,f){l instanceof String&&(l+="");var g=0,_=!1,D={next:function(){if(!_&&g<l.length){var U=g++;return{value:f(U,l[U]),done:!1}}return _=!0,{done:!0,value:void 0}}};return D[Symbol.iterator]=function(){return D},D}r("Array.prototype.values",function(l){return l||function(){return i(this,function(f,g){return g})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function c(l){var f=typeof l;return f=f!="object"?f:l?Array.isArray(l)?"array":f:"null",f=="array"||f=="object"&&typeof l.length=="number"}function u(l){var f=typeof l;return f=="object"&&l!=null||f=="function"}function h(l,f,g){return l.call.apply(l.bind,arguments)}function d(l,f,g){if(!l)throw Error();if(2<arguments.length){var _=Array.prototype.slice.call(arguments,2);return function(){var D=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(D,_),l.apply(f,D)}}return function(){return l.apply(f,arguments)}}function p(l,f,g){return p=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?h:d,p.apply(null,arguments)}function m(l,f){var g=Array.prototype.slice.call(arguments,1);return function(){var _=g.slice();return _.push.apply(_,arguments),l.apply(this,_)}}function v(l,f){function g(){}g.prototype=f.prototype,l.aa=f.prototype,l.prototype=new g,l.prototype.constructor=l,l.Qb=function(_,D,U){for(var ne=Array(arguments.length-2),ze=2;ze<arguments.length;ze++)ne[ze-2]=arguments[ze];return f.prototype[D].apply(_,ne)}}function b(l){const f=l.length;if(0<f){const g=Array(f);for(let _=0;_<f;_++)g[_]=l[_];return g}return[]}function S(l,f){for(let g=1;g<arguments.length;g++){const _=arguments[g];if(c(_)){const D=l.length||0,U=_.length||0;l.length=D+U;for(let ne=0;ne<U;ne++)l[D+ne]=_[ne]}else l.push(_)}}class L{constructor(f,g){this.i=f,this.j=g,this.h=0,this.g=null}get(){let f;return 0<this.h?(this.h--,f=this.g,this.g=f.next,f.next=null):f=this.i(),f}}function V(l){return/^[\s\xa0]*$/.test(l)}function B(){var l=a.navigator;return l&&(l=l.userAgent)?l:""}function j(l){return j[" "](l),l}j[" "]=function(){};var fe=B().indexOf("Gecko")!=-1&&!(B().toLowerCase().indexOf("webkit")!=-1&&B().indexOf("Edge")==-1)&&!(B().indexOf("Trident")!=-1||B().indexOf("MSIE")!=-1)&&B().indexOf("Edge")==-1;function ue(l,f,g){for(const _ in l)f.call(g,l[_],_,l)}function A(l,f){for(const g in l)f.call(void 0,l[g],g,l)}function E(l){const f={};for(const g in l)f[g]=l[g];return f}const I="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function R(l,f){let g,_;for(let D=1;D<arguments.length;D++){_=arguments[D];for(g in _)l[g]=_[g];for(let U=0;U<I.length;U++)g=I[U],Object.prototype.hasOwnProperty.call(_,g)&&(l[g]=_[g])}}function P(l){var f=1;l=l.split(":");const g=[];for(;0<f&&l.length;)g.push(l.shift()),f--;return l.length&&g.push(l.join(":")),g}function N(l){a.setTimeout(()=>{throw l},0)}function T(){var l=ot;let f=null;return l.g&&(f=l.g,l.g=l.g.next,l.g||(l.h=null),f.next=null),f}class Ye{constructor(){this.h=this.g=null}add(f,g){const _=_e.get();_.set(f,g),this.h?this.h.next=_:this.g=_,this.h=_}}var _e=new L(()=>new pe,l=>l.reset());class pe{constructor(){this.next=this.g=this.h=null}set(f,g){this.h=f,this.g=g,this.next=null}reset(){this.next=this.g=this.h=null}}let ve,Te=!1,ot=new Ye,rt=()=>{const l=a.Promise.resolve(void 0);ve=()=>{l.then(it)}};var it=()=>{for(var l;l=T();){try{l.h.call(l.g)}catch(g){N(g)}var f=_e;f.j(l),100>f.h&&(f.h++,l.next=f.g,f.g=l)}Te=!1};function x(){this.s=this.s,this.C=this.C}x.prototype.s=!1,x.prototype.ma=function(){this.s||(this.s=!0,this.N())},x.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function O(l,f){this.type=l,this.g=this.target=f,this.defaultPrevented=!1}O.prototype.h=function(){this.defaultPrevented=!0};var Q=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var l=!1,f=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const g=()=>{};a.addEventListener("test",g,f),a.removeEventListener("test",g,f)}catch{}return l}();function ce(l,f){if(O.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var g=this.type=l.type,_=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=f,f=l.relatedTarget){if(fe){e:{try{j(f.nodeName);var D=!0;break e}catch{}D=!1}D||(f=null)}}else g=="mouseover"?f=l.fromElement:g=="mouseout"&&(f=l.toElement);this.relatedTarget=f,_?(this.clientX=_.clientX!==void 0?_.clientX:_.pageX,this.clientY=_.clientY!==void 0?_.clientY:_.pageY,this.screenX=_.screenX||0,this.screenY=_.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:he[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&ce.aa.h.call(this)}}v(ce,O);var he={2:"touch",3:"pen",4:"mouse"};ce.prototype.h=function(){ce.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var M="closure_listenable_"+(1e6*Math.random()|0),Y=0;function F(l,f,g,_,D){this.listener=l,this.proxy=null,this.src=f,this.type=g,this.capture=!!_,this.ha=D,this.key=++Y,this.da=this.fa=!1}function H(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function oe(l){this.src=l,this.g={},this.h=0}oe.prototype.add=function(l,f,g,_,D){var U=l.toString();l=this.g[U],l||(l=this.g[U]=[],this.h++);var ne=w(l,f,_,D);return-1<ne?(f=l[ne],g||(f.fa=!1)):(f=new F(f,this.src,U,!!_,D),f.fa=g,l.push(f)),f};function y(l,f){var g=f.type;if(g in l.g){var _=l.g[g],D=Array.prototype.indexOf.call(_,f,void 0),U;(U=0<=D)&&Array.prototype.splice.call(_,D,1),U&&(H(f),l.g[g].length==0&&(delete l.g[g],l.h--))}}function w(l,f,g,_){for(var D=0;D<l.length;++D){var U=l[D];if(!U.da&&U.listener==f&&U.capture==!!g&&U.ha==_)return D}return-1}var k="closure_lm_"+(1e6*Math.random()|0),$={};function W(l,f,g,_,D){if(Array.isArray(f)){for(var U=0;U<f.length;U++)W(l,f[U],g,_,D);return null}return g=Ae(g),l&&l[M]?l.K(f,g,u(_)?!!_.capture:!1,D):G(l,f,g,!1,_,D)}function G(l,f,g,_,D,U){if(!f)throw Error("Invalid event type");var ne=u(D)?!!D.capture:!!D,ze=re(l);if(ze||(l[k]=ze=new oe(l)),g=ze.add(f,g,_,ne,U),g.proxy)return g;if(_=se(),g.proxy=_,_.src=l,_.listener=g,l.addEventListener)Q||(D=ne),D===void 0&&(D=!1),l.addEventListener(f.toString(),_,D);else if(l.attachEvent)l.attachEvent(K(f.toString()),_);else if(l.addListener&&l.removeListener)l.addListener(_);else throw Error("addEventListener and attachEvent are unavailable.");return g}function se(){function l(g){return f.call(l.src,l.listener,g)}const f=ge;return l}function te(l,f,g,_,D){if(Array.isArray(f))for(var U=0;U<f.length;U++)te(l,f[U],g,_,D);else _=u(_)?!!_.capture:!!_,g=Ae(g),l&&l[M]?(l=l.i,f=String(f).toString(),f in l.g&&(U=l.g[f],g=w(U,g,_,D),-1<g&&(H(U[g]),Array.prototype.splice.call(U,g,1),U.length==0&&(delete l.g[f],l.h--)))):l&&(l=re(l))&&(f=l.g[f.toString()],l=-1,f&&(l=w(f,g,_,D)),(g=-1<l?f[l]:null)&&X(g))}function X(l){if(typeof l!="number"&&l&&!l.da){var f=l.src;if(f&&f[M])y(f.i,l);else{var g=l.type,_=l.proxy;f.removeEventListener?f.removeEventListener(g,_,l.capture):f.detachEvent?f.detachEvent(K(g),_):f.addListener&&f.removeListener&&f.removeListener(_),(g=re(f))?(y(g,l),g.h==0&&(g.src=null,f[k]=null)):H(l)}}}function K(l){return l in $?$[l]:$[l]="on"+l}function ge(l,f){if(l.da)l=!0;else{f=new ce(f,this);var g=l.listener,_=l.ha||l.src;l.fa&&X(l),l=g.call(_,f)}return l}function re(l){return l=l[k],l instanceof oe?l:null}var de="__closure_events_fn_"+(1e9*Math.random()>>>0);function Ae(l){return typeof l=="function"?l:(l[de]||(l[de]=function(f){return l.handleEvent(f)}),l[de])}function Ee(){x.call(this),this.i=new oe(this),this.M=this,this.F=null}v(Ee,x),Ee.prototype[M]=!0,Ee.prototype.removeEventListener=function(l,f,g,_){te(this,l,f,g,_)};function Pe(l,f){var g,_=l.F;if(_)for(g=[];_;_=_.F)g.push(_);if(l=l.M,_=f.type||f,typeof f=="string")f=new O(f,l);else if(f instanceof O)f.target=f.target||l;else{var D=f;f=new O(_,l),R(f,D)}if(D=!0,g)for(var U=g.length-1;0<=U;U--){var ne=f.g=g[U];D=Ve(ne,_,!0,f)&&D}if(ne=f.g=l,D=Ve(ne,_,!0,f)&&D,D=Ve(ne,_,!1,f)&&D,g)for(U=0;U<g.length;U++)ne=f.g=g[U],D=Ve(ne,_,!1,f)&&D}Ee.prototype.N=function(){if(Ee.aa.N.call(this),this.i){var l=this.i,f;for(f in l.g){for(var g=l.g[f],_=0;_<g.length;_++)H(g[_]);delete l.g[f],l.h--}}this.F=null},Ee.prototype.K=function(l,f,g,_){return this.i.add(String(l),f,!1,g,_)},Ee.prototype.L=function(l,f,g,_){return this.i.add(String(l),f,!0,g,_)};function Ve(l,f,g,_){if(f=l.i.g[String(f)],!f)return!0;f=f.concat();for(var D=!0,U=0;U<f.length;++U){var ne=f[U];if(ne&&!ne.da&&ne.capture==g){var ze=ne.listener,xt=ne.ha||ne.src;ne.fa&&y(l.i,ne),D=ze.call(xt,_)!==!1&&D}}return D&&!_.defaultPrevented}function Dt(l,f,g){if(typeof l=="function")g&&(l=p(l,g));else if(l&&typeof l.handleEvent=="function")l=p(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(f)?-1:a.setTimeout(l,f||0)}function St(l){l.g=Dt(()=>{l.g=null,l.i&&(l.i=!1,St(l))},l.l);const f=l.h;l.h=null,l.m.apply(null,f)}class gn extends x{constructor(f,g){super(),this.m=f,this.l=g,this.h=null,this.i=!1,this.g=null}j(f){this.h=arguments,this.g?this.i=!0:St(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Ot(l){x.call(this),this.h=l,this.g={}}v(Ot,x);var Ms=[];function to(l){ue(l.g,function(f,g){this.g.hasOwnProperty(g)&&X(f)},l),l.g={}}Ot.prototype.N=function(){Ot.aa.N.call(this),to(this)},Ot.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Rt=a.JSON.stringify,mn=a.JSON.parse,Ha=class{stringify(l){return a.JSON.stringify(l,void 0)}parse(l){return a.JSON.parse(l,void 0)}};function Ru(){}Ru.prototype.h=null;function wp(l){return l.h||(l.h=l.i())}function Tp(){}var no={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function xu(){O.call(this,"d")}v(xu,O);function Pu(){O.call(this,"c")}v(Pu,O);var yr={},Ip=null;function Ga(){return Ip=Ip||new Ee}yr.La="serverreachability";function bp(l){O.call(this,yr.La,l)}v(bp,O);function so(l){const f=Ga();Pe(f,new bp(f))}yr.STAT_EVENT="statevent";function Cp(l,f){O.call(this,yr.STAT_EVENT,l),this.stat=f}v(Cp,O);function zt(l){const f=Ga();Pe(f,new Cp(f,l))}yr.Ma="timingevent";function Ap(l,f){O.call(this,yr.Ma,l),this.size=f}v(Ap,O);function ro(l,f){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){l()},f)}function io(){this.g=!0}io.prototype.xa=function(){this.g=!1};function ZT(l,f,g,_,D,U){l.info(function(){if(l.g)if(U)for(var ne="",ze=U.split("&"),xt=0;xt<ze.length;xt++){var Ue=ze[xt].split("=");if(1<Ue.length){var Mt=Ue[0];Ue=Ue[1];var Lt=Mt.split("_");ne=2<=Lt.length&&Lt[1]=="type"?ne+(Mt+"="+Ue+"&"):ne+(Mt+"=redacted&")}}else ne=null;else ne=U;return"XMLHTTP REQ ("+_+") [attempt "+D+"]: "+f+`
`+g+`
`+ne})}function eI(l,f,g,_,D,U,ne){l.info(function(){return"XMLHTTP RESP ("+_+") [ attempt "+D+"]: "+f+`
`+g+`
`+U+" "+ne})}function Yr(l,f,g,_){l.info(function(){return"XMLHTTP TEXT ("+f+"): "+nI(l,g)+(_?" "+_:"")})}function tI(l,f){l.info(function(){return"TIMEOUT: "+f})}io.prototype.info=function(){};function nI(l,f){if(!l.g)return f;if(!f)return null;try{var g=JSON.parse(f);if(g){for(l=0;l<g.length;l++)if(Array.isArray(g[l])){var _=g[l];if(!(2>_.length)){var D=_[1];if(Array.isArray(D)&&!(1>D.length)){var U=D[0];if(U!="noop"&&U!="stop"&&U!="close")for(var ne=1;ne<D.length;ne++)D[ne]=""}}}}return Rt(g)}catch{return f}}var Wa={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Sp={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},ku;function qa(){}v(qa,Ru),qa.prototype.g=function(){return new XMLHttpRequest},qa.prototype.i=function(){return{}},ku=new qa;function Ls(l,f,g,_){this.j=l,this.i=f,this.l=g,this.R=_||1,this.U=new Ot(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Rp}function Rp(){this.i=null,this.g="",this.h=!1}var xp={},Nu={};function Du(l,f,g){l.L=1,l.v=Ya(Zn(f)),l.m=g,l.P=!0,Pp(l,null)}function Pp(l,f){l.F=Date.now(),za(l),l.A=Zn(l.v);var g=l.A,_=l.R;Array.isArray(_)||(_=[String(_)]),Gp(g.i,"t",_),l.C=0,g=l.j.J,l.h=new Rp,l.g=lg(l.j,g?f:null,!l.m),0<l.O&&(l.M=new gn(p(l.Y,l,l.g),l.O)),f=l.U,g=l.g,_=l.ca;var D="readystatechange";Array.isArray(D)||(D&&(Ms[0]=D.toString()),D=Ms);for(var U=0;U<D.length;U++){var ne=W(g,D[U],_||f.handleEvent,!1,f.h||f);if(!ne)break;f.g[ne.key]=ne}f=l.H?E(l.H):{},l.m?(l.u||(l.u="POST"),f["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,f)):(l.u="GET",l.g.ea(l.A,l.u,null,f)),so(),ZT(l.i,l.u,l.A,l.l,l.R,l.m)}Ls.prototype.ca=function(l){l=l.target;const f=this.M;f&&es(l)==3?f.j():this.Y(l)},Ls.prototype.Y=function(l){try{if(l==this.g)e:{const Lt=es(this.g);var f=this.g.Ba();const Zr=this.g.Z();if(!(3>Lt)&&(Lt!=3||this.g&&(this.h.h||this.g.oa()||Jp(this.g)))){this.J||Lt!=4||f==7||(f==8||0>=Zr?so(3):so(2)),Ou(this);var g=this.g.Z();this.X=g;t:if(kp(this)){var _=Jp(this.g);l="";var D=_.length,U=es(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){vr(this),oo(this);var ne="";break t}this.h.i=new a.TextDecoder}for(f=0;f<D;f++)this.h.h=!0,l+=this.h.i.decode(_[f],{stream:!(U&&f==D-1)});_.length=0,this.h.g+=l,this.C=0,ne=this.h.g}else ne=this.g.oa();if(this.o=g==200,eI(this.i,this.u,this.A,this.l,this.R,Lt,g),this.o){if(this.T&&!this.K){t:{if(this.g){var ze,xt=this.g;if((ze=xt.g?xt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!V(ze)){var Ue=ze;break t}}Ue=null}if(g=Ue)Yr(this.i,this.l,g,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Mu(this,g);else{this.o=!1,this.s=3,zt(12),vr(this),oo(this);break e}}if(this.P){g=!0;let bn;for(;!this.J&&this.C<ne.length;)if(bn=sI(this,ne),bn==Nu){Lt==4&&(this.s=4,zt(14),g=!1),Yr(this.i,this.l,null,"[Incomplete Response]");break}else if(bn==xp){this.s=4,zt(15),Yr(this.i,this.l,ne,"[Invalid Chunk]"),g=!1;break}else Yr(this.i,this.l,bn,null),Mu(this,bn);if(kp(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Lt!=4||ne.length!=0||this.h.h||(this.s=1,zt(16),g=!1),this.o=this.o&&g,!g)Yr(this.i,this.l,ne,"[Invalid Chunked Response]"),vr(this),oo(this);else if(0<ne.length&&!this.W){this.W=!0;var Mt=this.j;Mt.g==this&&Mt.ba&&!Mt.M&&(Mt.j.info("Great, no buffering proxy detected. Bytes received: "+ne.length),$u(Mt),Mt.M=!0,zt(11))}}else Yr(this.i,this.l,ne,null),Mu(this,ne);Lt==4&&vr(this),this.o&&!this.J&&(Lt==4?rg(this.j,this):(this.o=!1,za(this)))}else EI(this.g),g==400&&0<ne.indexOf("Unknown SID")?(this.s=3,zt(12)):(this.s=0,zt(13)),vr(this),oo(this)}}}catch{}finally{}};function kp(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function sI(l,f){var g=l.C,_=f.indexOf(`
`,g);return _==-1?Nu:(g=Number(f.substring(g,_)),isNaN(g)?xp:(_+=1,_+g>f.length?Nu:(f=f.slice(_,_+g),l.C=_+g,f)))}Ls.prototype.cancel=function(){this.J=!0,vr(this)};function za(l){l.S=Date.now()+l.I,Np(l,l.I)}function Np(l,f){if(l.B!=null)throw Error("WatchDog timer not null");l.B=ro(p(l.ba,l),f)}function Ou(l){l.B&&(a.clearTimeout(l.B),l.B=null)}Ls.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(tI(this.i,this.A),this.L!=2&&(so(),zt(17)),vr(this),this.s=2,oo(this)):Np(this,this.S-l)};function oo(l){l.j.G==0||l.J||rg(l.j,l)}function vr(l){Ou(l);var f=l.M;f&&typeof f.ma=="function"&&f.ma(),l.M=null,to(l.U),l.g&&(f=l.g,l.g=null,f.abort(),f.ma())}function Mu(l,f){try{var g=l.j;if(g.G!=0&&(g.g==l||Lu(g.h,l))){if(!l.K&&Lu(g.h,l)&&g.G==3){try{var _=g.Da.g.parse(f)}catch{_=null}if(Array.isArray(_)&&_.length==3){var D=_;if(D[0]==0){e:if(!g.u){if(g.g)if(g.g.F+3e3<l.F)nl(g),el(g);else break e;Bu(g),zt(18)}}else g.za=D[1],0<g.za-g.T&&37500>D[2]&&g.F&&g.v==0&&!g.C&&(g.C=ro(p(g.Za,g),6e3));if(1>=Mp(g.h)&&g.ca){try{g.ca()}catch{}g.ca=void 0}}else wr(g,11)}else if((l.K||g.g==l)&&nl(g),!V(f))for(D=g.Da.g.parse(f),f=0;f<D.length;f++){let Ue=D[f];if(g.T=Ue[0],Ue=Ue[1],g.G==2)if(Ue[0]=="c"){g.K=Ue[1],g.ia=Ue[2];const Mt=Ue[3];Mt!=null&&(g.la=Mt,g.j.info("VER="+g.la));const Lt=Ue[4];Lt!=null&&(g.Aa=Lt,g.j.info("SVER="+g.Aa));const Zr=Ue[5];Zr!=null&&typeof Zr=="number"&&0<Zr&&(_=1.5*Zr,g.L=_,g.j.info("backChannelRequestTimeoutMs_="+_)),_=g;const bn=l.g;if(bn){const rl=bn.g?bn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(rl){var U=_.h;U.g||rl.indexOf("spdy")==-1&&rl.indexOf("quic")==-1&&rl.indexOf("h2")==-1||(U.j=U.l,U.g=new Set,U.h&&(Vu(U,U.h),U.h=null))}if(_.D){const ju=bn.g?bn.g.getResponseHeader("X-HTTP-Session-Id"):null;ju&&(_.ya=ju,tt(_.I,_.D,ju))}}g.G=3,g.l&&g.l.ua(),g.ba&&(g.R=Date.now()-l.F,g.j.info("Handshake RTT: "+g.R+"ms")),_=g;var ne=l;if(_.qa=ag(_,_.J?_.ia:null,_.W),ne.K){Lp(_.h,ne);var ze=ne,xt=_.L;xt&&(ze.I=xt),ze.B&&(Ou(ze),za(ze)),_.g=ne}else ng(_);0<g.i.length&&tl(g)}else Ue[0]!="stop"&&Ue[0]!="close"||wr(g,7);else g.G==3&&(Ue[0]=="stop"||Ue[0]=="close"?Ue[0]=="stop"?wr(g,7):Uu(g):Ue[0]!="noop"&&g.l&&g.l.ta(Ue),g.v=0)}}so(4)}catch{}}var rI=class{constructor(l,f){this.g=l,this.map=f}};function Dp(l){this.l=l||10,a.PerformanceNavigationTiming?(l=a.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Op(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function Mp(l){return l.h?1:l.g?l.g.size:0}function Lu(l,f){return l.h?l.h==f:l.g?l.g.has(f):!1}function Vu(l,f){l.g?l.g.add(f):l.h=f}function Lp(l,f){l.h&&l.h==f?l.h=null:l.g&&l.g.has(f)&&l.g.delete(f)}Dp.prototype.cancel=function(){if(this.i=Vp(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function Vp(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let f=l.i;for(const g of l.g.values())f=f.concat(g.D);return f}return b(l.i)}function iI(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(c(l)){for(var f=[],g=l.length,_=0;_<g;_++)f.push(l[_]);return f}f=[],g=0;for(_ in l)f[g++]=l[_];return f}function oI(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(c(l)||typeof l=="string"){var f=[];l=l.length;for(var g=0;g<l;g++)f.push(g);return f}f=[],g=0;for(const _ in l)f[g++]=_;return f}}}function Fp(l,f){if(l.forEach&&typeof l.forEach=="function")l.forEach(f,void 0);else if(c(l)||typeof l=="string")Array.prototype.forEach.call(l,f,void 0);else for(var g=oI(l),_=iI(l),D=_.length,U=0;U<D;U++)f.call(void 0,_[U],g&&g[U],l)}var Up=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function aI(l,f){if(l){l=l.split("&");for(var g=0;g<l.length;g++){var _=l[g].indexOf("="),D=null;if(0<=_){var U=l[g].substring(0,_);D=l[g].substring(_+1)}else U=l[g];f(U,D?decodeURIComponent(D.replace(/\+/g," ")):"")}}}function Er(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof Er){this.h=l.h,Ka(this,l.j),this.o=l.o,this.g=l.g,Qa(this,l.s),this.l=l.l;var f=l.i,g=new co;g.i=f.i,f.g&&(g.g=new Map(f.g),g.h=f.h),Bp(this,g),this.m=l.m}else l&&(f=String(l).match(Up))?(this.h=!1,Ka(this,f[1]||"",!0),this.o=ao(f[2]||""),this.g=ao(f[3]||"",!0),Qa(this,f[4]),this.l=ao(f[5]||"",!0),Bp(this,f[6]||"",!0),this.m=ao(f[7]||"")):(this.h=!1,this.i=new co(null,this.h))}Er.prototype.toString=function(){var l=[],f=this.j;f&&l.push(lo(f,$p,!0),":");var g=this.g;return(g||f=="file")&&(l.push("//"),(f=this.o)&&l.push(lo(f,$p,!0),"@"),l.push(encodeURIComponent(String(g)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),g=this.s,g!=null&&l.push(":",String(g))),(g=this.l)&&(this.g&&g.charAt(0)!="/"&&l.push("/"),l.push(lo(g,g.charAt(0)=="/"?uI:cI,!0))),(g=this.i.toString())&&l.push("?",g),(g=this.m)&&l.push("#",lo(g,dI)),l.join("")};function Zn(l){return new Er(l)}function Ka(l,f,g){l.j=g?ao(f,!0):f,l.j&&(l.j=l.j.replace(/:$/,""))}function Qa(l,f){if(f){if(f=Number(f),isNaN(f)||0>f)throw Error("Bad port number "+f);l.s=f}else l.s=null}function Bp(l,f,g){f instanceof co?(l.i=f,fI(l.i,l.h)):(g||(f=lo(f,hI)),l.i=new co(f,l.h))}function tt(l,f,g){l.i.set(f,g)}function Ya(l){return tt(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function ao(l,f){return l?f?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function lo(l,f,g){return typeof l=="string"?(l=encodeURI(l).replace(f,lI),g&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function lI(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var $p=/[#\/\?@]/g,cI=/[#\?:]/g,uI=/[#\?]/g,hI=/[#\?@]/g,dI=/#/g;function co(l,f){this.h=this.g=null,this.i=l||null,this.j=!!f}function Vs(l){l.g||(l.g=new Map,l.h=0,l.i&&aI(l.i,function(f,g){l.add(decodeURIComponent(f.replace(/\+/g," ")),g)}))}n=co.prototype,n.add=function(l,f){Vs(this),this.i=null,l=Jr(this,l);var g=this.g.get(l);return g||this.g.set(l,g=[]),g.push(f),this.h+=1,this};function jp(l,f){Vs(l),f=Jr(l,f),l.g.has(f)&&(l.i=null,l.h-=l.g.get(f).length,l.g.delete(f))}function Hp(l,f){return Vs(l),f=Jr(l,f),l.g.has(f)}n.forEach=function(l,f){Vs(this),this.g.forEach(function(g,_){g.forEach(function(D){l.call(f,D,_,this)},this)},this)},n.na=function(){Vs(this);const l=Array.from(this.g.values()),f=Array.from(this.g.keys()),g=[];for(let _=0;_<f.length;_++){const D=l[_];for(let U=0;U<D.length;U++)g.push(f[_])}return g},n.V=function(l){Vs(this);let f=[];if(typeof l=="string")Hp(this,l)&&(f=f.concat(this.g.get(Jr(this,l))));else{l=Array.from(this.g.values());for(let g=0;g<l.length;g++)f=f.concat(l[g])}return f},n.set=function(l,f){return Vs(this),this.i=null,l=Jr(this,l),Hp(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[f]),this.h+=1,this},n.get=function(l,f){return l?(l=this.V(l),0<l.length?String(l[0]):f):f};function Gp(l,f,g){jp(l,f),0<g.length&&(l.i=null,l.g.set(Jr(l,f),b(g)),l.h+=g.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],f=Array.from(this.g.keys());for(var g=0;g<f.length;g++){var _=f[g];const U=encodeURIComponent(String(_)),ne=this.V(_);for(_=0;_<ne.length;_++){var D=U;ne[_]!==""&&(D+="="+encodeURIComponent(String(ne[_]))),l.push(D)}}return this.i=l.join("&")};function Jr(l,f){return f=String(f),l.j&&(f=f.toLowerCase()),f}function fI(l,f){f&&!l.j&&(Vs(l),l.i=null,l.g.forEach(function(g,_){var D=_.toLowerCase();_!=D&&(jp(this,_),Gp(this,D,g))},l)),l.j=f}function pI(l,f){const g=new io;if(a.Image){const _=new Image;_.onload=m(Fs,g,"TestLoadImage: loaded",!0,f,_),_.onerror=m(Fs,g,"TestLoadImage: error",!1,f,_),_.onabort=m(Fs,g,"TestLoadImage: abort",!1,f,_),_.ontimeout=m(Fs,g,"TestLoadImage: timeout",!1,f,_),a.setTimeout(function(){_.ontimeout&&_.ontimeout()},1e4),_.src=l}else f(!1)}function gI(l,f){const g=new io,_=new AbortController,D=setTimeout(()=>{_.abort(),Fs(g,"TestPingServer: timeout",!1,f)},1e4);fetch(l,{signal:_.signal}).then(U=>{clearTimeout(D),U.ok?Fs(g,"TestPingServer: ok",!0,f):Fs(g,"TestPingServer: server error",!1,f)}).catch(()=>{clearTimeout(D),Fs(g,"TestPingServer: error",!1,f)})}function Fs(l,f,g,_,D){try{D&&(D.onload=null,D.onerror=null,D.onabort=null,D.ontimeout=null),_(g)}catch{}}function mI(){this.g=new Ha}function _I(l,f,g){const _=g||"";try{Fp(l,function(D,U){let ne=D;u(D)&&(ne=Rt(D)),f.push(_+U+"="+encodeURIComponent(ne))})}catch(D){throw f.push(_+"type="+encodeURIComponent("_badmap")),D}}function Ja(l){this.l=l.Ub||null,this.j=l.eb||!1}v(Ja,Ru),Ja.prototype.g=function(){return new Xa(this.l,this.j)},Ja.prototype.i=function(l){return function(){return l}}({});function Xa(l,f){Ee.call(this),this.D=l,this.o=f,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}v(Xa,Ee),n=Xa.prototype,n.open=function(l,f){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=f,this.readyState=1,ho(this)},n.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const f={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(f.body=l),(this.D||a).fetch(new Request(this.A,f)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,uo(this)),this.readyState=0},n.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,ho(this)),this.g&&(this.readyState=3,ho(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Wp(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function Wp(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}n.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var f=l.value?l.value:new Uint8Array(0);(f=this.v.decode(f,{stream:!l.done}))&&(this.response=this.responseText+=f)}l.done?uo(this):ho(this),this.readyState==3&&Wp(this)}},n.Ra=function(l){this.g&&(this.response=this.responseText=l,uo(this))},n.Qa=function(l){this.g&&(this.response=l,uo(this))},n.ga=function(){this.g&&uo(this)};function uo(l){l.readyState=4,l.l=null,l.j=null,l.v=null,ho(l)}n.setRequestHeader=function(l,f){this.u.append(l,f)},n.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],f=this.h.entries();for(var g=f.next();!g.done;)g=g.value,l.push(g[0]+": "+g[1]),g=f.next();return l.join(`\r
`)};function ho(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(Xa.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function qp(l){let f="";return ue(l,function(g,_){f+=_,f+=":",f+=g,f+=`\r
`}),f}function Fu(l,f,g){e:{for(_ in g){var _=!1;break e}_=!0}_||(g=qp(g),typeof l=="string"?g!=null&&encodeURIComponent(String(g)):tt(l,f,g))}function at(l){Ee.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}v(at,Ee);var yI=/^https?$/i,vI=["POST","PUT"];n=at.prototype,n.Ha=function(l){this.J=l},n.ea=function(l,f,g,_){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);f=f?f.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():ku.g(),this.v=this.o?wp(this.o):wp(ku),this.g.onreadystatechange=p(this.Ea,this);try{this.B=!0,this.g.open(f,String(l),!0),this.B=!1}catch(U){zp(this,U);return}if(l=g||"",g=new Map(this.headers),_)if(Object.getPrototypeOf(_)===Object.prototype)for(var D in _)g.set(D,_[D]);else if(typeof _.keys=="function"&&typeof _.get=="function")for(const U of _.keys())g.set(U,_.get(U));else throw Error("Unknown input type for opt_headers: "+String(_));_=Array.from(g.keys()).find(U=>U.toLowerCase()=="content-type"),D=a.FormData&&l instanceof a.FormData,!(0<=Array.prototype.indexOf.call(vI,f,void 0))||_||D||g.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[U,ne]of g)this.g.setRequestHeader(U,ne);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Yp(this),this.u=!0,this.g.send(l),this.u=!1}catch(U){zp(this,U)}};function zp(l,f){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=f,l.m=5,Kp(l),Za(l)}function Kp(l){l.A||(l.A=!0,Pe(l,"complete"),Pe(l,"error"))}n.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,Pe(this,"complete"),Pe(this,"abort"),Za(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Za(this,!0)),at.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Qp(this):this.bb())},n.bb=function(){Qp(this)};function Qp(l){if(l.h&&typeof o<"u"&&(!l.v[1]||es(l)!=4||l.Z()!=2)){if(l.u&&es(l)==4)Dt(l.Ea,0,l);else if(Pe(l,"readystatechange"),es(l)==4){l.h=!1;try{const ne=l.Z();e:switch(ne){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var f=!0;break e;default:f=!1}var g;if(!(g=f)){var _;if(_=ne===0){var D=String(l.D).match(Up)[1]||null;!D&&a.self&&a.self.location&&(D=a.self.location.protocol.slice(0,-1)),_=!yI.test(D?D.toLowerCase():"")}g=_}if(g)Pe(l,"complete"),Pe(l,"success");else{l.m=6;try{var U=2<es(l)?l.g.statusText:""}catch{U=""}l.l=U+" ["+l.Z()+"]",Kp(l)}}finally{Za(l)}}}}function Za(l,f){if(l.g){Yp(l);const g=l.g,_=l.v[0]?()=>{}:null;l.g=null,l.v=null,f||Pe(l,"ready");try{g.onreadystatechange=_}catch{}}}function Yp(l){l.I&&(a.clearTimeout(l.I),l.I=null)}n.isActive=function(){return!!this.g};function es(l){return l.g?l.g.readyState:0}n.Z=function(){try{return 2<es(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(l){if(this.g){var f=this.g.responseText;return l&&f.indexOf(l)==0&&(f=f.substring(l.length)),mn(f)}};function Jp(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function EI(l){const f={};l=(l.g&&2<=es(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let _=0;_<l.length;_++){if(V(l[_]))continue;var g=P(l[_]);const D=g[0];if(g=g[1],typeof g!="string")continue;g=g.trim();const U=f[D]||[];f[D]=U,U.push(g)}A(f,function(_){return _.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function fo(l,f,g){return g&&g.internalChannelParams&&g.internalChannelParams[l]||f}function Xp(l){this.Aa=0,this.i=[],this.j=new io,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=fo("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=fo("baseRetryDelayMs",5e3,l),this.cb=fo("retryDelaySeedMs",1e4,l),this.Wa=fo("forwardChannelMaxRetries",2,l),this.wa=fo("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new Dp(l&&l.concurrentRequestLimit),this.Da=new mI,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Xp.prototype,n.la=8,n.G=1,n.connect=function(l,f,g,_){zt(0),this.W=l,this.H=f||{},g&&_!==void 0&&(this.H.OSID=g,this.H.OAID=_),this.F=this.X,this.I=ag(this,null,this.W),tl(this)};function Uu(l){if(Zp(l),l.G==3){var f=l.U++,g=Zn(l.I);if(tt(g,"SID",l.K),tt(g,"RID",f),tt(g,"TYPE","terminate"),po(l,g),f=new Ls(l,l.j,f),f.L=2,f.v=Ya(Zn(g)),g=!1,a.navigator&&a.navigator.sendBeacon)try{g=a.navigator.sendBeacon(f.v.toString(),"")}catch{}!g&&a.Image&&(new Image().src=f.v,g=!0),g||(f.g=lg(f.j,null),f.g.ea(f.v)),f.F=Date.now(),za(f)}og(l)}function el(l){l.g&&($u(l),l.g.cancel(),l.g=null)}function Zp(l){el(l),l.u&&(a.clearTimeout(l.u),l.u=null),nl(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&a.clearTimeout(l.s),l.s=null)}function tl(l){if(!Op(l.h)&&!l.s){l.s=!0;var f=l.Ga;ve||rt(),Te||(ve(),Te=!0),ot.add(f,l),l.B=0}}function wI(l,f){return Mp(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=f.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=ro(p(l.Ga,l,f),ig(l,l.B)),l.B++,!0)}n.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const D=new Ls(this,this.j,l);let U=this.o;if(this.S&&(U?(U=E(U),R(U,this.S)):U=this.S),this.m!==null||this.O||(D.H=U,U=null),this.P)e:{for(var f=0,g=0;g<this.i.length;g++){t:{var _=this.i[g];if("__data__"in _.map&&(_=_.map.__data__,typeof _=="string")){_=_.length;break t}_=void 0}if(_===void 0)break;if(f+=_,4096<f){f=g;break e}if(f===4096||g===this.i.length-1){f=g+1;break e}}f=1e3}else f=1e3;f=tg(this,D,f),g=Zn(this.I),tt(g,"RID",l),tt(g,"CVER",22),this.D&&tt(g,"X-HTTP-Session-Id",this.D),po(this,g),U&&(this.O?f="headers="+encodeURIComponent(String(qp(U)))+"&"+f:this.m&&Fu(g,this.m,U)),Vu(this.h,D),this.Ua&&tt(g,"TYPE","init"),this.P?(tt(g,"$req",f),tt(g,"SID","null"),D.T=!0,Du(D,g,null)):Du(D,g,f),this.G=2}}else this.G==3&&(l?eg(this,l):this.i.length==0||Op(this.h)||eg(this))};function eg(l,f){var g;f?g=f.l:g=l.U++;const _=Zn(l.I);tt(_,"SID",l.K),tt(_,"RID",g),tt(_,"AID",l.T),po(l,_),l.m&&l.o&&Fu(_,l.m,l.o),g=new Ls(l,l.j,g,l.B+1),l.m===null&&(g.H=l.o),f&&(l.i=f.D.concat(l.i)),f=tg(l,g,1e3),g.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),Vu(l.h,g),Du(g,_,f)}function po(l,f){l.H&&ue(l.H,function(g,_){tt(f,_,g)}),l.l&&Fp({},function(g,_){tt(f,_,g)})}function tg(l,f,g){g=Math.min(l.i.length,g);var _=l.l?p(l.l.Na,l.l,l):null;e:{var D=l.i;let U=-1;for(;;){const ne=["count="+g];U==-1?0<g?(U=D[0].g,ne.push("ofs="+U)):U=0:ne.push("ofs="+U);let ze=!0;for(let xt=0;xt<g;xt++){let Ue=D[xt].g;const Mt=D[xt].map;if(Ue-=U,0>Ue)U=Math.max(0,D[xt].g-100),ze=!1;else try{_I(Mt,ne,"req"+Ue+"_")}catch{_&&_(Mt)}}if(ze){_=ne.join("&");break e}}}return l=l.i.splice(0,g),f.D=l,_}function ng(l){if(!l.g&&!l.u){l.Y=1;var f=l.Fa;ve||rt(),Te||(ve(),Te=!0),ot.add(f,l),l.v=0}}function Bu(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=ro(p(l.Fa,l),ig(l,l.v)),l.v++,!0)}n.Fa=function(){if(this.u=null,sg(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=ro(p(this.ab,this),l)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,zt(10),el(this),sg(this))};function $u(l){l.A!=null&&(a.clearTimeout(l.A),l.A=null)}function sg(l){l.g=new Ls(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var f=Zn(l.qa);tt(f,"RID","rpc"),tt(f,"SID",l.K),tt(f,"AID",l.T),tt(f,"CI",l.F?"0":"1"),!l.F&&l.ja&&tt(f,"TO",l.ja),tt(f,"TYPE","xmlhttp"),po(l,f),l.m&&l.o&&Fu(f,l.m,l.o),l.L&&(l.g.I=l.L);var g=l.g;l=l.ia,g.L=1,g.v=Ya(Zn(f)),g.m=null,g.P=!0,Pp(g,l)}n.Za=function(){this.C!=null&&(this.C=null,el(this),Bu(this),zt(19))};function nl(l){l.C!=null&&(a.clearTimeout(l.C),l.C=null)}function rg(l,f){var g=null;if(l.g==f){nl(l),$u(l),l.g=null;var _=2}else if(Lu(l.h,f))g=f.D,Lp(l.h,f),_=1;else return;if(l.G!=0){if(f.o)if(_==1){g=f.m?f.m.length:0,f=Date.now()-f.F;var D=l.B;_=Ga(),Pe(_,new Ap(_,g)),tl(l)}else ng(l);else if(D=f.s,D==3||D==0&&0<f.X||!(_==1&&wI(l,f)||_==2&&Bu(l)))switch(g&&0<g.length&&(f=l.h,f.i=f.i.concat(g)),D){case 1:wr(l,5);break;case 4:wr(l,10);break;case 3:wr(l,6);break;default:wr(l,2)}}}function ig(l,f){let g=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(g*=2),g*f}function wr(l,f){if(l.j.info("Error code "+f),f==2){var g=p(l.fb,l),_=l.Xa;const D=!_;_=new Er(_||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Ka(_,"https"),Ya(_),D?pI(_.toString(),g):gI(_.toString(),g)}else zt(2);l.G=0,l.l&&l.l.sa(f),og(l),Zp(l)}n.fb=function(l){l?(this.j.info("Successfully pinged google.com"),zt(2)):(this.j.info("Failed to ping google.com"),zt(1))};function og(l){if(l.G=0,l.ka=[],l.l){const f=Vp(l.h);(f.length!=0||l.i.length!=0)&&(S(l.ka,f),S(l.ka,l.i),l.h.i.length=0,b(l.i),l.i.length=0),l.l.ra()}}function ag(l,f,g){var _=g instanceof Er?Zn(g):new Er(g);if(_.g!="")f&&(_.g=f+"."+_.g),Qa(_,_.s);else{var D=a.location;_=D.protocol,f=f?f+"."+D.hostname:D.hostname,D=+D.port;var U=new Er(null);_&&Ka(U,_),f&&(U.g=f),D&&Qa(U,D),g&&(U.l=g),_=U}return g=l.D,f=l.ya,g&&f&&tt(_,g,f),tt(_,"VER",l.la),po(l,_),_}function lg(l,f,g){if(f&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return f=l.Ca&&!l.pa?new at(new Ja({eb:g})):new at(l.pa),f.Ha(l.J),f}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function cg(){}n=cg.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function sl(){}sl.prototype.g=function(l,f){return new an(l,f)};function an(l,f){Ee.call(this),this.g=new Xp(f),this.l=l,this.h=f&&f.messageUrlParams||null,l=f&&f.messageHeaders||null,f&&f.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=f&&f.initMessageHeaders||null,f&&f.messageContentType&&(l?l["X-WebChannel-Content-Type"]=f.messageContentType:l={"X-WebChannel-Content-Type":f.messageContentType}),f&&f.va&&(l?l["X-WebChannel-Client-Profile"]=f.va:l={"X-WebChannel-Client-Profile":f.va}),this.g.S=l,(l=f&&f.Sb)&&!V(l)&&(this.g.m=l),this.v=f&&f.supportsCrossDomainXhr||!1,this.u=f&&f.sendRawJson||!1,(f=f&&f.httpSessionIdParam)&&!V(f)&&(this.g.D=f,l=this.h,l!==null&&f in l&&(l=this.h,f in l&&delete l[f])),this.j=new Xr(this)}v(an,Ee),an.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},an.prototype.close=function(){Uu(this.g)},an.prototype.o=function(l){var f=this.g;if(typeof l=="string"){var g={};g.__data__=l,l=g}else this.u&&(g={},g.__data__=Rt(l),l=g);f.i.push(new rI(f.Ya++,l)),f.G==3&&tl(f)},an.prototype.N=function(){this.g.l=null,delete this.j,Uu(this.g),delete this.g,an.aa.N.call(this)};function ug(l){xu.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var f=l.__sm__;if(f){e:{for(const g in f){l=g;break e}l=void 0}(this.i=l)&&(l=this.i,f=f!==null&&l in f?f[l]:void 0),this.data=f}else this.data=l}v(ug,xu);function hg(){Pu.call(this),this.status=1}v(hg,Pu);function Xr(l){this.g=l}v(Xr,cg),Xr.prototype.ua=function(){Pe(this.g,"a")},Xr.prototype.ta=function(l){Pe(this.g,new ug(l))},Xr.prototype.sa=function(l){Pe(this.g,new hg)},Xr.prototype.ra=function(){Pe(this.g,"b")},sl.prototype.createWebChannel=sl.prototype.g,an.prototype.send=an.prototype.o,an.prototype.open=an.prototype.m,an.prototype.close=an.prototype.close,G0=function(){return new sl},H0=function(){return Ga()},j0=yr,$h={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Wa.NO_ERROR=0,Wa.TIMEOUT=8,Wa.HTTP_ERROR=6,Rl=Wa,Sp.COMPLETE="complete",$0=Sp,Tp.EventType=no,no.OPEN="a",no.CLOSE="b",no.ERROR="c",no.MESSAGE="d",Ee.prototype.listen=Ee.prototype.K,So=Tp,at.prototype.listenOnce=at.prototype.L,at.prototype.getLastError=at.prototype.Ka,at.prototype.getLastErrorCode=at.prototype.Ba,at.prototype.getStatus=at.prototype.Z,at.prototype.getResponseJson=at.prototype.Oa,at.prototype.getResponseText=at.prototype.oa,at.prototype.send=at.prototype.ea,at.prototype.setWithCredentials=at.prototype.Ha,B0=at}).apply(typeof ul<"u"?ul:typeof self<"u"?self:typeof window<"u"?window:{});const Em="@firebase/firestore",wm="4.7.16";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ce(n,e,t){let s="Unexpected state";typeof e=="string"?s=e:t=e,W0(n,s,t)}function W0(n,e,t){let s=`FIRESTORE (${zi}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{s+=" CONTEXT: "+JSON.stringify(t)}catch{s+=" CONTEXT: "+t}throw Cs(s),new Error(s)}function We(n,e,t,s){let r="Unexpected state";typeof t=="string"?r=t:s=t,n||W0(e,r,s)}function Re(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bm=-62135596800,Cm=1e6;class wt{static now(){return wt.fromMillis(Date.now())}static fromDate(e){return wt.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),s=Math.floor((e-1e3*t)*Cm);return new wt(t,s)}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new le(z.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new le(z.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<bm)throw new le(z.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new le(z.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Cm}_compareTo(e){return this.seconds===e.seconds?ke(this.nanoseconds,e.nanoseconds):ke(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){const e=this.seconds-bm;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ki(n){if(n.code!==z.FAILED_PRECONDITION||n.message!==Gx)throw n;ae("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e(t=>{this.isDone=!0,this.result=t,this.nextCallback&&this.nextCallback(t)},t=>{this.isDone=!0,this.error=t,this.catchCallback&&this.catchCallback(t)})}catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&Ce(59440),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new q((s,r)=>{this.nextCallback=i=>{this.wrapSuccess(e,i).next(s,r)},this.catchCallback=i=>{this.wrapFailure(t,i).next(s,r)}})}toPromise(){return new Promise((e,t)=>{this.next(e,t)})}wrapUserFunction(e){try{const t=e();return t instanceof q?t:q.resolve(t)}catch(t){return q.reject(t)}}wrapSuccess(e,t){return e?this.wrapUserFunction(()=>e(t)):q.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction(()=>e(t)):q.reject(t)}static resolve(e){return new q((t,s)=>{t(e)})}static reject(e){return new q((t,s)=>{s(e)})}static waitFor(e){return new q((t,s)=>{let r=0,i=0,o=!1;e.forEach(a=>{++r,a.next(()=>{++i,o&&i===r&&t()},c=>s(c))}),o=!0,i===r&&t()})}static or(e){let t=q.resolve(!1);for(const s of e)t=t.next(r=>r?q.resolve(r):s());return t}static forEach(e,t){const s=[];return e.forEach((r,i)=>{s.push(t.call(this,r,i))}),this.waitFor(s)}static mapArray(e,t){return new q((s,r)=>{const i=e.length,o=new Array(i);let a=0;for(let c=0;c<i;c++){const u=c;t(e[u]).next(h=>{o[u]=h,++a,a===i&&s(o)},h=>r(h))}})}static doWhile(e,t){return new q((s,r)=>{const i=()=>{e()===!0?t().next(()=>{i()},r):s()};i()})}}function qx(n){const e=n.match(/Android ([\d.]+)/i),t=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(t)}function Qi(n){return n.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q0="";function Kx(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Sm(e)),e=Qx(n.get(t),e);return Sm(e)}function Qx(n,e){let t=e;const s=n.length;for(let r=0;r<s;r++){const i=n.charAt(r);switch(i){case"\0":t+="";break;case Q0:t+="";break;default:t+=i}}return t}function Sm(n){return n+Q0+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rm(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function mr(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Y0(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rc{constructor(e,t){this.position=e,this.inclusive=t}}function Mm(n,e,t){let s=0;for(let r=0;r<n.position.length;r++){const i=e[r],o=n.position[r];if(i.field.isKeyField()?s=me.comparator(me.fromName(o.referenceValue),t.key):s=xi(o,t.data.field(i.field)),i.dir==="desc"&&(s*=-1),s!==0)break}return s}function Lm(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!Jn(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iE{}class gt extends iE{constructor(e,t,s){super(),this.field=e,this.op=t,this.value=s}static create(e,t,s){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,s):new s1(e,t,s):t==="array-contains"?new o1(e,s):t==="in"?new a1(e,s):t==="not-in"?new l1(e,s):t==="array-contains-any"?new c1(e,s):new gt(e,t,s)}static createKeyFieldInFilter(e,t,s){return t==="in"?new r1(e,s):new i1(e,s)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(xi(t,this.value)):t!==null&&lr(this.value)===lr(t)&&this.matchesComparison(xi(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return Ce(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Dn extends iE{constructor(e,t){super(),this.filters=e,this.op=t,this.Te=null}static create(e,t){return new Dn(e,t)}matches(e){return oE(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.Te!==null||(this.Te=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.Te}getFilters(){return Object.assign([],this.filters)}}function oE(n){return n.op==="and"}function aE(n){return n1(n)&&oE(n)}function n1(n){for(const e of n.filters)if(e instanceof Dn)return!1;return!0}function qh(n){if(n instanceof gt)return n.field.canonicalString()+n.op.toString()+Pi(n.value);if(aE(n))return n.filters.map(e=>qh(e)).join(",");{const e=n.filters.map(t=>qh(t)).join(",");return`${n.op}(${e})`}}function lE(n,e){return n instanceof gt?function(s,r){return r instanceof gt&&s.op===r.op&&s.field.isEqual(r.field)&&Jn(s.value,r.value)}(n,e):n instanceof Dn?function(s,r){return r instanceof Dn&&s.op===r.op&&s.filters.length===r.filters.length?s.filters.reduce((i,o,a)=>i&&lE(o,r.filters[a]),!0):!1}(n,e):void Ce(19439)}function cE(n){return n instanceof gt?function(t){return`${t.field.canonicalString()} ${t.op} ${Pi(t.value)}`}(n):n instanceof Dn?function(t){return t.op.toString()+" {"+t.getFilters().map(cE).join(" ,")+"}"}(n):"Filter"}class s1 extends gt{constructor(e,t,s){super(e,t,s),this.key=me.fromName(s.referenceValue)}matches(e){const t=me.comparator(e.key,this.key);return this.matchesComparison(t)}}class r1 extends gt{constructor(e,t){super(e,"in",t),this.keys=uE("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class i1 extends gt{constructor(e,t){super(e,"not-in",t),this.keys=uE("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function uE(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(s=>me.fromName(s.referenceValue))}class o1 extends gt{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return rf(t)&&la(t.arrayValue,this.value)}}class a1 extends gt{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&la(this.value.arrayValue,t)}}class l1 extends gt{constructor(e,t){super(e,"not-in",t)}matches(e){if(la(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!la(this.value.arrayValue,t)}}class c1 extends gt{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!rf(t)||!t.arrayValue.values)&&t.arrayValue.values.some(s=>la(this.value.arrayValue,s))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qr{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),s=this.inner[t];if(s!==void 0){for(const[r,i]of s)if(this.equalsFn(r,e))return i}}has(e){return this.get(e)!==void 0}set(e,t){const s=this.mapKeyFn(e),r=this.inner[s];if(r===void 0)return this.inner[s]=[[e,t]],void this.innerSize++;for(let i=0;i<r.length;i++)if(this.equalsFn(r[i][0],e))return void(r[i]=[e,t]);r.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),s=this.inner[t];if(s===void 0)return!1;for(let r=0;r<s.length;r++)if(this.equalsFn(s[r][0],e))return s.length===1?delete this.inner[t]:s.splice(r,1),this.innerSize--,!0;return!1}forEach(e){mr(this.inner,(t,s)=>{for(const[r,i]of s)e(r,i)})}isEmpty(){return Y0(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g1=new _t(me.comparator);function As(){return g1}const pE=new _t(me.comparator);function Ro(...n){let e=pE;for(const t of n)e=e.insert(t.key,t);return e}function gE(n){let e=pE;return n.forEach((t,s)=>e=e.insert(t,s.overlayedDocument)),e}function Rr(){return $o()}function mE(){return $o()}function $o(){return new qr(n=>n.toString(),(n,e)=>n.isEqual(e))}const m1=new _t(me.comparator),_1=new Tt(me.comparator);function Le(...n){let e=_1;for(const t of n)e=e.add(t);return e}const y1=new Tt(ke);function v1(){return y1}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N1=new Qs([4294967295,4294967295],0);function Hm(n){const e=z0().encode(n),t=new U0;return t.update(e),new Uint8Array(t.digest())}function Gm(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),s=e.getUint32(4,!0),r=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new Qs([t,s],0),new Qs([r,i],0)]}class hf{constructor(e,t,s){if(this.bitmap=e,this.padding=t,this.hashCount=s,t<0||t>=8)throw new xo(`Invalid padding: ${t}`);if(s<0)throw new xo(`Invalid hash count: ${s}`);if(e.length>0&&this.hashCount===0)throw new xo(`Invalid hash count: ${s}`);if(e.length===0&&t!==0)throw new xo(`Invalid padding when bitmap length is 0: ${t}`);this.pe=8*e.length-t,this.ye=Qs.fromNumber(this.pe)}we(e,t,s){let r=e.add(t.multiply(Qs.fromNumber(s)));return r.compare(N1)===1&&(r=new Qs([r.getBits(0),r.getBits(1)],0)),r.modulo(this.ye).toNumber()}Se(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.pe===0)return!1;const t=Hm(e),[s,r]=Gm(t);for(let i=0;i<this.hashCount;i++){const o=this.we(s,r,i);if(!this.Se(o))return!1}return!0}static create(e,t,s){const r=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),o=new hf(i,r,t);return s.forEach(a=>o.insert(a)),o}insert(e){if(this.pe===0)return;const t=Hm(e),[s,r]=Gm(t);for(let i=0;i<this.hashCount;i++){const o=this.we(s,r,i);this.be(o)}}be(e){const t=Math.floor(e/8),s=e%8;this.bitmap[t]|=1<<s}}class xo extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nl{constructor(e,t,s,r){this.De=e,this.removedTargetIds=t,this.key=s,this.ve=r}}class AE{constructor(e,t){this.targetId=e,this.Ce=t}}class SE{constructor(e,t,s=Nt.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=t,this.resumeToken=s,this.cause=r}}class Wm{constructor(){this.Fe=0,this.Me=qm(),this.xe=Nt.EMPTY_BYTE_STRING,this.Oe=!1,this.Ne=!0}get current(){return this.Oe}get resumeToken(){return this.xe}get Be(){return this.Fe!==0}get Le(){return this.Ne}ke(e){e.approximateByteSize()>0&&(this.Ne=!0,this.xe=e)}qe(){let e=Le(),t=Le(),s=Le();return this.Me.forEach((r,i)=>{switch(i){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:s=s.add(r);break;default:Ce(38017,{changeType:i})}}),new Na(this.xe,this.Oe,e,t,s)}Qe(){this.Ne=!1,this.Me=qm()}$e(e,t){this.Ne=!0,this.Me=this.Me.insert(e,t)}Ue(e){this.Ne=!0,this.Me=this.Me.remove(e)}Ke(){this.Fe+=1}We(){this.Fe-=1,We(this.Fe>=0,3241,{Fe:this.Fe})}Ge(){this.Ne=!0,this.Oe=!0}}class D1{constructor(e){this.ze=e,this.je=new Map,this.He=As(),this.Je=fl(),this.Ye=fl(),this.Ze=new _t(ke)}Xe(e){for(const t of e.De)e.ve&&e.ve.isFoundDocument()?this.et(t,e.ve):this.tt(t,e.key,e.ve);for(const t of e.removedTargetIds)this.tt(t,e.key,e.ve)}nt(e){this.forEachTarget(e,t=>{const s=this.rt(t);switch(e.state){case 0:this.it(t)&&s.ke(e.resumeToken);break;case 1:s.We(),s.Be||s.Qe(),s.ke(e.resumeToken);break;case 2:s.We(),s.Be||this.removeTarget(t);break;case 3:this.it(t)&&(s.Ge(),s.ke(e.resumeToken));break;case 4:this.it(t)&&(this.st(t),s.ke(e.resumeToken));break;default:Ce(56790,{state:e.state})}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.je.forEach((s,r)=>{this.it(r)&&t(r)})}ot(e){const t=e.targetId,s=e.Ce.count,r=this._t(t);if(r){const i=r.target;if(zh(i))if(s===0){const o=new me(i.path);this.tt(t,o,Bt.newNoDocument(o,Se.min()))}else We(s===1,20013,{expectedCount:s});else{const o=this.ut(t);if(o!==s){const a=this.ct(e),c=a?this.lt(a,e,o):1;if(c!==0){this.st(t);const u=c===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ze=this.Ze.insert(t,u)}}}}}ct(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:s="",padding:r=0},hashCount:i=0}=t;let o,a;try{o=ar(s).toUint8Array()}catch(c){if(c instanceof J0)return Si("Decoding the base64 bloom filter in existence filter failed ("+c.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw c}try{a=new hf(o,r,i)}catch(c){return Si(c instanceof xo?"BloomFilter error: ":"Applying bloom filter failed: ",c),null}return a.pe===0?null:a}lt(e,t,s){return t.Ce.count===s-this.Tt(e,t.targetId)?0:2}Tt(e,t){const s=this.ze.getRemoteKeysForTarget(t);let r=0;return s.forEach(i=>{const o=this.ze.Pt(),a=`projects/${o.projectId}/databases/${o.database}/documents/${i.path.canonicalString()}`;e.mightContain(a)||(this.tt(t,i,null),r++)}),r}It(e){const t=new Map;this.je.forEach((i,o)=>{const a=this._t(o);if(a){if(i.current&&zh(a.target)){const c=new me(a.target.path);this.Et(c).has(o)||this.dt(o,c)||this.tt(o,c,Bt.newNoDocument(c,e))}i.Le&&(t.set(o,i.qe()),i.Qe())}});let s=Le();this.Ye.forEach((i,o)=>{let a=!0;o.forEachWhile(c=>{const u=this._t(c);return!u||u.purpose==="TargetPurposeLimboResolution"||(a=!1,!1)}),a&&(s=s.add(i))}),this.He.forEach((i,o)=>o.setReadTime(e));const r=new ru(e,t,this.Ze,this.He,s);return this.He=As(),this.Je=fl(),this.Ye=fl(),this.Ze=new _t(ke),r}et(e,t){if(!this.it(e))return;const s=this.dt(e,t.key)?2:0;this.rt(e).$e(t.key,s),this.He=this.He.insert(t.key,t),this.Je=this.Je.insert(t.key,this.Et(t.key).add(e)),this.Ye=this.Ye.insert(t.key,this.At(t.key).add(e))}tt(e,t,s){if(!this.it(e))return;const r=this.rt(e);this.dt(e,t)?r.$e(t,1):r.Ue(t),this.Ye=this.Ye.insert(t,this.At(t).delete(e)),this.Ye=this.Ye.insert(t,this.At(t).add(e)),s&&(this.He=this.He.insert(t,s))}removeTarget(e){this.je.delete(e)}ut(e){const t=this.rt(e).qe();return this.ze.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Ke(e){this.rt(e).Ke()}rt(e){let t=this.je.get(e);return t||(t=new Wm,this.je.set(e,t)),t}At(e){let t=this.Ye.get(e);return t||(t=new Tt(ke),this.Ye=this.Ye.insert(e,t)),t}Et(e){let t=this.Je.get(e);return t||(t=new Tt(ke),this.Je=this.Je.insert(e,t)),t}it(e){const t=this._t(e)!==null;return t||ae("WatchChangeAggregator","Detected inactive target",e),t}_t(e){const t=this.je.get(e);return t&&t.Be?null:this.ze.Rt(e)}st(e){this.je.set(e,new Wm),this.ze.getRemoteKeysForTarget(e).forEach(t=>{this.tt(e,t,null)})}dt(e,t){return this.ze.getRemoteKeysForTarget(e).has(t)}}function fl(){return new _t(me.comparator)}function qm(){return new _t(me.comparator)}const O1={asc:"ASCENDING",desc:"DESCENDING"},M1={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},L1={and:"AND",or:"OR"};class V1{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Yh(n,e){return n.useProto3Json||Jc(e)?e:{value:e}}function ac(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function RE(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function F1(n,e){return ac(n,e.toTimestamp())}function Kn(n){return We(!!n,49232),Se.fromTimestamp(function(t){const s=or(t);return new wt(s.seconds,s.nanos)}(n))}function df(n,e){return Jh(n,e).canonicalString()}function Jh(n,e){const t=function(r){return new st(["projects",r.projectId,"databases",r.database])}(n).child("documents");return e===void 0?t:t.child(e)}function xE(n){const e=st.fromString(n);return We(OE(e),10190,{key:e.toString()}),e}function Xh(n,e){return df(n.databaseId,e.path)}function ih(n,e){const t=xE(e);if(t.get(1)!==n.databaseId.projectId)throw new le(z.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new le(z.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new me(kE(t))}function PE(n,e){return df(n.databaseId,e)}function U1(n){const e=xE(n);return e.length===4?st.emptyPath():kE(e)}function Zh(n){return new st(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function kE(n){return We(n.length>4&&n.get(4)==="documents",29091,{key:n.toString()}),n.popFirst(5)}function zm(n,e,t){return{name:Xh(n,e),fields:t.value.mapValue.fields}}function B1(n,e){let t;if("targetChange"in e){e.targetChange;const s=function(u){return u==="NO_CHANGE"?0:u==="ADD"?1:u==="REMOVE"?2:u==="CURRENT"?3:u==="RESET"?4:Ce(39313,{state:u})}(e.targetChange.targetChangeType||"NO_CHANGE"),r=e.targetChange.targetIds||[],i=function(u,h){return u.useProto3Json?(We(h===void 0||typeof h=="string",58123),Nt.fromBase64String(h||"")):(We(h===void 0||h instanceof Buffer||h instanceof Uint8Array,16193),Nt.fromUint8Array(h||new Uint8Array))}(n,e.targetChange.resumeToken),o=e.targetChange.cause,a=o&&function(u){const h=u.code===void 0?z.UNKNOWN:CE(u.code);return new le(h,u.message||"")}(o);t=new SE(s,r,i,a||null)}else if("documentChange"in e){e.documentChange;const s=e.documentChange;s.document,s.document.name,s.document.updateTime;const r=ih(n,s.document.name),i=Kn(s.document.updateTime),o=s.document.createTime?Kn(s.document.createTime):Se.min(),a=new tn({mapValue:{fields:s.document.fields}}),c=Bt.newFoundDocument(r,i,o,a),u=s.targetIds||[],h=s.removedTargetIds||[];t=new Nl(u,h,c.key,c)}else if("documentDelete"in e){e.documentDelete;const s=e.documentDelete;s.document;const r=ih(n,s.document),i=s.readTime?Kn(s.readTime):Se.min(),o=Bt.newNoDocument(r,i),a=s.removedTargetIds||[];t=new Nl([],a,o.key,o)}else if("documentRemove"in e){e.documentRemove;const s=e.documentRemove;s.document;const r=ih(n,s.document),i=s.removedTargetIds||[];t=new Nl([],i,r,null)}else{if(!("filter"in e))return Ce(11601,{Vt:e});{e.filter;const s=e.filter;s.targetId;const{count:r=0,unchangedNames:i}=s,o=new P1(r,i),a=s.targetId;t=new AE(a,o)}}return t}function $1(n,e){let t;if(e instanceof ka)t={update:zm(n,e.key,e.value)};else if(e instanceof cf)t={delete:Xh(n,e.key)};else if(e instanceof _r)t={update:zm(n,e.key,e.data),updateMask:Y1(e.fieldMask)};else{if(!(e instanceof S1))return Ce(16599,{ft:e.type});t={verify:Xh(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(s=>function(i,o){const a=o.transform;if(a instanceof ca)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(a instanceof ki)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:a.elements}};if(a instanceof ua)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:a.elements}};if(a instanceof oc)return{fieldPath:o.field.canonicalString(),increment:a.Re};throw Ce(20930,{transform:o.transform})}(0,s))),e.precondition.isNone||(t.currentDocument=function(r,i){return i.updateTime!==void 0?{updateTime:F1(r,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:Ce(27497)}(n,e.precondition)),t}function j1(n,e){return n&&n.length>0?(We(e!==void 0,14353),n.map(t=>function(r,i){let o=r.updateTime?Kn(r.updateTime):Kn(i);return o.isEqual(Se.min())&&(o=Kn(i)),new b1(o,r.transformResults||[])}(t,e))):[]}function H1(n,e){return{documents:[PE(n,e.path)]}}function G1(n,e){const t={structuredQuery:{}},s=e.path;let r;e.collectionGroup!==null?(r=s,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(r=s.popLast(),t.structuredQuery.from=[{collectionId:s.lastSegment()}]),t.parent=PE(n,r);const i=function(u){if(u.length!==0)return DE(Dn.create(u,"and"))}(e.filters);i&&(t.structuredQuery.where=i);const o=function(u){if(u.length!==0)return u.map(h=>function(p){return{field:ii(p.field),direction:z1(p.dir)}}(h))}(e.orderBy);o&&(t.structuredQuery.orderBy=o);const a=Yh(n,e.limit);return a!==null&&(t.structuredQuery.limit=a),e.startAt&&(t.structuredQuery.startAt=function(u){return{before:u.inclusive,values:u.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(u){return{before:!u.inclusive,values:u.position}}(e.endAt)),{gt:t,parent:r}}function W1(n){let e=U1(n.parent);const t=n.structuredQuery,s=t.from?t.from.length:0;let r=null;if(s>0){We(s===1,65062);const h=t.from[0];h.allDescendants?r=h.collectionId:e=e.child(h.collectionId)}let i=[];t.where&&(i=function(d){const p=NE(d);return p instanceof Dn&&aE(p)?p.getFilters():[p]}(t.where));let o=[];t.orderBy&&(o=function(d){return d.map(p=>function(v){return new ic(oi(v.field),function(S){switch(S){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(v.direction))}(p))}(t.orderBy));let a=null;t.limit&&(a=function(d){let p;return p=typeof d=="object"?d.value:d,Jc(p)?null:p}(t.limit));let c=null;t.startAt&&(c=function(d){const p=!!d.before,m=d.values||[];return new rc(m,p)}(t.startAt));let u=null;return t.endAt&&(u=function(d){const p=!d.before,m=d.values||[];return new rc(m,p)}(t.endAt)),h1(e,r,o,i,a,"F",c,u)}function q1(n,e){const t=function(r){switch(r){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return Ce(28987,{purpose:r})}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function NE(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const s=oi(t.unaryFilter.field);return gt.create(s,"==",{doubleValue:NaN});case"IS_NULL":const r=oi(t.unaryFilter.field);return gt.create(r,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=oi(t.unaryFilter.field);return gt.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=oi(t.unaryFilter.field);return gt.create(o,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return Ce(61313);default:return Ce(60726)}}(n):n.fieldFilter!==void 0?function(t){return gt.create(oi(t.fieldFilter.field),function(r){switch(r){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return Ce(58110);default:return Ce(50506)}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return Dn.create(t.compositeFilter.filters.map(s=>NE(s)),function(r){switch(r){case"AND":return"and";case"OR":return"or";default:return Ce(1026)}}(t.compositeFilter.op))}(n):Ce(30097,{filter:n})}function z1(n){return O1[n]}function K1(n){return M1[n]}function Q1(n){return L1[n]}function ii(n){return{fieldPath:n.canonicalString()}}function oi(n){return kt.fromServerFormat(n.fieldPath)}function DE(n){return n instanceof gt?function(t){if(t.op==="=="){if(Om(t.value))return{unaryFilter:{field:ii(t.field),op:"IS_NAN"}};if(Dm(t.value))return{unaryFilter:{field:ii(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Om(t.value))return{unaryFilter:{field:ii(t.field),op:"IS_NOT_NAN"}};if(Dm(t.value))return{unaryFilter:{field:ii(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:ii(t.field),op:K1(t.op),value:t.value}}}(n):n instanceof Dn?function(t){const s=t.getFilters().map(r=>DE(r));return s.length===1?s[0]:{compositeFilter:{op:Q1(t.op),filters:s}}}(n):Ce(54877,{filter:n})}function Y1(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function OE(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J1{constructor(e){this.wt=e}}function X1(n){const e=W1({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Qh(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z1{constructor(){this.Cn=new eP}addToCollectionParentIndex(e,t){return this.Cn.add(t),q.resolve()}getCollectionParents(e,t){return q.resolve(this.Cn.getEntries(t))}addFieldIndex(e,t){return q.resolve()}deleteFieldIndex(e,t){return q.resolve()}deleteAllFieldIndexes(e){return q.resolve()}createTargetIndexes(e,t){return q.resolve()}getDocumentsMatchingTarget(e,t){return q.resolve(null)}getIndexType(e,t){return q.resolve(0)}getFieldIndexes(e,t){return q.resolve([])}getNextCollectionGroupToUpdate(e){return q.resolve(null)}getMinOffset(e,t){return q.resolve(ir.min())}getMinOffsetFromCollectionGroup(e,t){return q.resolve(ir.min())}updateCollectionGroup(e,t,s){return q.resolve()}updateIndexEntries(e,t){return q.resolve()}}class eP{constructor(){this.index={}}add(e){const t=e.lastSegment(),s=e.popLast(),r=this.index[t]||new Tt(st.comparator),i=!r.has(s);return this.index[t]=r.add(s),i}has(e){const t=e.lastSegment(),s=e.popLast(),r=this.index[t];return r&&r.has(s)}getEntries(e){return(this.index[e]||new Tt(st.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qm="LruGarbageCollector",tP=1048576;function Ym([n,e],[t,s]){const r=ke(n,t);return r===0?ke(e,s):r}class nP{constructor(e){this.Er=e,this.buffer=new Tt(Ym),this.dr=0}Ar(){return++this.dr}Rr(e){const t=[e,this.Ar()];if(this.buffer.size<this.Er)this.buffer=this.buffer.add(t);else{const s=this.buffer.last();Ym(t,s)<0&&(this.buffer=this.buffer.delete(s).add(t))}}get maxValue(){return this.buffer.last()[0]}}class sP{constructor(e,t,s){this.garbageCollector=e,this.asyncQueue=t,this.localStore=s,this.Vr=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.mr(6e4)}stop(){this.Vr&&(this.Vr.cancel(),this.Vr=null)}get started(){return this.Vr!==null}mr(e){ae(Qm,`Garbage collection scheduled in ${e}ms`),this.Vr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,async()=>{this.Vr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(t){Qi(t)?ae(Qm,"Ignoring IndexedDB error during garbage collection: ",t):await Ki(t)}await this.mr(3e5)})}}class rP{constructor(e,t){this.gr=e,this.params=t}calculateTargetCount(e,t){return this.gr.pr(e).next(s=>Math.floor(t/100*s))}nthSequenceNumber(e,t){if(t===0)return q.resolve(Yc.le);const s=new nP(t);return this.gr.forEachTarget(e,r=>s.Rr(r.sequenceNumber)).next(()=>this.gr.yr(e,r=>s.Rr(r))).next(()=>s.maxValue)}removeTargets(e,t,s){return this.gr.removeTargets(e,t,s)}removeOrphanedDocuments(e,t){return this.gr.removeOrphanedDocuments(e,t)}collect(e,t){return this.params.cacheSizeCollectionThreshold===-1?(ae("LruGarbageCollector","Garbage collection skipped; disabled"),q.resolve(Km)):this.getCacheSize(e).next(s=>s<this.params.cacheSizeCollectionThreshold?(ae("LruGarbageCollector",`Garbage collection skipped; Cache size ${s} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),Km):this.wr(e,t))}getCacheSize(e){return this.gr.getCacheSize(e)}wr(e,t){let s,r,i,o,a,c,u;const h=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next(d=>(d>this.params.maximumSequenceNumbersToCollect?(ae("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${d}`),r=this.params.maximumSequenceNumbersToCollect):r=d,o=Date.now(),this.nthSequenceNumber(e,r))).next(d=>(s=d,a=Date.now(),this.removeTargets(e,s,t))).next(d=>(i=d,c=Date.now(),this.removeOrphanedDocuments(e,s))).next(d=>(u=Date.now(),si()<=De.DEBUG&&ae("LruGarbageCollector",`LRU Garbage Collection
	Counted targets in ${o-h}ms
	Determined least recently used ${r} in `+(a-o)+`ms
	Removed ${i} targets in `+(c-a)+`ms
	Removed ${d} documents in `+(u-c)+`ms
Total Duration: ${u-h}ms`),q.resolve({didRun:!0,sequenceNumbersCollected:r,targetsRemoved:i,documentsRemoved:d})))}}function iP(n,e){return new rP(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oP{constructor(){this.changes=new qr(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Bt.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const s=this.changes.get(t);return s!==void 0?q.resolve(s):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cP{constructor(e){this.serializer=e,this.kr=new Map,this.qr=new Map}getBundleMetadata(e,t){return q.resolve(this.kr.get(t))}saveBundleMetadata(e,t){return this.kr.set(t.id,function(r){return{id:r.id,version:r.version,createTime:Kn(r.createTime)}}(t)),q.resolve()}getNamedQuery(e,t){return q.resolve(this.qr.get(t))}saveNamedQuery(e,t){return this.qr.set(t.name,function(r){return{name:r.name,query:X1(r.bundledQuery),readTime:Kn(r.readTime)}}(t)),q.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uP{constructor(){this.overlays=new _t(me.comparator),this.Qr=new Map}getOverlay(e,t){return q.resolve(this.overlays.get(t))}getOverlays(e,t){const s=Rr();return q.forEach(t,r=>this.getOverlay(e,r).next(i=>{i!==null&&s.set(r,i)})).next(()=>s)}saveOverlays(e,t,s){return s.forEach((r,i)=>{this.bt(e,t,i)}),q.resolve()}removeOverlaysForBatchId(e,t,s){const r=this.Qr.get(s);return r!==void 0&&(r.forEach(i=>this.overlays=this.overlays.remove(i)),this.Qr.delete(s)),q.resolve()}getOverlaysForCollection(e,t,s){const r=Rr(),i=t.length+1,o=new me(t.child("")),a=this.overlays.getIteratorFrom(o);for(;a.hasNext();){const c=a.getNext().value,u=c.getKey();if(!t.isPrefixOf(u.path))break;u.path.length===i&&c.largestBatchId>s&&r.set(c.getKey(),c)}return q.resolve(r)}getOverlaysForCollectionGroup(e,t,s,r){let i=new _t((u,h)=>u-h);const o=this.overlays.getIterator();for(;o.hasNext();){const u=o.getNext().value;if(u.getKey().getCollectionGroup()===t&&u.largestBatchId>s){let h=i.get(u.largestBatchId);h===null&&(h=Rr(),i=i.insert(u.largestBatchId,h)),h.set(u.getKey(),u)}}const a=Rr(),c=i.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((u,h)=>a.set(u,h)),!(a.size()>=r)););return q.resolve(a)}bt(e,t,s){const r=this.overlays.get(s.key);if(r!==null){const o=this.Qr.get(r.largestBatchId).delete(s.key);this.Qr.set(r.largestBatchId,o)}this.overlays=this.overlays.insert(s.key,new x1(t,s));let i=this.Qr.get(t);i===void 0&&(i=Le(),this.Qr.set(t,i)),this.Qr.set(t,i.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hP{constructor(){this.sessionToken=Nt.EMPTY_BYTE_STRING}getSessionToken(e){return q.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,q.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dP{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.nr=1,this.Xr=new Tt(bt.Ur)}checkEmpty(e){return q.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,s,r){const i=this.nr;this.nr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new R1(i,t,s,r);this.mutationQueue.push(o);for(const a of r)this.Xr=this.Xr.add(new bt(a.key,i)),this.indexManager.addToCollectionParentIndex(e,a.key.path.popLast());return q.resolve(o)}lookupMutationBatch(e,t){return q.resolve(this.ei(t))}getNextMutationBatchAfterBatchId(e,t){const s=t+1,r=this.ti(s),i=r<0?0:r;return q.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return q.resolve(this.mutationQueue.length===0?nf:this.nr-1)}getAllMutationBatches(e){return q.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const s=new bt(t,0),r=new bt(t,Number.POSITIVE_INFINITY),i=[];return this.Xr.forEachInRange([s,r],o=>{const a=this.ei(o.Zr);i.push(a)}),q.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let s=new Tt(ke);return t.forEach(r=>{const i=new bt(r,0),o=new bt(r,Number.POSITIVE_INFINITY);this.Xr.forEachInRange([i,o],a=>{s=s.add(a.Zr)})}),q.resolve(this.ni(s))}getAllMutationBatchesAffectingQuery(e,t){const s=t.path,r=s.length+1;let i=s;me.isDocumentKey(i)||(i=i.child(""));const o=new bt(new me(i),0);let a=new Tt(ke);return this.Xr.forEachWhile(c=>{const u=c.key.path;return!!s.isPrefixOf(u)&&(u.length===r&&(a=a.add(c.Zr)),!0)},o),q.resolve(this.ni(a))}ni(e){const t=[];return e.forEach(s=>{const r=this.ei(s);r!==null&&t.push(r)}),t}removeMutationBatch(e,t){We(this.ri(t.batchId,"removed")===0,55003),this.mutationQueue.shift();let s=this.Xr;return q.forEach(t.mutations,r=>{const i=new bt(r.key,t.batchId);return s=s.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)}).next(()=>{this.Xr=s})}sr(e){}containsKey(e,t){const s=new bt(t,0),r=this.Xr.firstAfterOrEqual(s);return q.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,q.resolve()}ri(e,t){return this.ti(e)}ti(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}ei(e){const t=this.ti(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gP{constructor(e){this.persistence=e,this.oi=new qr(t=>of(t),af),this.lastRemoteSnapshotVersion=Se.min(),this.highestTargetId=0,this._i=0,this.ai=new ff,this.targetCount=0,this.ui=Ni.cr()}forEachTarget(e,t){return this.oi.forEach((s,r)=>t(r)),q.resolve()}getLastRemoteSnapshotVersion(e){return q.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return q.resolve(this._i)}allocateTargetId(e){return this.highestTargetId=this.ui.next(),q.resolve(this.highestTargetId)}setTargetsMetadata(e,t,s){return s&&(this.lastRemoteSnapshotVersion=s),t>this._i&&(this._i=t),q.resolve()}Tr(e){this.oi.set(e.target,e);const t=e.targetId;t>this.highestTargetId&&(this.ui=new Ni(t),this.highestTargetId=t),e.sequenceNumber>this._i&&(this._i=e.sequenceNumber)}addTargetData(e,t){return this.Tr(t),this.targetCount+=1,q.resolve()}updateTargetData(e,t){return this.Tr(t),q.resolve()}removeTargetData(e,t){return this.oi.delete(t.target),this.ai.Hr(t.targetId),this.targetCount-=1,q.resolve()}removeTargets(e,t,s){let r=0;const i=[];return this.oi.forEach((o,a)=>{a.sequenceNumber<=t&&s.get(a.targetId)===null&&(this.oi.delete(o),i.push(this.removeMatchingKeysForTargetId(e,a.targetId)),r++)}),q.waitFor(i).next(()=>r)}getTargetCount(e){return q.resolve(this.targetCount)}getTargetData(e,t){const s=this.oi.get(t)||null;return q.resolve(s)}addMatchingKeys(e,t,s){return this.ai.Gr(t,s),q.resolve()}removeMatchingKeys(e,t,s){this.ai.jr(t,s);const r=this.persistence.referenceDelegate,i=[];return r&&t.forEach(o=>{i.push(r.markPotentiallyOrphaned(e,o))}),q.waitFor(i)}removeMatchingKeysForTargetId(e,t){return this.ai.Hr(t),q.resolve()}getMatchingKeysForTargetId(e,t){const s=this.ai.Yr(t);return q.resolve(s)}containsKey(e,t){return q.resolve(this.ai.containsKey(t))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LE{constructor(e,t){this.ci={},this.overlays={},this.li=new Yc(0),this.hi=!1,this.hi=!0,this.Pi=new hP,this.referenceDelegate=e(this),this.Ti=new gP(this),this.indexManager=new Z1,this.remoteDocumentCache=function(r){return new fP(r)}(s=>this.referenceDelegate.Ii(s)),this.serializer=new J1(t),this.Ei=new cP(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.hi=!1,Promise.resolve()}get started(){return this.hi}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new uP,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let s=this.ci[e.toKey()];return s||(s=new dP(t,this.referenceDelegate),this.ci[e.toKey()]=s),s}getGlobalsCache(){return this.Pi}getTargetCache(){return this.Ti}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ei}runTransaction(e,t,s){ae("MemoryPersistence","Starting transaction:",e);const r=new mP(this.li.next());return this.referenceDelegate.di(),s(r).next(i=>this.referenceDelegate.Ai(r).next(()=>i)).toPromise().then(i=>(r.raiseOnCommittedEvent(),i))}Ri(e,t){return q.or(Object.values(this.ci).map(s=>()=>s.containsKey(e,t)))}}class mP extends Wx{constructor(e){super(),this.currentSequenceNumber=e}}class pf{constructor(e){this.persistence=e,this.Vi=new ff,this.mi=null}static fi(e){return new pf(e)}get gi(){if(this.mi)return this.mi;throw Ce(60996)}addReference(e,t,s){return this.Vi.addReference(s,t),this.gi.delete(s.toString()),q.resolve()}removeReference(e,t,s){return this.Vi.removeReference(s,t),this.gi.add(s.toString()),q.resolve()}markPotentiallyOrphaned(e,t){return this.gi.add(t.toString()),q.resolve()}removeTarget(e,t){this.Vi.Hr(t.targetId).forEach(r=>this.gi.add(r.toString()));const s=this.persistence.getTargetCache();return s.getMatchingKeysForTargetId(e,t.targetId).next(r=>{r.forEach(i=>this.gi.add(i.toString()))}).next(()=>s.removeTargetData(e,t))}di(){this.mi=new Set}Ai(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return q.forEach(this.gi,s=>{const r=me.fromPath(s);return this.pi(e,r).next(i=>{i||t.removeEntry(r,Se.min())})}).next(()=>(this.mi=null,t.apply(e)))}updateLimboDocument(e,t){return this.pi(e,t).next(s=>{s?this.gi.delete(t.toString()):this.gi.add(t.toString())})}Ii(e){return 0}pi(e,t){return q.or([()=>q.resolve(this.Vi.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ri(e,t)])}}class lc{constructor(e,t){this.persistence=e,this.yi=new qr(s=>Kx(s.path),(s,r)=>s.isEqual(r)),this.garbageCollector=iP(this,t)}static fi(e,t){return new lc(e,t)}di(){}Ai(e){return q.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}pr(e){const t=this.Sr(e);return this.persistence.getTargetCache().getTargetCount(e).next(s=>t.next(r=>s+r))}Sr(e){let t=0;return this.yr(e,s=>{t++}).next(()=>t)}yr(e,t){return q.forEach(this.yi,(s,r)=>this.Dr(e,s,r).next(i=>i?q.resolve():t(r)))}removeTargets(e,t,s){return this.persistence.getTargetCache().removeTargets(e,t,s)}removeOrphanedDocuments(e,t){let s=0;const r=this.persistence.getRemoteDocumentCache(),i=r.newChangeBuffer();return r.si(e,o=>this.Dr(e,o,t).next(a=>{a||(s++,i.removeEntry(o,Se.min()))})).next(()=>i.apply(e)).next(()=>s)}markPotentiallyOrphaned(e,t){return this.yi.set(t,e.currentSequenceNumber),q.resolve()}removeTarget(e,t){const s=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,s)}addReference(e,t,s){return this.yi.set(s,e.currentSequenceNumber),q.resolve()}removeReference(e,t,s){return this.yi.set(s,e.currentSequenceNumber),q.resolve()}updateLimboDocument(e,t){return this.yi.set(t,e.currentSequenceNumber),q.resolve()}Ii(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=xl(e.data.value)),t}Dr(e,t,s){return q.or([()=>this.persistence.Ri(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{const r=this.yi.get(t);return q.resolve(r!==void 0&&r>s)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gf{constructor(e,t,s,r){this.targetId=e,this.fromCache=t,this.ds=s,this.As=r}static Rs(e,t){let s=Le(),r=Le();for(const i of t.docChanges)switch(i.type){case 0:s=s.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new gf(e,t.fromCache,s,r)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yP{constructor(){this.Vs=!1,this.fs=!1,this.gs=100,this.ps=function(){return lA()?8:qx(qt())>0?6:4}()}initialize(e,t){this.ys=e,this.indexManager=t,this.Vs=!0}getDocumentsMatchingQuery(e,t,s,r){const i={result:null};return this.ws(e,t).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.Ss(e,t,r,s).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new _P;return this.bs(e,t,o).next(a=>{if(i.result=a,this.fs)return this.Ds(e,t,o,a.size)})}).next(()=>i.result)}Ds(e,t,s,r){return s.documentReadCount<this.gs?(si()<=De.DEBUG&&ae("QueryEngine","SDK will not create cache indexes for query:",ri(t),"since it only creates cache indexes for collection contains","more than or equal to",this.gs,"documents"),q.resolve()):(si()<=De.DEBUG&&ae("QueryEngine","Query:",ri(t),"scans",s.documentReadCount,"local documents and returns",r,"documents as results."),s.documentReadCount>this.ps*r?(si()<=De.DEBUG&&ae("QueryEngine","The SDK decides to create cache indexes for query:",ri(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,zn(t))):q.resolve())}ws(e,t){if(Fm(t))return q.resolve(null);let s=zn(t);return this.indexManager.getIndexType(e,s).next(r=>r===0?null:(t.limit!==null&&r===1&&(t=Qh(t,null,"F"),s=zn(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next(i=>{const o=Le(...i);return this.ys.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,s).next(c=>{const u=this.vs(t,a);return this.Cs(t,u,o,c.readTime)?this.ws(e,Qh(t,null,"F")):this.Fs(e,u,t,c)}))})))}Ss(e,t,s,r){return Fm(t)||r.isEqual(Se.min())?q.resolve(null):this.ys.getDocuments(e,s).next(i=>{const o=this.vs(t,i);return this.Cs(t,o,s,r)?q.resolve(null):(si()<=De.DEBUG&&ae("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),ri(t)),this.Fs(e,o,t,$x(r,ia)).next(a=>a))})}vs(e,t){let s=new Tt(fE(e));return t.forEach((r,i)=>{tu(e,i)&&(s=s.add(i))}),s}Cs(e,t,s,r){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}bs(e,t,s){return si()<=De.DEBUG&&ae("QueryEngine","Using full collection scan to execute query:",ri(t)),this.ys.getDocumentsMatchingQuery(e,t,ir.min(),s)}Fs(e,t,s,r){return this.ys.getDocumentsMatchingQuery(e,s,r).next(i=>(t.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zm="ConnectivityMonitor";class e_{constructor(){this.Bo=()=>this.Lo(),this.ko=()=>this.qo(),this.Qo=[],this.$o()}No(e){this.Qo.push(e)}shutdown(){window.removeEventListener("online",this.Bo),window.removeEventListener("offline",this.ko)}$o(){window.addEventListener("online",this.Bo),window.addEventListener("offline",this.ko)}Lo(){ae(Zm,"Network connectivity changed: AVAILABLE");for(const e of this.Qo)e(0)}qo(){ae(Zm,"Network connectivity changed: UNAVAILABLE");for(const e of this.Qo)e(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vt="WebChannelConnection";class DP extends kP{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,s,r,i){const o=td();return new Promise((a,c)=>{const u=new B0;u.setWithCredentials(!0),u.listenOnce($0.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Rl.NO_ERROR:const d=u.getResponseJson();ae(Vt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(d)),a(d);break;case Rl.TIMEOUT:ae(Vt,`RPC '${e}' ${o} timed out`),c(new le(z.DEADLINE_EXCEEDED,"Request time out"));break;case Rl.HTTP_ERROR:const p=u.getStatus();if(ae(Vt,`RPC '${e}' ${o} failed with status:`,p,"response text:",u.getResponseText()),p>0){let m=u.getResponseJson();Array.isArray(m)&&(m=m[0]);const v=m==null?void 0:m.error;if(v&&v.status&&v.message){const b=function(L){const V=L.toLowerCase().replace(/_/g,"-");return Object.values(z).indexOf(V)>=0?V:z.UNKNOWN}(v.status);c(new le(b,v.message))}else c(new le(z.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new le(z.UNAVAILABLE,"Connection failed."));break;default:Ce(9055,{l_:e,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{ae(Vt,`RPC '${e}' ${o} completed.`)}});const h=JSON.stringify(r);ae(Vt,`RPC '${e}' ${o} sending request:`,r),u.send(t,"POST",h,s,15)})}T_(e,t,s){const r=td(),i=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=G0(),a=H0(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Ho(c.initMessageHeaders,t,s),c.encodeInitMessageHeaders=!0;const h=i.join("");ae(Vt,`Creating RPC '${e}' stream ${r}: ${h}`,c);const d=o.createWebChannel(h,c);let p=!1,m=!1;const v=new NP({Zo:S=>{m?ae(Vt,`Not sending because RPC '${e}' stream ${r} is closed:`,S):(p||(ae(Vt,`Opening RPC '${e}' stream ${r} transport.`),d.open(),p=!0),ae(Vt,`RPC '${e}' stream ${r} sending:`,S),d.send(S))},Xo:()=>d.close()}),b=(S,L,V)=>{S.listen(L,B=>{try{V(B)}catch(j){setTimeout(()=>{throw j},0)}})};return b(d,So.EventType.OPEN,()=>{m||(ae(Vt,`RPC '${e}' stream ${r} transport opened.`),v.__())}),b(d,So.EventType.CLOSE,()=>{m||(m=!0,ae(Vt,`RPC '${e}' stream ${r} transport closed`),v.u_())}),b(d,So.EventType.ERROR,S=>{m||(m=!0,Si(Vt,`RPC '${e}' stream ${r} transport errored. Name:`,S.name,"Message:",S.message),v.u_(new le(z.UNAVAILABLE,"The operation could not be completed")))}),b(d,So.EventType.MESSAGE,S=>{var L;if(!m){const V=S.data[0];We(!!V,16349);const B=V,j=(B==null?void 0:B.error)||((L=B[0])===null||L===void 0?void 0:L.error);if(j){ae(Vt,`RPC '${e}' stream ${r} received error:`,j);const fe=j.status;let ue=function(I){const R=dt[I];if(R!==void 0)return CE(R)}(fe),A=j.message;ue===void 0&&(ue=z.INTERNAL,A="Unknown error status: "+fe+" with message "+j.message),m=!0,v.u_(new le(ue,A)),d.close()}else ae(Vt,`RPC '${e}' stream ${r} received:`,V),v.c_(V)}}),b(a,j0.STAT_EVENT,S=>{S.stat===$h.PROXY?ae(Vt,`RPC '${e}' stream ${r} detected buffering proxy`):S.stat===$h.NOPROXY&&ae(Vt,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{v.a_()},0),v}}function ah(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LP{}class VP extends LP{constructor(e,t,s,r){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=s,this.serializer=r,this.na=!1}ra(){if(this.na)throw new le(z.FAILED_PRECONDITION,"The client has already been terminated.")}zo(e,t,s,r){return this.ra(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.zo(e,Jh(t,s),r,i,o)).catch(i=>{throw i.name==="FirebaseError"?(i.code===z.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new le(z.UNKNOWN,i.toString())})}Yo(e,t,s,r,i){return this.ra(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,a])=>this.connection.Yo(e,Jh(t,s),r,o,a,i)).catch(o=>{throw o.name==="FirebaseError"?(o.code===z.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new le(z.UNKNOWN,o.toString())})}terminate(){this.na=!0,this.connection.terminate()}}class FP{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.ia=0,this.sa=null,this.oa=!0}_a(){this.ia===0&&(this.aa("Unknown"),this.sa=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.sa=null,this.ua("Backend didn't respond within 10 seconds."),this.aa("Offline"),Promise.resolve())))}ca(e){this.state==="Online"?this.aa("Unknown"):(this.ia++,this.ia>=1&&(this.la(),this.ua(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.aa("Offline")))}set(e){this.la(),this.ia=0,e==="Online"&&(this.oa=!1),this.aa(e)}aa(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}ua(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mi{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Mi(Nt.fromBase64String(e))}catch(t){throw new le(z.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Mi(Nt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hu{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new le(z.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new kt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fw(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new le(z.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Lf{}class Vk extends Lf{}function Fk(n,e,...t){let s=[];e instanceof Lf&&s.push(e),s=s.concat(t),function(i){const o=i.filter(c=>c instanceof Ff).length,a=i.filter(c=>c instanceof Vf).length;if(o>1||o>0&&a>0)throw new le(z.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(s);for(const r of s)n=r._apply(n);return n}class Vf extends Vk{constructor(e,t,s){super(),this._field=e,this._op=t,this._value=s,this.type="where"}static _create(e,t,s){return new Vf(e,t,s)}_apply(e){const t=this._parse(e);return pw(e._query,t),new Kr(e.firestore,e.converter,Kh(e._query,t))}_parse(e){const t=fu(e.firestore);return function(i,o,a,c,u,h,d){let p;if(u.isKeyField()){if(h==="array-contains"||h==="array-contains-any")throw new le(z.INVALID_ARGUMENT,`Invalid Query. You can't perform '${h}' queries on documentId().`);if(h==="in"||h==="not-in"){v_(d,h);const v=[];for(const b of d)v.push(y_(c,i,b));p={arrayValue:{values:v}}}else p=y_(c,i,d)}else h!=="in"&&h!=="not-in"&&h!=="array-contains-any"||v_(d,h),p=Ok(a,o,d,h==="in"||h==="not-in");return gt.create(u,h,p)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}class Ff extends Lf{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Ff(e,t)}_parse(e){const t=this._queryConstraints.map(s=>s._parse(e)).filter(s=>s.getFilters().length>0);return t.length===1?t[0]:Dn.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(r,i){let o=r;const a=i.getFlattenedFilters();for(const c of a)pw(o,c),o=Kh(o,c)}(e._query,t),new Kr(e.firestore,e.converter,Kh(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}function y_(n,e,t){if(typeof(t=et(t))=="string"){if(t==="")throw new le(z.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!hE(e)&&t.indexOf("/")!==-1)throw new le(z.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const s=e.path.child(st.fromString(t));if(!me.isDocumentKey(s))throw new le(z.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);return Nm(n,new me(s))}if(t instanceof Gt)return Nm(n,t._key);throw new le(z.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${lu(t)}.`)}function v_(n,e){if(!Array.isArray(n)||n.length===0)throw new le(z.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function pw(n,e){const t=function(r,i){for(const o of r)for(const a of o.getFlattenedFilters())if(i.indexOf(a.op)>=0)return a.op;return null}(n.filters,function(r){switch(r){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new le(z.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new le(z.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class Uk{convertValue(e,t="none"){switch(lr(e)){case 0:return null;case 1:return e.booleanValue;case 2:return ct(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(ar(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw Ce(62114,{value:e})}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const s={};return mr(e,(r,i)=>{s[r]=this.convertValue(i,t)}),s}convertVectorValue(e){var t,s,r;const i=(r=(s=(t=e.fields)===null||t===void 0?void 0:t[sc].arrayValue)===null||s===void 0?void 0:s.values)===null||r===void 0?void 0:r.map(o=>ct(o.doubleValue));return new kf(i)}convertGeoPoint(e){return new Pf(ct(e.latitude),ct(e.longitude))}convertArray(e,t){return(e.values||[]).map(s=>this.convertValue(s,t))}convertServerTimestamp(e,t){switch(t){case"previous":const s=Xc(e);return s==null?null:this.convertValue(s,t);case"estimate":return this.convertTimestamp(oa(e));default:return null}}convertTimestamp(e){const t=or(e);return new wt(t.seconds,t.nanos)}convertDocumentKey(e,t){const s=st.fromString(e);We(OE(s),9688,{name:e});const r=new aa(s.get(1),s.get(3)),i=new me(s.popFirst(5));return r.isEqual(t)||Cs(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gw(n,e,t){let s;return s=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function E_(n){n=sn(n,Gt);const e=sn(n.firestore,Ss);return Tk(uu(e),n._key).then(t=>yw(e,n,t))}class Uf extends Uk{constructor(e){super(),this.firestore=e}convertBytes(e){return new Mi(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Gt(this.firestore,null,t)}}function fc(n){n=sn(n,Kr);const e=sn(n.firestore,Ss),t=uu(e),s=new Uf(e);return fw(n._query),Ik(t,n._query).then(r=>new _w(e,s,n,r))}function w_(n,e,t){n=sn(n,Gt);const s=sn(n.firestore,Ss),r=gw(n.converter,e,t);return gu(s,[aw(fu(s),"setDoc",n._key,r,n.converter!==null,t).toMutation(n._key,Tn.none())])}function $k(n,e,t,...s){n=sn(n,Gt);const r=sn(n.firestore,Ss),i=fu(r);let o;return o=typeof(e=et(e))=="string"||e instanceof hu?Dk(i,"updateDoc",n._key,e,t,s):Nk(i,"updateDoc",n._key,e),gu(r,[o.toMutation(n._key,Tn.exists(!0))])}function jk(n){return gu(sn(n.firestore,Ss),[new cf(n._key,Tn.none())])}function Hk(n,e){const t=sn(n.firestore,Ss),s=ha(n),r=gw(n.converter,e);return gu(t,[aw(fu(n.firestore),"addDoc",s._key,r,n.converter!==null,{}).toMutation(s._key,Tn.exists(!1))]).then(()=>s)}function Gk(n,...e){var t,s,r;n=et(n);let i={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||__(e[o])||(i=e[o],o++);const a={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(__(e[o])){const d=e[o];e[o]=(t=d.next)===null||t===void 0?void 0:t.bind(d),e[o+1]=(s=d.error)===null||s===void 0?void 0:s.bind(d),e[o+2]=(r=d.complete)===null||r===void 0?void 0:r.bind(d)}let c,u,h;if(n instanceof Gt)u=sn(n.firestore,Ss),h=Zc(n._key.path),c={next:d=>{e[o]&&e[o](yw(u,n,d))},error:e[o+1],complete:e[o+2]};else{const d=sn(n,Kr);u=sn(d.firestore,Ss),h=d._query;const p=new Uf(u);c={next:m=>{e[o]&&e[o](new _w(u,p,d,m))},error:e[o+1],complete:e[o+2]},fw(n._query)}return function(p,m,v,b){const S=new xf(b),L=new Af(m,S,v);return p.asyncQueue.enqueueAndForget(async()=>If(await hc(p),L)),()=>{S.Cu(),p.asyncQueue.enqueueAndForget(async()=>bf(await hc(p),L))}}(uu(u),h,a,c)}function gu(n,e){return function(s,r){const i=new ys;return s.asyncQueue.enqueueAndForget(async()=>uk(await wk(s),r,i)),i.promise}(uu(n),e)}function yw(n,e,t){const s=t.docs.get(e._key),r=new Uf(n);return new mw(n,r,e._key,s,new Po(t.hasPendingWrites,t.fromCache),e.converter)}function Wk(){return new Nf("serverTimestamp")}function qk(...n){return new Df("arrayUnion",n)}(function(e,t=!0){(function(r){zi=r})(jr),Dr(new sr("firestore",(s,{instanceIdentifier:r,options:i})=>{const o=s.getProvider("app").getImmediate(),a=new Ss(new Ox(s.getProvider("auth-internal")),new Vx(o,s.getProvider("app-check-internal")),function(u,h){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new le(z.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new aa(u.options.projectId,h)}(o,r),o);return i=Object.assign({useFetchStreams:t},i),a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),Gn(Em,wm,e),Gn(Em,wm,"esm2017")})();var T_={};const I_="@firebase/database",b_="1.0.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gc extends jw{static getInstance(){return new gc}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!$d()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return ee(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gf extends jw{static getInstance(){return new Gf}constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}getInitialEvent(e){return ee(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gl;class Kw extends mu{static get __EMPTY_NODE(){return gl}static set __EMPTY_NODE(e){gl=e}compare(e,t){return Xi(e.name,t.name)}isDefinedOn(e){throw Gi("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Ne.MIN}maxPost(){return new Ne(Vr,gl)}makePost(e,t){return ee(typeof e=="string","KeyIndex indexValue must always be a string."),new Ne(e,gl)}toString(){return".key"}}const wi=new Kw;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WN(n,e){return Xi(n.name,e.name)}function Wf(n,e){return Xi(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YN=Math.log(2);class JN{constructor(e){const t=i=>parseInt(Math.log(i)/YN,10),s=i=>parseInt(Array(i+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const r=s(this.count);this.bits_=e+1&r}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const mc=function(n,e,t,s){n.sort(e);const r=function(c,u){const h=u-c;let d,p;if(h===0)return null;if(h===1)return d=n[c],p=t?t(d):d,new Ct(p,d.node,Ct.BLACK,null,null);{const m=parseInt(h/2,10)+c,v=r(c,m),b=r(m+1,u);return d=n[m],p=t?t(d):d,new Ct(p,d.node,Ct.BLACK,v,b)}},i=function(c){let u=null,h=null,d=n.length;const p=function(v,b){const S=d-v,L=d;d-=v;const V=r(S+1,L),B=n[S],j=t?t(B):B;m(new Ct(j,B.node,b,null,V))},m=function(v){u?(u.left=v,u=v):(h=v,u=v)};for(let v=0;v<c.count;++v){const b=c.nextBitIsOne(),S=Math.pow(2,c.count-(v+1));b?p(S,Ct.BLACK):(p(S,Ct.BLACK),p(S,Ct.RED))}return h},o=new JN(n.length),a=i(o);return new nn(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dh;const ti={};class ms{static get Default(){return ee(ti&&lt,"ChildrenNode.ts has not been loaded"),dh=dh||new ms({".priority":ti},{".priority":lt}),dh}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=bi(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof nn?t:null}hasIndex(e){return ks(this.indexSet_,e.toString())}addIndex(e,t){ee(e!==wi,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let r=!1;const i=t.getIterator(Ne.Wrap);let o=i.getNext();for(;o;)r=r||e.isDefinedOn(o.node),s.push(o),o=i.getNext();let a;r?a=mc(s,e.getCompare()):a=ti;const c=e.toString(),u=Object.assign({},this.indexSet_);u[c]=e;const h=Object.assign({},this.indexes_);return h[c]=a,new ms(h,u)}addToIndexes(e,t){const s=zl(this.indexes_,(r,i)=>{const o=bi(this.indexSet_,i);if(ee(o,"Missing index implementation for "+i),r===ti)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator(Ne.Wrap);let u=c.getNext();for(;u;)u.name!==e.name&&a.push(u),u=c.getNext();return a.push(e),mc(a,o.getCompare())}else return ti;else{const a=t.get(e.name);let c=r;return a&&(c=c.remove(new Ne(e.name,a))),c.insert(e,e.node)}});return new ms(s,this.indexSet_)}removeFromIndexes(e,t){const s=zl(this.indexes_,r=>{if(r===ti)return r;{const i=t.get(e.name);return i?r.remove(new Ne(e.name,i)):r}});return new ms(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tD extends mu{compare(e,t){const s=e.node.compareTo(t.node);return s===0?Xi(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Ne.MIN}maxPost(){return Ne.MAX}makePost(e,t){const s=At(e);return new Ne(t,s)}toString(){return".value"}}const nD=new tD;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $_=10*1e3,cD=30*1e3,uD=5*60*1e3;class hD{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new lD(e);const s=$_+(cD-$_)*Math.random();Go(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;on(e,(r,i)=>{i>0&&ks(this.statsToReport_,r)&&(t[r]=i,s=!0)}),s&&this.server_.reportStats(t),Go(this.reportStats_.bind(this),Math.floor(Math.random()*2*uD))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ma{constructor(e,t){this.source=e,this.path=t,this.type=Rn.LISTEN_COMPLETE}operationForChild(e){return Oe(this.path)?new ma(this.source,$e()):new ma(this.source,Xe(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dD{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function fD(n,e,t,s){const r=[],i=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&i.push(sD(o.childName,o.snapshotNode))}),Eo(n,r,"child_removed",e,s,t),Eo(n,r,"child_added",e,s,t),Eo(n,r,"child_moved",i,s,t),Eo(n,r,"child_changed",e,s,t),Eo(n,r,"value",e,s,t),r}function Eo(n,e,t,s,r,i){const o=s.filter(a=>a.type===t);o.sort((a,c)=>gD(n,a,c)),o.forEach(a=>{const c=pD(n,a,i);r.forEach(u=>{u.respondsTo(a.type)&&e.push(u.createEvent(c,n.query_))})})}function pD(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function gD(n,e,t){if(e.childName==null||t.childName==null)throw Gi("Should only compare child_ events.");const s=new Ne(e.childName,e.snapshotNode),r=new Ne(t.childName,t.snapshotNode);return n.index_.compare(s,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _u(n,e){return{eventCache:n,serverCache:e}}function Wo(n,e,t,s){return _u(new dr(e,t,s),n.serverCache)}function nT(n,e,t,s){return _u(n.eventCache,new dr(e,t,s))}function Ec(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Ur(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Cc;function JD(n){ee(!Cc,"__referenceConstructor has already been defined"),Cc=n}function XD(){return ee(Cc,"Reference.ts has not been loaded"),Cc}let ZD=1;class J_{constructor(e){this.listenProvider_=e,this.syncPointTree_=new nt(null),this.pendingWriteTree_=RD(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function mT(n,e,t,s,r){return _D(n.pendingWriteTree_,e,t,s,r),r?Ba(n,new Fr(tT(),e,t)):[]}function Pr(n,e,t=!1){const s=yD(n.pendingWriteTree_,e);if(vD(n.pendingWriteTree_,e)){let i=new nt(null);return s.snap!=null?i=i.set($e(),!0):on(s.children,o=>{i=i.set(new Qe(o),!0)}),Ba(n,new vc(s.path,i,t))}else return[]}function Ua(n,e,t){return Ba(n,new Fr(Kf(),e,t))}function eO(n,e,t){const s=nt.fromObject(t);return Ba(n,new _a(Kf(),e,s))}function tO(n,e){return Ba(n,new ma(Kf(),e))}function nO(n,e,t){const s=tp(n,t);if(s){const r=np(s),i=r.path,o=r.queryId,a=Yt(i,e),c=new ma(Qf(o),a);return sp(n,i,c)}else return[]}function _T(n,e,t,s,r=!1){const i=e._path,o=n.syncPointTree_.get(i);let a=[];if(o&&(e._queryIdentifier==="default"||gT(o,e))){const c=YD(o,e,t,s);KD(o)&&(n.syncPointTree_=n.syncPointTree_.remove(i));const u=c.removed;if(a=c.events,!r){const h=u.findIndex(p=>p._queryParams.loadsAllData())!==-1,d=n.syncPointTree_.findOnPath(i,(p,m)=>fr(m));if(h&&!d){const p=n.syncPointTree_.subtree(i);if(!p.isEmpty()){const m=oO(p);for(let v=0;v<m.length;++v){const b=m[v],S=b.query,L=wT(n,b);n.listenProvider_.startListening(zo(S),ya(n,S),L.hashFn,L.onComplete)}}}!d&&u.length>0&&!s&&(h?n.listenProvider_.stopListening(zo(e),null):u.forEach(p=>{const m=n.queryToTagMap.get(Eu(p));n.listenProvider_.stopListening(zo(p),m)}))}aO(n,u)}return a}function yT(n,e,t,s){const r=tp(n,s);if(r!=null){const i=np(r),o=i.path,a=i.queryId,c=Yt(o,e),u=new Fr(Qf(a),c,t);return sp(n,o,u)}else return[]}function sO(n,e,t,s){const r=tp(n,s);if(r){const i=np(r),o=i.path,a=i.queryId,c=Yt(o,e),u=nt.fromObject(t),h=new _a(Qf(a),c,u);return sp(n,o,h)}else return[]}function rO(n,e,t,s=!1){const r=e._path;let i=null,o=!1;n.syncPointTree_.foreachOnPath(r,(p,m)=>{const v=Yt(p,r);i=i||Zs(m,v),o=o||fr(m)});let a=n.syncPointTree_.get(r);a?(o=o||fr(a),i=i||Zs(a,$e())):(a=new hT,n.syncPointTree_=n.syncPointTree_.set(r,a));let c;i!=null?c=!0:(c=!1,i=be.EMPTY_NODE,n.syncPointTree_.subtree(r).foreachChild((m,v)=>{const b=Zs(v,$e());b&&(i=i.updateImmediateChild(m,b))}));const u=gT(a,e);if(!u&&!e._queryParams.loadsAllData()){const p=Eu(e);ee(!n.queryToTagMap.has(p),"View does not exist, but we have a tag");const m=lO();n.queryToTagMap.set(p,m),n.tagToQueryMap.set(m,p)}const h=yu(n.pendingWriteTree_,r);let d=QD(a,e,t,h,i,c);if(!u&&!o&&!s){const p=pT(a,e);d=d.concat(cO(n,e,p))}return d}function ep(n,e,t){const r=n.pendingWriteTree_,i=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=Yt(o,e),u=Zs(a,c);if(u)return u});return iT(r,e,i,t,!0)}function iO(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(u,h)=>{const d=Yt(u,t);s=s||Zs(h,d)});let r=n.syncPointTree_.get(t);r?s=s||Zs(r,$e()):(r=new hT,n.syncPointTree_=n.syncPointTree_.set(t,r));const i=s!=null,o=i?new dr(s,!0,!1):null,a=yu(n.pendingWriteTree_,e._path),c=dT(r,e,a,i?o.getNode():be.EMPTY_NODE,i);return jD(c)}function Ba(n,e){return vT(e,n.syncPointTree_,null,yu(n.pendingWriteTree_,$e()))}function vT(n,e,t,s){if(Oe(n.path))return ET(n,e,t,s);{const r=e.get($e());t==null&&r!=null&&(t=Zs(r,$e()));let i=[];const o=Me(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const u=t?t.getImmediateChild(o):null,h=oT(s,o);i=i.concat(vT(a,c,u,h))}return r&&(i=i.concat(Zf(r,n,s,t))),i}}function ET(n,e,t,s){const r=e.get($e());t==null&&r!=null&&(t=Zs(r,$e()));let i=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,u=oT(s,o),h=n.operationForChild(o);h&&(i=i.concat(ET(h,a,c,u)))}),r&&(i=i.concat(Zf(r,n,s,t))),i}function wT(n,e){const t=e.query,s=ya(n,t);return{hashFn:()=>($D(e)||be.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return s?nO(n,t._path,s):tO(n,t._path);{const i=rN(r,t);return _T(n,t,null,i)}}}}function ya(n,e){const t=Eu(e);return n.queryToTagMap.get(t)}function Eu(n){return n._path.toString()+"$"+n._queryIdentifier}function tp(n,e){return n.tagToQueryMap.get(e)}function np(n){const e=n.indexOf("$");return ee(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Qe(n.substr(0,e))}}function sp(n,e,t){const s=n.syncPointTree_.get(e);ee(s,"Missing sync point for query tag that we're tracking");const r=yu(n.pendingWriteTree_,e);return Zf(s,t,r,null)}function oO(n){return n.fold((e,t,s)=>{if(t&&fr(t))return[vu(t)];{let r=[];return t&&(r=fT(t)),on(s,(i,o)=>{r=r.concat(o)}),r}})}function zo(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(XD())(n._repo,n._path):n}function aO(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const r=Eu(s),i=n.queryToTagMap.get(r);n.queryToTagMap.delete(r),n.tagToQueryMap.delete(i)}}}function lO(){return ZD++}function cO(n,e,t){const s=e._path,r=ya(n,e),i=wT(n,t),o=n.listenProvider_.startListening(zo(e),r,i.hashFn,i.onComplete),a=n.syncPointTree_.subtree(s);if(r)ee(!fr(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((u,h,d)=>{if(!Oe(u)&&h&&fr(h))return[vu(h).query];{let p=[];return h&&(p=p.concat(fT(h).map(m=>m.query))),on(d,(m,v)=>{p=p.concat(v)}),p}});for(let u=0;u<c.length;++u){const h=c[u];n.listenProvider_.stopListening(zo(h),ya(n,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fp{constructor(e,t,s,r){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=r}get key(){return Oe(this._path)?null:Hw(this._path)}get ref(){return new Ds(this._repo,this._path)}get _queryIdentifier(){const e=B_(this._queryParams),t=Bf(e);return t==="{}"?"default":t}get _queryObject(){return B_(this._queryParams)}isEqual(e){if(e=et(e),!(e instanceof fp))return!1;const t=this._repo===e._repo,s=qw(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&s&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+LN(this._path)}}class Ds extends fp{constructor(e,t){super(e,t,new zf,!1)}get parent(){const e=Ww(this._path);return e===null?null:new Ds(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class va{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Qe(e),s=gd(this.ref,e);return new va(this._node.getChild(t),s,lt)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,r)=>e(new va(r,gd(this.ref,s),lt)))}hasChild(e){const t=new Qe(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function LT(n,e){return n=et(n),n._checkNotDeleted("ref"),e!==void 0?gd(n._root,e):n._root}function gd(n,e){return n=et(n),Me(n._path)===null?wO("child","path",e):RT("child","path",e),new Ds(n._repo,Et(n._path,e))}function qO(n,e){n=et(n),TO("set",n._path),EO("set",e,n._path);const t=new $c;return OO(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function VT(n){n=et(n);const e=new WO(()=>{}),t=new pp(e);return DO(n._repo,n,t).then(s=>new va(s,new Ds(n._repo,n._path),n._queryParams.getIndex()))}class pp{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new HO("value",this,new va(e.snapshotNode,new Ds(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new GO(this,e,t):null}matches(e){return e instanceof pp?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}qD(Ds);JD(Ds);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tM(n){zk(jr),Dr(new sr("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return YO(s,r,i,t)},"PUBLIC").setMultipleInstances(!0)),Gn(I_,b_,n),Gn(I_,b_,"esm2017")}vs.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};vs.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};tM();const nM={apiKey:"AIzaSyB43BHj0kWeKl6oRhKPXmzk2mownbe3eUM",authDomain:"tapandplay-7b964.firebaseapp.com",databaseURL:"https://tapandplay-7b964-default-rtdb.europe-west1.firebasedatabase.app",projectId:"tapandplay-7b964",storageBucket:"tapandplay-7b964.firebasestorage.app",messagingSenderId:"201759992414",appId:"1:201759992414:web:59953bc311be19a60a22cf",measurementId:"G-W041KDRDGX"},mp=Gv(nM),pn=Wr(mp),Bn=Ak(mp);gp(mp);/*!
  * vue-router v4.5.1
  * (c) 2025 Eduardo San Martin Morote
  * @license MIT
  */const ai=typeof document<"u";function FT(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function sM(n){return n.__esModule||n[Symbol.toStringTag]==="Module"||n.default&&FT(n.default)}const je=Object.assign;function mh(n,e){const t={};for(const s in e){const r=e[s];t[s]=On(r)?r.map(n):n(r)}return t}const Ko=()=>{},On=Array.isArray,UT=/#/g,rM=/&/g,iM=/\//g,oM=/=/g,aM=/\?/g,BT=/\+/g,lM=/%5B/g,cM=/%5D/g,$T=/%5E/g,uM=/%60/g,jT=/%7B/g,hM=/%7C/g,HT=/%7D/g,dM=/%20/g;function _p(n){return encodeURI(""+n).replace(hM,"|").replace(lM,"[").replace(cM,"]")}function fM(n){return _p(n).replace(jT,"{").replace(HT,"}").replace($T,"^")}function _d(n){return _p(n).replace(BT,"%2B").replace(dM,"+").replace(UT,"%23").replace(rM,"%26").replace(uM,"`").replace(jT,"{").replace(HT,"}").replace($T,"^")}function pM(n){return _d(n).replace(oM,"%3D")}function gM(n){return _p(n).replace(UT,"%23").replace(aM,"%3F")}function mM(n){return n==null?"":gM(n).replace(iM,"%2F")}function Ea(n){try{return decodeURIComponent(""+n)}catch{}return""+n}const _M=/\/$/,yM=n=>n.replace(_M,"");function _h(n,e,t="/"){let s,r={},i="",o="";const a=e.indexOf("#");let c=e.indexOf("?");return a<c&&a>=0&&(c=-1),c>-1&&(s=e.slice(0,c),i=e.slice(c+1,a>-1?a:e.length),r=n(i)),a>-1&&(s=s||e.slice(0,a),o=e.slice(a,e.length)),s=TM(s??e,t),{fullPath:s+(i&&"?")+i+o,path:s,query:r,hash:Ea(o)}}function vM(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function ny(n,e){return!e||!n.toLowerCase().startsWith(e.toLowerCase())?n:n.slice(e.length)||"/"}function EM(n,e,t){const s=e.matched.length-1,r=t.matched.length-1;return s>-1&&s===r&&Ui(e.matched[s],t.matched[r])&&GT(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function Ui(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function GT(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(const t in n)if(!wM(n[t],e[t]))return!1;return!0}function wM(n,e){return On(n)?sy(n,e):On(e)?sy(e,n):n===e}function sy(n,e){return On(e)?n.length===e.length&&n.every((t,s)=>t===e[s]):n.length===1&&n[0]===e}function TM(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),s=n.split("/"),r=s[s.length-1];(r===".."||r===".")&&s.push("");let i=t.length-1,o,a;for(o=0;o<s.length;o++)if(a=s[o],a!==".")if(a==="..")i>1&&i--;else break;return t.slice(0,i).join("/")+"/"+s.slice(o).join("/")}const Bs={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var wa;(function(n){n.pop="pop",n.push="push"})(wa||(wa={}));var Qo;(function(n){n.back="back",n.forward="forward",n.unknown=""})(Qo||(Qo={}));function IM(n){if(!n)if(ai){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),yM(n)}const bM=/^[^#]+#/;function CM(n,e){return n.replace(bM,"#")+e}function AM(n,e){const t=document.documentElement.getBoundingClientRect(),s=n.getBoundingClientRect();return{behavior:e.behavior,left:s.left-t.left-(e.left||0),top:s.top-t.top-(e.top||0)}}const Cu=()=>({left:window.scrollX,top:window.scrollY});function SM(n){let e;if("el"in n){const t=n.el,s=typeof t=="string"&&t.startsWith("#"),r=typeof t=="string"?s?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!r)return;e=AM(r,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function ry(n,e){return(history.state?history.state.position-e:-1)+n}const yd=new Map;function RM(n,e){yd.set(n,e)}function xM(n){const e=yd.get(n);return yd.delete(n),e}let PM=()=>location.protocol+"//"+location.host;function WT(n,e){const{pathname:t,search:s,hash:r}=e,i=n.indexOf("#");if(i>-1){let a=r.includes(n.slice(i))?n.slice(i).length:1,c=r.slice(a);return c[0]!=="/"&&(c="/"+c),ny(c,"")}return ny(t,n)+s+r}function kM(n,e,t,s){let r=[],i=[],o=null;const a=({state:p})=>{const m=WT(n,location),v=t.value,b=e.value;let S=0;if(p){if(t.value=m,e.value=p,o&&o===v){o=null;return}S=b?p.position-b.position:0}else s(m);r.forEach(L=>{L(t.value,v,{delta:S,type:wa.pop,direction:S?S>0?Qo.forward:Qo.back:Qo.unknown})})};function c(){o=t.value}function u(p){r.push(p);const m=()=>{const v=r.indexOf(p);v>-1&&r.splice(v,1)};return i.push(m),m}function h(){const{history:p}=window;p.state&&p.replaceState(je({},p.state,{scroll:Cu()}),"")}function d(){for(const p of i)p();i=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",h)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",h,{passive:!0}),{pauseListeners:c,listen:u,destroy:d}}function iy(n,e,t,s=!1,r=!1){return{back:n,current:e,forward:t,replaced:s,position:window.history.length,scroll:r?Cu():null}}function NM(n){const{history:e,location:t}=window,s={value:WT(n,t)},r={value:e.state};r.value||i(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(c,u,h){const d=n.indexOf("#"),p=d>-1?(t.host&&document.querySelector("base")?n:n.slice(d))+c:PM()+n+c;try{e[h?"replaceState":"pushState"](u,"",p),r.value=u}catch(m){console.error(m),t[h?"replace":"assign"](p)}}function o(c,u){const h=je({},e.state,iy(r.value.back,c,r.value.forward,!0),u,{position:r.value.position});i(c,h,!0),s.value=c}function a(c,u){const h=je({},r.value,e.state,{forward:c,scroll:Cu()});i(h.current,h,!0);const d=je({},iy(s.value,c,null),{position:h.position+1},u);i(c,d,!1),s.value=c}return{location:s,state:r,push:a,replace:o}}function DM(n){n=IM(n);const e=NM(n),t=kM(n,e.state,e.location,e.replace);function s(i,o=!0){o||t.pauseListeners(),history.go(i)}const r=je({location:"",base:n,go:s,createHref:CM.bind(null,n)},e,t);return Object.defineProperty(r,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(r,"state",{enumerable:!0,get:()=>e.state.value}),r}function OM(n){return n=location.host?n||location.pathname+location.search:"",n.includes("#")||(n+="#"),DM(n)}function MM(n){return typeof n=="string"||n&&typeof n=="object"}function qT(n){return typeof n=="string"||typeof n=="symbol"}const zT=Symbol("");var oy;(function(n){n[n.aborted=4]="aborted",n[n.cancelled=8]="cancelled",n[n.duplicated=16]="duplicated"})(oy||(oy={}));function Bi(n,e){return je(new Error,{type:n,[zT]:!0},e)}function ns(n,e){return n instanceof Error&&zT in n&&(e==null||!!(n.type&e))}const ay="[^/]+?",LM={sensitive:!1,strict:!1,start:!0,end:!0},VM=/[.+*?^${}()[\]/\\]/g;function FM(n,e){const t=je({},LM,e),s=[];let r=t.start?"^":"";const i=[];for(const u of n){const h=u.length?[]:[90];t.strict&&!u.length&&(r+="/");for(let d=0;d<u.length;d++){const p=u[d];let m=40+(t.sensitive?.25:0);if(p.type===0)d||(r+="/"),r+=p.value.replace(VM,"\\$&"),m+=40;else if(p.type===1){const{value:v,repeatable:b,optional:S,regexp:L}=p;i.push({name:v,repeatable:b,optional:S});const V=L||ay;if(V!==ay){m+=10;try{new RegExp(`(${V})`)}catch(j){throw new Error(`Invalid custom RegExp for param "${v}" (${V}): `+j.message)}}let B=b?`((?:${V})(?:/(?:${V}))*)`:`(${V})`;d||(B=S&&u.length<2?`(?:/${B})`:"/"+B),S&&(B+="?"),r+=B,m+=20,S&&(m+=-8),b&&(m+=-20),V===".*"&&(m+=-50)}h.push(m)}s.push(h)}if(t.strict&&t.end){const u=s.length-1;s[u][s[u].length-1]+=.7000000000000001}t.strict||(r+="/?"),t.end?r+="$":t.strict&&!r.endsWith("/")&&(r+="(?:/|$)");const o=new RegExp(r,t.sensitive?"":"i");function a(u){const h=u.match(o),d={};if(!h)return null;for(let p=1;p<h.length;p++){const m=h[p]||"",v=i[p-1];d[v.name]=m&&v.repeatable?m.split("/"):m}return d}function c(u){let h="",d=!1;for(const p of n){(!d||!h.endsWith("/"))&&(h+="/"),d=!1;for(const m of p)if(m.type===0)h+=m.value;else if(m.type===1){const{value:v,repeatable:b,optional:S}=m,L=v in u?u[v]:"";if(On(L)&&!b)throw new Error(`Provided param "${v}" is an array but it is not repeatable (* or + modifiers)`);const V=On(L)?L.join("/"):L;if(!V)if(S)p.length<2&&(h.endsWith("/")?h=h.slice(0,-1):d=!0);else throw new Error(`Missing required param "${v}"`);h+=V}}return h||"/"}return{re:o,score:s,keys:i,parse:a,stringify:c}}function UM(n,e){let t=0;for(;t<n.length&&t<e.length;){const s=e[t]-n[t];if(s)return s;t++}return n.length<e.length?n.length===1&&n[0]===80?-1:1:n.length>e.length?e.length===1&&e[0]===80?1:-1:0}function KT(n,e){let t=0;const s=n.score,r=e.score;for(;t<s.length&&t<r.length;){const i=UM(s[t],r[t]);if(i)return i;t++}if(Math.abs(r.length-s.length)===1){if(ly(s))return 1;if(ly(r))return-1}return r.length-s.length}function ly(n){const e=n[n.length-1];return n.length>0&&e[e.length-1]<0}const BM={type:0,value:""},$M=/[a-zA-Z0-9_]/;function jM(n){if(!n)return[[]];if(n==="/")return[[BM]];if(!n.startsWith("/"))throw new Error(`Invalid path "${n}"`);function e(m){throw new Error(`ERR (${t})/"${u}": ${m}`)}let t=0,s=t;const r=[];let i;function o(){i&&r.push(i),i=[]}let a=0,c,u="",h="";function d(){u&&(t===0?i.push({type:0,value:u}):t===1||t===2||t===3?(i.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:u,regexp:h,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),u="")}function p(){u+=c}for(;a<n.length;){if(c=n[a++],c==="\\"&&t!==2){s=t,t=4;continue}switch(t){case 0:c==="/"?(u&&d(),o()):c===":"?(d(),t=1):p();break;case 4:p(),t=s;break;case 1:c==="("?t=2:$M.test(c)?p():(d(),t=0,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case 2:c===")"?h[h.length-1]=="\\"?h=h.slice(0,-1)+c:t=3:h+=c;break;case 3:d(),t=0,c!=="*"&&c!=="?"&&c!=="+"&&a--,h="";break;default:e("Unknown state");break}}return t===2&&e(`Unfinished custom RegExp for param "${u}"`),d(),o(),r}function HM(n,e,t){const s=FM(jM(n.path),t),r=je(s,{record:n,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function GM(n,e){const t=[],s=new Map;e=dy({strict:!1,end:!0,sensitive:!1},e);function r(d){return s.get(d)}function i(d,p,m){const v=!m,b=uy(d);b.aliasOf=m&&m.record;const S=dy(e,d),L=[b];if("alias"in d){const j=typeof d.alias=="string"?[d.alias]:d.alias;for(const fe of j)L.push(uy(je({},b,{components:m?m.record.components:b.components,path:fe,aliasOf:m?m.record:b})))}let V,B;for(const j of L){const{path:fe}=j;if(p&&fe[0]!=="/"){const ue=p.record.path,A=ue[ue.length-1]==="/"?"":"/";j.path=p.record.path+(fe&&A+fe)}if(V=HM(j,p,S),m?m.alias.push(V):(B=B||V,B!==V&&B.alias.push(V),v&&d.name&&!hy(V)&&o(d.name)),QT(V)&&c(V),b.children){const ue=b.children;for(let A=0;A<ue.length;A++)i(ue[A],V,m&&m.children[A])}m=m||V}return B?()=>{o(B)}:Ko}function o(d){if(qT(d)){const p=s.get(d);p&&(s.delete(d),t.splice(t.indexOf(p),1),p.children.forEach(o),p.alias.forEach(o))}else{const p=t.indexOf(d);p>-1&&(t.splice(p,1),d.record.name&&s.delete(d.record.name),d.children.forEach(o),d.alias.forEach(o))}}function a(){return t}function c(d){const p=zM(d,t);t.splice(p,0,d),d.record.name&&!hy(d)&&s.set(d.record.name,d)}function u(d,p){let m,v={},b,S;if("name"in d&&d.name){if(m=s.get(d.name),!m)throw Bi(1,{location:d});S=m.record.name,v=je(cy(p.params,m.keys.filter(B=>!B.optional).concat(m.parent?m.parent.keys.filter(B=>B.optional):[]).map(B=>B.name)),d.params&&cy(d.params,m.keys.map(B=>B.name))),b=m.stringify(v)}else if(d.path!=null)b=d.path,m=t.find(B=>B.re.test(b)),m&&(v=m.parse(b),S=m.record.name);else{if(m=p.name?s.get(p.name):t.find(B=>B.re.test(p.path)),!m)throw Bi(1,{location:d,currentLocation:p});S=m.record.name,v=je({},p.params,d.params),b=m.stringify(v)}const L=[];let V=m;for(;V;)L.unshift(V.record),V=V.parent;return{name:S,path:b,params:v,matched:L,meta:qM(L)}}n.forEach(d=>i(d));function h(){t.length=0,s.clear()}return{addRoute:i,resolve:u,removeRoute:o,clearRoutes:h,getRoutes:a,getRecordMatcher:r}}function cy(n,e){const t={};for(const s of e)s in n&&(t[s]=n[s]);return t}function uy(n){const e={path:n.path,redirect:n.redirect,name:n.name,meta:n.meta||{},aliasOf:n.aliasOf,beforeEnter:n.beforeEnter,props:WM(n),children:n.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in n?n.components||null:n.component&&{default:n.component}};return Object.defineProperty(e,"mods",{value:{}}),e}function WM(n){const e={},t=n.props||!1;if("component"in n)e.default=t;else for(const s in n.components)e[s]=typeof t=="object"?t[s]:t;return e}function hy(n){for(;n;){if(n.record.aliasOf)return!0;n=n.parent}return!1}function qM(n){return n.reduce((e,t)=>je(e,t.meta),{})}function dy(n,e){const t={};for(const s in n)t[s]=s in e?e[s]:n[s];return t}function zM(n,e){let t=0,s=e.length;for(;t!==s;){const i=t+s>>1;KT(n,e[i])<0?s=i:t=i+1}const r=KM(n);return r&&(s=e.lastIndexOf(r,s-1)),s}function KM(n){let e=n;for(;e=e.parent;)if(QT(e)&&KT(n,e)===0)return e}function QT({record:n}){return!!(n.name||n.components&&Object.keys(n.components).length||n.redirect)}function QM(n){const e={};if(n===""||n==="?")return e;const s=(n[0]==="?"?n.slice(1):n).split("&");for(let r=0;r<s.length;++r){const i=s[r].replace(BT," "),o=i.indexOf("="),a=Ea(o<0?i:i.slice(0,o)),c=o<0?null:Ea(i.slice(o+1));if(a in e){let u=e[a];On(u)||(u=e[a]=[u]),u.push(c)}else e[a]=c}return e}function fy(n){let e="";for(let t in n){const s=n[t];if(t=pM(t),s==null){s!==void 0&&(e+=(e.length?"&":"")+t);continue}(On(s)?s.map(i=>i&&_d(i)):[s&&_d(s)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+t,i!=null&&(e+="="+i))})}return e}function YM(n){const e={};for(const t in n){const s=n[t];s!==void 0&&(e[t]=On(s)?s.map(r=>r==null?null:""+r):s==null?s:""+s)}return e}const JM=Symbol(""),py=Symbol(""),Au=Symbol(""),YT=Symbol(""),vd=Symbol("");function wo(){let n=[];function e(s){return n.push(s),()=>{const r=n.indexOf(s);r>-1&&n.splice(r,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function Gs(n,e,t,s,r,i=o=>o()){const o=s&&(s.enterCallbacks[r]=s.enterCallbacks[r]||[]);return()=>new Promise((a,c)=>{const u=p=>{p===!1?c(Bi(4,{from:t,to:e})):p instanceof Error?c(p):MM(p)?c(Bi(2,{from:e,to:p})):(o&&s.enterCallbacks[r]===o&&typeof p=="function"&&o.push(p),a())},h=i(()=>n.call(s&&s.instances[r],e,t,u));let d=Promise.resolve(h);n.length<3&&(d=d.then(u)),d.catch(p=>c(p))})}function yh(n,e,t,s,r=i=>i()){const i=[];for(const o of n)for(const a in o.components){let c=o.components[a];if(!(e!=="beforeRouteEnter"&&!o.instances[a]))if(FT(c)){const h=(c.__vccOpts||c)[e];h&&i.push(Gs(h,t,s,o,a,r))}else{let u=c();i.push(()=>u.then(h=>{if(!h)throw new Error(`Couldn't resolve component "${a}" at "${o.path}"`);const d=sM(h)?h.default:h;o.mods[a]=h,o.components[a]=d;const m=(d.__vccOpts||d)[e];return m&&Gs(m,t,s,o,a,r)()}))}}return i}function gy(n){const e=jn(Au),t=jn(YT),s=pt(()=>{const c=fi(n.to);return e.resolve(c)}),r=pt(()=>{const{matched:c}=s.value,{length:u}=c,h=c[u-1],d=t.matched;if(!h||!d.length)return-1;const p=d.findIndex(Ui.bind(null,h));if(p>-1)return p;const m=my(c[u-2]);return u>1&&my(h)===m&&d[d.length-1].path!==m?d.findIndex(Ui.bind(null,c[u-2])):p}),i=pt(()=>r.value>-1&&n2(t.params,s.value.params)),o=pt(()=>r.value>-1&&r.value===t.matched.length-1&&GT(t.params,s.value.params));function a(c={}){if(t2(c)){const u=e[fi(n.replace)?"replace":"push"](fi(n.to)).catch(Ko);return n.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>u),u}return Promise.resolve()}return{route:s,href:pt(()=>s.value.href),isActive:i,isExactActive:o,navigate:a}}function XM(n){return n.length===1?n[0]:n}const ZM=Zy({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:gy,setup(n,{slots:e}){const t=Nc(gy(n)),{options:s}=jn(Au),r=pt(()=>({[_y(n.activeClass,s.linkActiveClass,"router-link-active")]:t.isActive,[_y(n.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:t.isExactActive}));return()=>{const i=e.default&&XM(e.default(t));return n.custom?i:Av("a",{"aria-current":t.isExactActive?n.ariaCurrentValue:null,href:t.href,onClick:t.navigate,class:r.value},i)}}}),e2=ZM;function t2(n){if(!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)&&!n.defaultPrevented&&!(n.button!==void 0&&n.button!==0)){if(n.currentTarget&&n.currentTarget.getAttribute){const e=n.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return n.preventDefault&&n.preventDefault(),!0}}function n2(n,e){for(const t in e){const s=e[t],r=n[t];if(typeof s=="string"){if(s!==r)return!1}else if(!On(r)||r.length!==s.length||s.some((i,o)=>i!==r[o]))return!1}return!0}function my(n){return n?n.aliasOf?n.aliasOf.path:n.path:""}const _y=(n,e,t)=>n??e??t,s2=Zy({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(n,{attrs:e,slots:t}){const s=jn(vd),r=pt(()=>n.route||s.value),i=jn(py,0),o=pt(()=>{let u=fi(i);const{matched:h}=r.value;let d;for(;(d=h[u])&&!d.components;)u++;return u}),a=pt(()=>r.value.matched[o.value]);vl(py,pt(()=>o.value+1)),vl(JM,a),vl(vd,r);const c=ie();return El(()=>[c.value,a.value,n.name],([u,h,d],[p,m,v])=>{h&&(h.instances[d]=u,m&&m!==h&&u&&u===p&&(h.leaveGuards.size||(h.leaveGuards=m.leaveGuards),h.updateGuards.size||(h.updateGuards=m.updateGuards))),u&&h&&(!m||!Ui(h,m)||!p)&&(h.enterCallbacks[d]||[]).forEach(b=>b(u))},{flush:"post"}),()=>{const u=r.value,h=n.name,d=a.value,p=d&&d.components[h];if(!p)return yy(t.default,{Component:p,route:u});const m=d.props[h],v=m?m===!0?u.params:typeof m=="function"?m(u):m:null,S=Av(p,je({},v,e,{onVnodeUnmounted:L=>{L.component.isUnmounted&&(d.instances[h]=null)},ref:c}));return yy(t.default,{Component:S,route:u})||S}}});function yy(n,e){if(!n)return null;const t=n(e);return t.length===1?t[0]:t}const r2=s2;function i2(n){const e=GM(n.routes,n),t=n.parseQuery||QM,s=n.stringifyQuery||fy,r=n.history,i=wo(),o=wo(),a=wo(),c=tb(Bs);let u=Bs;ai&&n.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const h=mh.bind(null,M=>""+M),d=mh.bind(null,mM),p=mh.bind(null,Ea);function m(M,Y){let F,H;return qT(M)?(F=e.getRecordMatcher(M),H=Y):H=M,e.addRoute(H,F)}function v(M){const Y=e.getRecordMatcher(M);Y&&e.removeRoute(Y)}function b(){return e.getRoutes().map(M=>M.record)}function S(M){return!!e.getRecordMatcher(M)}function L(M,Y){if(Y=je({},Y||c.value),typeof M=="string"){const k=_h(t,M,Y.path),$=e.resolve({path:k.path},Y),W=r.createHref(k.fullPath);return je(k,$,{params:p($.params),hash:Ea(k.hash),redirectedFrom:void 0,href:W})}let F;if(M.path!=null)F=je({},M,{path:_h(t,M.path,Y.path).path});else{const k=je({},M.params);for(const $ in k)k[$]==null&&delete k[$];F=je({},M,{params:d(k)}),Y.params=d(Y.params)}const H=e.resolve(F,Y),oe=M.hash||"";H.params=h(p(H.params));const y=vM(s,je({},M,{hash:fM(oe),path:H.path})),w=r.createHref(y);return je({fullPath:y,hash:oe,query:s===fy?YM(M.query):M.query||{}},H,{redirectedFrom:void 0,href:w})}function V(M){return typeof M=="string"?_h(t,M,c.value.path):je({},M)}function B(M,Y){if(u!==M)return Bi(8,{from:Y,to:M})}function j(M){return A(M)}function fe(M){return j(je(V(M),{replace:!0}))}function ue(M){const Y=M.matched[M.matched.length-1];if(Y&&Y.redirect){const{redirect:F}=Y;let H=typeof F=="function"?F(M):F;return typeof H=="string"&&(H=H.includes("?")||H.includes("#")?H=V(H):{path:H},H.params={}),je({query:M.query,hash:M.hash,params:H.path!=null?{}:M.params},H)}}function A(M,Y){const F=u=L(M),H=c.value,oe=M.state,y=M.force,w=M.replace===!0,k=ue(F);if(k)return A(je(V(k),{state:typeof k=="object"?je({},oe,k.state):oe,force:y,replace:w}),Y||F);const $=F;$.redirectedFrom=Y;let W;return!y&&EM(s,H,F)&&(W=Bi(16,{to:$,from:H}),it(H,H,!0,!1)),(W?Promise.resolve(W):R($,H)).catch(G=>ns(G)?ns(G,2)?G:rt(G):Te(G,$,H)).then(G=>{if(G){if(ns(G,2))return A(je({replace:w},V(G.to),{state:typeof G.to=="object"?je({},oe,G.to.state):oe,force:y}),Y||$)}else G=N($,H,!0,w,oe);return P($,H,G),G})}function E(M,Y){const F=B(M,Y);return F?Promise.reject(F):Promise.resolve()}function I(M){const Y=Q.values().next().value;return Y&&typeof Y.runWithContext=="function"?Y.runWithContext(M):M()}function R(M,Y){let F;const[H,oe,y]=o2(M,Y);F=yh(H.reverse(),"beforeRouteLeave",M,Y);for(const k of H)k.leaveGuards.forEach($=>{F.push(Gs($,M,Y))});const w=E.bind(null,M,Y);return F.push(w),he(F).then(()=>{F=[];for(const k of i.list())F.push(Gs(k,M,Y));return F.push(w),he(F)}).then(()=>{F=yh(oe,"beforeRouteUpdate",M,Y);for(const k of oe)k.updateGuards.forEach($=>{F.push(Gs($,M,Y))});return F.push(w),he(F)}).then(()=>{F=[];for(const k of y)if(k.beforeEnter)if(On(k.beforeEnter))for(const $ of k.beforeEnter)F.push(Gs($,M,Y));else F.push(Gs(k.beforeEnter,M,Y));return F.push(w),he(F)}).then(()=>(M.matched.forEach(k=>k.enterCallbacks={}),F=yh(y,"beforeRouteEnter",M,Y,I),F.push(w),he(F))).then(()=>{F=[];for(const k of o.list())F.push(Gs(k,M,Y));return F.push(w),he(F)}).catch(k=>ns(k,8)?k:Promise.reject(k))}function P(M,Y,F){a.list().forEach(H=>I(()=>H(M,Y,F)))}function N(M,Y,F,H,oe){const y=B(M,Y);if(y)return y;const w=Y===Bs,k=ai?history.state:{};F&&(H||w?r.replace(M.fullPath,je({scroll:w&&k&&k.scroll},oe)):r.push(M.fullPath,oe)),c.value=M,it(M,Y,F,w),rt()}let T;function Ye(){T||(T=r.listen((M,Y,F)=>{if(!ce.listening)return;const H=L(M),oe=ue(H);if(oe){A(je(oe,{replace:!0,force:!0}),H).catch(Ko);return}u=H;const y=c.value;ai&&RM(ry(y.fullPath,F.delta),Cu()),R(H,y).catch(w=>ns(w,12)?w:ns(w,2)?(A(je(V(w.to),{force:!0}),H).then(k=>{ns(k,20)&&!F.delta&&F.type===wa.pop&&r.go(-1,!1)}).catch(Ko),Promise.reject()):(F.delta&&r.go(-F.delta,!1),Te(w,H,y))).then(w=>{w=w||N(H,y,!1),w&&(F.delta&&!ns(w,8)?r.go(-F.delta,!1):F.type===wa.pop&&ns(w,20)&&r.go(-1,!1)),P(H,y,w)}).catch(Ko)}))}let _e=wo(),pe=wo(),ve;function Te(M,Y,F){rt(M);const H=pe.list();return H.length?H.forEach(oe=>oe(M,Y,F)):console.error(M),Promise.reject(M)}function ot(){return ve&&c.value!==Bs?Promise.resolve():new Promise((M,Y)=>{_e.add([M,Y])})}function rt(M){return ve||(ve=!M,Ye(),_e.list().forEach(([Y,F])=>M?F(M):Y()),_e.reset()),M}function it(M,Y,F,H){const{scrollBehavior:oe}=n;if(!ai||!oe)return Promise.resolve();const y=!F&&xM(ry(M.fullPath,0))||(H||!F)&&history.state&&history.state.scroll||null;return Zo().then(()=>oe(M,Y,y)).then(w=>w&&SM(w)).catch(w=>Te(w,M,Y))}const x=M=>r.go(M);let O;const Q=new Set,ce={currentRoute:c,listening:!0,addRoute:m,removeRoute:v,clearRoutes:e.clearRoutes,hasRoute:S,getRoutes:b,resolve:L,options:n,push:j,replace:fe,go:x,back:()=>x(-1),forward:()=>x(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:pe.add,isReady:ot,install(M){const Y=this;M.component("RouterLink",e2),M.component("RouterView",r2),M.config.globalProperties.$router=Y,Object.defineProperty(M.config.globalProperties,"$route",{enumerable:!0,get:()=>fi(c)}),ai&&!O&&c.value===Bs&&(O=!0,j(r.location).catch(oe=>{}));const F={};for(const oe in Bs)Object.defineProperty(F,oe,{get:()=>c.value[oe],enumerable:!0});M.provide(Au,Y),M.provide(YT,Gy(F)),M.provide(vd,c);const H=M.unmount;Q.add(M),M.unmount=function(){Q.delete(M),Q.size<1&&(u=Bs,T&&T(),T=null,c.value=Bs,O=!1,ve=!1),H()}}};function he(M){return M.reduce((Y,F)=>Y.then(()=>I(F)),Promise.resolve())}return ce}function o2(n,e){const t=[],s=[],r=[],i=Math.max(e.matched.length,n.matched.length);for(let o=0;o<i;o++){const a=e.matched[o];a&&(n.matched.find(u=>Ui(u,a))?s.push(a):t.push(a));const c=n.matched[o];c&&(e.matched.find(u=>Ui(u,c))||r.push(c))}return[t,s,r]}function Os(){return jn(Au)}const a2={class:"fixed top-5 left-8 right-5 z-50 flex justify-between items-center px-5 py-4 text-white sci-fi-font"},l2={key:0,class:"relative"},c2={key:0,class:"absolute right-0 mt-2 w-44 bg-gray-800 rounded-lg shadow-lg py-2 z-50"},u2={__name:"Header",setup(n){const e=ie(null),t=ie(!1),s=Os();Mn(()=>{qi(pn,a=>{e.value=a})});const r=()=>{t.value=!t.value},i=async()=>{await Jd(pn),t.value=!1,s.push("/")},o=()=>{t.value=!1};return(a,c)=>{const u=ji("router-link"),h=Cb("click-outside");return J(),Z("header",a2,[qe(u,{to:"/",class:"text-3xl font-bold tracking-wide"},{default:cn(()=>c[3]||(c[3]=[ht("Tap&Play")])),_:1,__:[3]}),e.value?vn((J(),Z("div",l2,[C("button",{onClick:r,class:"text-white hover:text-orange-500 transition unselectable"},c[4]||(c[4]=[C("span",{class:"material-symbols-outlined",style:{"font-size":"40px !important"}},"settings",-1)])),t.value?(J(),Z("div",c2,[qe(u,{to:"/profile",class:"flex items-center gap-2 px-4 py-2 hover:bg-gray-700 transition unselectable",onClick:c[0]||(c[0]=d=>t.value=!1)},{default:cn(()=>c[5]||(c[5]=[C("span",{class:"material-symbols-outlined"},"person",-1),ht(" Profile ")])),_:1,__:[5]}),qe(u,{to:"/badges",class:"flex items-center gap-2 px-4 py-2 hover:bg-gray-700 transition unselectable",onClick:c[1]||(c[1]=d=>t.value=!1)},{default:cn(()=>c[6]||(c[6]=[C("span",{class:"material-symbols-outlined"},"star",-1),ht(" Badges ")])),_:1,__:[6]}),qe(u,{to:"/records",class:"flex items-center gap-2 px-4 py-2 hover:bg-gray-700 transition unselectable",onClick:c[2]||(c[2]=d=>t.value=!1)},{default:cn(()=>c[7]||(c[7]=[C("span",{class:"material-symbols-outlined"},"trophy",-1),ht(" Records ")])),_:1,__:[7]}),C("button",{onClick:i,class:"flex items-center gap-2 w-full text-left px-4 py-2 text-red-500 hover:bg-red-800 hover:text-white transition unselectable"},c[8]||(c[8]=[C("span",{class:"material-symbols-outlined"},"logout",-1),ht(" Log out ")]))])):Be("",!0)])),[[h,o]]):(J(),jl(u,{key:1,to:"/login",class:"text-white hover:text-orange-500 transition unselectable"},{default:cn(()=>c[9]||(c[9]=[C("span",{class:"material-symbols-outlined",style:{"font-size":"40px !important"}},"login",-1)])),_:1,__:[9]}))])}}},Jt=(n,e)=>{const t=n.__vccOpts||n;for(const[s,r]of e)t[s]=r;return t},h2={},d2={class:"fixed top-1/2 left-1 transform -translate-y-1/2 flex flex-col items-center gap-5 z-50"},f2={class:"h-28 flex items-center"},p2={class:"h-28 flex items-center"},g2={class:"h-28 flex items-center"},m2={class:"h-28 flex items-center"};function _2(n,e){const t=ji("router-link");return J(),Z("nav",d2,[C("div",f2,[qe(t,{to:"/about",class:"transform rotate-[270deg] text-white hover:text-orange-500 tracking-widest text-xl transition sci-fi-font unselectable"},{default:cn(()=>e[0]||(e[0]=[ht(" ABOUT ")])),_:1,__:[0]})]),C("div",p2,[qe(t,{to:"/forum",class:"transform rotate-[270deg] text-white hover:text-orange-500 tracking-widest text-xl transition sci-fi-font unselectable"},{default:cn(()=>e[1]||(e[1]=[ht(" FORUM ")])),_:1,__:[1]})]),C("div",g2,[qe(t,{to:"/games",class:"transform rotate-[270deg] text-white hover:text-orange-500 tracking-widest text-xl transition sci-fi-font unselectable"},{default:cn(()=>e[2]||(e[2]=[ht(" GAMES ")])),_:1,__:[2]})]),C("div",m2,[qe(t,{to:"/",class:"transform rotate-[270deg] text-white hover:text-orange-500 tracking-widest text-xl transition sci-fi-font unselectable"},{default:cn(()=>e[3]||(e[3]=[ht(" HOME ")])),_:1,__:[3]})])])}const y2=Jt(h2,[["render",_2],["__scopeId","data-v-06b41e90"]]),v2={},E2={class:"fixed bottom-5 right-5 flex gap-4 z-50"};function w2(n,e){return J(),Z("footer",E2,e[0]||(e[0]=[Hi('<a href="https://t.me/" target="_blank" class="text-white hover:text-orange-500 text-3xl transition sci-fi-font"><i class="fab fa-telegram"></i></a><a href="https://instagram.com/" target="_blank" class="text-white hover:text-orange-500 text-3xl transition sci-fi-font"><i class="fab fa-instagram"></i></a><a href="https://discord.com/" target="_blank" class="text-white hover:text-orange-500 text-3xl transition sci-fi-font"><i class="fab fa-discord"></i></a>',3)]))}const T2=Jt(v2,[["render",w2]]),I2={class:"bg-linear-to-t from-gray-900 to-indigo-950 min-h-screen relative"},b2={__name:"App",setup(n){return(e,t)=>{const s=ji("router-view");return J(),Z("div",I2,[qe(u2),qe(y2),qe(s),qe(T2)])}}},Br="/TapNPlayHost/assets/Scifi1-Dr16ngVb.png",C2="data:image/png;base64,",Su="/TapNPlayHost/assets/Scifi3-D3gTAX0M.png",A2="/TapNPlayHost/assets/Circle-DSOFxAk4.png",S2="/TapNPlayHost/assets/Soldier1-BrBwvwlr.png",R2={},x2={class:"w-full h-[calc(100vh-64px)] flex items-center justify-center bg-transparent relative overflow-hidden"};function P2(n,e){return J(),Z("section",x2,e[0]||(e[0]=[Hi('<img src="'+Br+'" alt="Scifi Decoration 1" draggable="false" class="absolute top-40 left-50 w-80 z-20 unselectable"><img src="'+C2+'" alt="Scifi Decoration 2" draggable="false" class="absolute scale-150 bottom-1 w-96 z-20 unselectable"><img src="'+Su+'" alt="Scifi Decoration 3" draggable="false" class="absolute bottom-40 right-40 w-80 z-20 unselectable scale-x-[-1]"><div class="relative flex items-center justify-center z-10"><img src="'+A2+'" alt="Background Circle" draggable="false" class="w-96 md:w-[36rem] lg:w-[48rem] absolute z-0 unselectable"><h2 class="text-8xl md:text-9xl font-bold text-white tracking-wide z-10 sci-fi-font unselectable"> Tap&amp;Play </h2></div><img src="'+S2+'" alt="Soldier" draggable="false" class="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-auto h-[80vh] z-10 unselectable">',5)]))}const k2=Jt(R2,[["render",P2]]),yp="/TapNPlayHost/assets/Soldier-BbYICOpa.png",vp=ie(null);pn.onAuthStateChanged(n=>{vp.value=n});const N2=async(n,e,t="")=>{const s=await I0(pn,n,e);s&&s.user&&t.trim()&&(await Yd(s.user,{displayName:t.trim()}),vp.value=s.user)},D2=async(n,e)=>{await b0(pn,n,e)},O2=async()=>{await Jd(pn)};function JT(){return{user:vp,register:N2,login:D2,logout:O2}}const M2={class:"flex h-screen bg-linear-to-t from-gray-900 to-indigo-950 text-white font-sci-fi"},L2={class:"flex flex-col justify-center items-start px-10 md:px-20 w-full md:w-1/2"},V2={class:"relative"},F2=["type"],U2={class:"material-symbols-outlined text-xl"},B2={key:0,class:"text-red-400 text-sm mt-2"},$2={class:"mt-4 text-sm"},j2={__name:"Login",setup(n){const{login:e}=JT(),t=Os(),s=ie(""),r=ie(""),i=ie(""),o=ie(!1),a=()=>{o.value=!o.value},c=async()=>{i.value="";try{await e(s.value,r.value),await t.push("/")}catch(u){i.value="Failed to log in: "+((u==null?void 0:u.message)||"Unknown error")}};return(u,h)=>{const d=ji("router-link");return J(),Z("section",M2,[h[6]||(h[6]=Hi('<img src="'+Br+'" alt="Scifi Decoration 1" draggable="false" class="absolute top-40 left-30 w-80 z-5 unselectable" data-v-8bf69284><img src="'+Br+'" alt="Scifi Decoration 1" draggable="false" class="absolute bottom-30 left-110 w-80 z-5 unselectable scale-x-[1]" data-v-8bf69284><img src="'+Su+'" alt="Scifi Decoration 3" draggable="false" class="absolute bottom-10 left-120 w-80 z-5 unselectable scale-x-[-1]" data-v-8bf69284><div class="hidden md:flex w-2/3 z-10 items-end justify-center" data-v-8bf69284><img src="'+yp+'" draggable="false" alt="Soldier" class="h-[90vh] object-contain unselectable" data-v-8bf69284></div>',4)),C("div",L2,[h[5]||(h[5]=C("h2",{class:"text-4xl font-bold mb-8"},"Log In",-1)),C("form",{class:"w-full max-w-sm space-y-6",onSubmit:Uc(c,["prevent"])},[vn(C("input",{"onUpdate:modelValue":h[0]||(h[0]=p=>s.value=p),type:"email",placeholder:"Email",required:"",class:"w-full p-3 bg-gray-800 text-white rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},null,512),[[Hn,s.value]]),C("div",V2,[vn(C("input",{type:o.value?"text":"password","onUpdate:modelValue":h[1]||(h[1]=p=>r.value=p),placeholder:"Password",required:"",class:"w-full p-3 pr-12 bg-gray-800 text-white rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},null,8,F2),[[Pv,r.value]]),C("button",{type:"button",onClick:a,class:"absolute right-3 top-1/2 transform -translate-y-1/2 text-white hover:text-orange-500 focus:outline-none"},[C("span",U2,ye(o.value?"visibility":"visibility_off"),1)])]),h[2]||(h[2]=C("button",{type:"submit",class:"w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-full transition unselectable"}," Sign In ",-1)),i.value?(J(),Z("p",B2,ye(i.value),1)):Be("",!0)],32),C("p",$2,[h[4]||(h[4]=ht(" Don't have an account? ")),qe(d,{to:"/register",class:"text-orange-500 hover:underline"},{default:cn(()=>h[3]||(h[3]=[ht("Register!")])),_:1,__:[3]})])])])}}},H2=Jt(j2,[["__scopeId","data-v-8bf69284"]]),G2={class:"flex h-screen bg-gradient-to-t from-gray-900 to-indigo-950 text-white font-sci-fi"},W2={class:"flex flex-col justify-center items-start px-10 md:px-20 w-full md:w-1/2"},q2={class:"relative"},z2=["type"],K2={class:"material-symbols-outlined text-xl"},Q2={key:0,class:"text-red-400 text-sm mt-2"},Y2={class:"mt-4 text-sm"},J2={__name:"Register",setup(n){const{register:e}=JT(),t=Os(),s=ie(""),r=ie(""),i=ie(""),o=ie(""),a=ie(""),c=ie(!1),u=()=>{c.value=!c.value},h=async()=>{if(a.value="",i.value!==o.value){a.value="Passwords do not match.";return}try{await e(r.value,i.value,s.value),await t.push("/")}catch(d){a.value=d.message||"Registration failed."}};return(d,p)=>{const m=ji("router-link");return J(),Z("section",G2,[p[8]||(p[8]=Hi('<img src="'+Br+'" alt="Scifi Decoration 1" draggable="false" class="absolute top-40 left-30 w-80 z-5 unselectable" data-v-15532776><img src="'+Br+'" alt="Scifi Decoration 1" draggable="false" class="absolute bottom-30 left-110 w-80 z-5 unselectable scale-x-[1]" data-v-15532776><img src="'+Su+'" alt="Scifi Decoration 3" draggable="false" class="absolute bottom-10 left-120 w-80 z-5 unselectable scale-x-[-1]" data-v-15532776><div class="hidden md:flex w-2/3 items-end justify-center" data-v-15532776><img src="'+yp+'" alt="Soldier" draggable="false" class="h-[90vh] object-contain z-10 unselectable" data-v-15532776></div>',4)),C("div",W2,[p[7]||(p[7]=C("h2",{class:"text-4xl font-bold mb-8"},"Register",-1)),C("form",{class:"w-full max-w-sm space-y-6",onSubmit:Uc(h,["prevent"])},[vn(C("input",{"onUpdate:modelValue":p[0]||(p[0]=v=>s.value=v),type:"text",placeholder:"Username",required:"",class:"w-full p-3 bg-gray-800 text-white rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},null,512),[[Hn,s.value]]),vn(C("input",{"onUpdate:modelValue":p[1]||(p[1]=v=>r.value=v),type:"email",placeholder:"Email",required:"",class:"w-full p-3 bg-gray-800 text-white rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},null,512),[[Hn,r.value]]),C("div",q2,[vn(C("input",{type:c.value?"text":"password","onUpdate:modelValue":p[2]||(p[2]=v=>i.value=v),placeholder:"Password",required:"",class:"w-full p-3 pr-12 bg-gray-800 text-white rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},null,8,z2),[[Pv,i.value]]),C("button",{type:"button",onClick:u,class:"absolute right-3 top-1/2 transform -translate-y-1/2 text-white hover:text-orange-500 focus:outline-none"},[C("span",K2,ye(c.value?"visibility":"visibility_off"),1)])]),vn(C("input",{"onUpdate:modelValue":p[3]||(p[3]=v=>o.value=v),type:"password",placeholder:"Confirm Password",required:"",class:"w-full p-3 bg-gray-800 text-white rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},null,512),[[Hn,o.value]]),p[4]||(p[4]=C("button",{type:"submit",class:"w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-full transition unselectable"}," Sign Up ",-1)),a.value?(J(),Z("p",Q2,ye(a.value),1)):Be("",!0)],32),C("p",Y2,[p[6]||(p[6]=ht(" Already have an account? ")),qe(m,{to:"/login",class:"text-orange-500 hover:underline"},{default:cn(()=>p[5]||(p[5]=[ht("Log in")])),_:1,__:[5]})])])])}}},X2=Jt(J2,[["__scopeId","data-v-15532776"]]),Z2={class:"relative group bg-gray-900 p-4 rounded-xl shadow-lg hover:shadow-orange-500/30 transition duration-300 aspect-[4/3] flex flex-col justify-between"},eL=["src","alt"],tL={class:"text-lg font-semibold mt-2 mb-1"},nL={class:"flex flex-wrap gap-2 text-sm text-orange-400 mb-10"},sL={__name:"GameCard",props:{game:{type:Object,required:!0}},setup(n){const e=n,t=Os(),s=()=>{t.push(e.game.route)};return(r,i)=>(J(),Z("div",Z2,[C("img",{src:n.game.img,alt:n.game.title,class:"w-full h-full object-cover rounded-lg unselectable cursor-pointer",draggable:"false",onClick:s},null,8,eL),C("h3",tL,ye(n.game.title),1),C("div",nL,[(J(!0),Z(ft,null,kn(n.game.tags,(o,a)=>(J(),Z("span",{key:a,class:"bg-gray-800 px-2 py-1 rounded"},ye(o),1))),128))]),C("button",{class:"absolute bottom-4 right-4 w-13 h-13 bg-orange-500 hover:bg-orange-600 text-white rounded-md flex items-center justify-center shadow-md transition z-10",onClick:s},i[0]||(i[0]=[C("span",{class:"material-symbols-outlined text-xl unselectable",style:{"font-size":"40px !important"}},"play_arrow",-1)]))]))}},vy=Jt(sL,[["__scopeId","data-v-26a09101"]]),rL="/TapNPlayHost/assets/Tetris-DZUUzxDk.png",iL="/TapNPlayHost/assets/Minesweeper-BHtiLAUO.png",oL="/TapNPlayHost/assets/CandyCrush-CCB6NESK.png",aL="/TapNPlayHost/assets/SnakeGame-9YZUlPn4.png",lL="/TapNPlayHost/assets/SpaceShooter-BJ-V_I7_.png",cL={class:"pt-28 pb-20 pl-20 pr-6 md:pl-32 md:pr-12 text-white font-sci-fi"},uL={class:"flex flex-col md:flex-row justify-between items-center mb-10 gap-4"},hL={key:0,class:"mb-12"},dL={class:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8"},fL={key:1},pL={class:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8"},gL={key:2,class:"text-center text-gray-400 mt-20 text-lg"},mL={__name:"Games",setup(n){const e=ie(""),t=ie("All"),s=[{title:"Minesweeper",img:iL,tags:["Logic"],route:"/games/minesweeper",best:!0},{title:"Tetris",img:rL,tags:["Reaction","Logic"],route:"/games/tetris"},{title:"Snake",img:aL,tags:["Reaction","Fun"],route:"/games/snake",best:!0},{title:"Candy Crush",img:oL,tags:["Fun"],route:"/games/candycrush"},{title:"Space Shooter",img:lL,tags:["Reaction","Fun"],route:"/games/spaceshooter",best:!0}],r=pt(()=>s.filter(a=>{const c=a.title.toLowerCase().includes(e.value.toLowerCase()),u=t.value==="All"||a.tags.includes(t.value);return c&&u})),i=pt(()=>r.value.filter(a=>a.best)),o=pt(()=>r.value.filter(a=>!a.best));return(a,c)=>(J(),Z("section",cL,[c[5]||(c[5]=C("h1",{class:"text-4xl font-bold text-center mb-4"},"GAMES",-1)),c[6]||(c[6]=C("div",{class:"h-1 w-33 bg-white mx-auto mb-10 rounded-full"},null,-1)),C("div",uL,[vn(C("input",{"onUpdate:modelValue":c[0]||(c[0]=u=>e.value=u),type:"text",placeholder:"Search games...",class:"w-full md:w-1/2 p-3 bg-gray-800 rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},null,512),[[Hn,e.value]]),vn(C("select",{"onUpdate:modelValue":c[1]||(c[1]=u=>t.value=u),class:"w-full md:w-1/4 p-3 bg-gray-800 rounded-lg outline-none focus:ring-2 focus:ring-orange-500 unselectable"},c[2]||(c[2]=[C("option",{value:"All"},"All Categories",-1),C("option",{value:"Logic"},"Logic",-1),C("option",{value:"Reaction"},"Reaction",-1),C("option",{value:"Fun"},"Fun",-1)]),512),[[Rv,t.value]])]),i.value.length?(J(),Z("div",hL,[c[3]||(c[3]=C("h2",{class:"text-2xl md:text-3xl font-bold mb-6 text-orange-500"},"Best Games",-1)),C("div",dL,[(J(!0),Z(ft,null,kn(i.value,u=>(J(),jl(vy,{key:u.title,game:u},null,8,["game"]))),128))])])):Be("",!0),o.value.length?(J(),Z("div",fL,[c[4]||(c[4]=C("h2",{class:"text-2xl md:text-3xl font-bold mb-6 text-orange-500"},"Full Catalog",-1)),C("div",pL,[(J(!0),Z(ft,null,kn(o.value,u=>(J(),jl(vy,{key:u.title,game:u},null,8,["game"]))),128))])])):Be("",!0),r.value.length===0?(J(),Z("div",gL," No games found. ")):Be("",!0)]))}},_L=Jt(mL,[["__scopeId","data-v-0882774a"]]),Ac="/TapNPlayHost/assets/Badge-DYBy8X7v.png",yL={class:"flex h-screen bg-gradient-to-t from-gray-900 to-indigo-950 text-white font-sci-fi"},vL={class:"flex flex-col justify-center items-start px-10 md:px-20 w-full md:w-1/2"},EL={class:"text-xl mb-6"},wL={class:"ml-2"},TL={key:0,class:"text-gray-400 mb-6"},IL={key:1,class:"flex gap-4 mb-6"},bL=["src","alt","title"],CL={key:1,class:"material-symbols-outlined text-gray-400"},AL={class:"text-sm text-gray-400 mb-6"},SL={key:0,class:"fixed inset-0 bg-black opacity-90 flex z-50"},RL={key:1,class:"fixed inset-0 flex items-center justify-center z-50"},xL={class:"bg-gray-900 rounded-xl p-6 w-96"},PL={class:"flex justify-end gap-2"},kL={__name:"Profile",setup(n){const e=ie("Loading..."),t=ie(""),s=ie(!1),r=ie([]),i=ie(!0),o=pt(()=>r.value.length),a=pt(()=>{const p=r.value.slice(-3).reverse();return[...p,...Array(3-p.length).fill(null)].slice(0,3)}),c=async p=>{var m;try{i.value=!0;const v=await fc(Oi(Bn,"users",p,"badges")),b=[];for(const S of v.docs){const L=S.id,V=S.data();if((m=V.badgeIds)!=null&&m.length)try{const B=await fc(Oi(Bn,"badges",L,"badgeList")),j={};for(const ue of B.docs)j[ue.id]={...ue.data(),id:ue.id};const fe=V.badgeIds.filter(ue=>j[ue]).map(ue=>{var A,E,I;return{id:ue,name:((A=j[ue])==null?void 0:A.name)||"Unknown Badge",description:((E=j[ue])==null?void 0:E.description)||"No description available",iconUrl:((I=j[ue])==null?void 0:I.iconUrl)||Ac,gameId:L}});b.push(...fe)}catch(B){console.error(`Error fetching badges for game ${L}:`,B)}}r.value=b}catch(v){console.error("Error fetching user badges:",v)}finally{i.value=!1}};Mn(()=>{qi(pn,p=>{p?(e.value=p.displayName||"Unnamed Soldier",c(p.uid)):i.value=!1})});const u=()=>{t.value=e.value,s.value=!0},h=async()=>{const p=pn.currentUser;if(p&&t.value.trim()!=="")try{await Yd(p,{displayName:t.value.trim()}),e.value=t.value.trim(),s.value=!1}catch(m){console.error("Error updating profile:",m)}},d=p=>{p.target.src=Ac};return(p,m)=>{const v=ji("router-link");return J(),Z("section",yL,[m[7]||(m[7]=Hi('<img src="'+Br+'" alt="" class="absolute top-40 left-30 w-80 z-5 unselectable" draggable="false" data-v-904319aa><img src="'+Br+'" alt="" class="absolute bottom-30 left-110 w-80 z-5 unselectable scale-x-[1]" draggable="false" data-v-904319aa><img src="'+Su+'" alt="" class="absolute bottom-10 left-120 w-80 z-5 unselectable scale-x-[-1]" draggable="false" data-v-904319aa><div class="hidden md:flex w-2/3 items-end justify-center" data-v-904319aa><img src="'+yp+'" alt="Soldier" draggable="false" class="h-[90vh] object-contain z-10 unselectable" data-v-904319aa></div>',4)),C("div",vL,[m[5]||(m[5]=C("h2",{class:"text-4xl font-bold mb-6"},"My Profile",-1)),C("div",EL,[m[2]||(m[2]=C("span",{class:"font-semibold"},"Username:",-1)),C("span",wL,ye(e.value),1)]),C("div",null,[m[4]||(m[4]=C("h3",{class:"text-lg font-semibold mb-2"},"Latest Badges",-1)),i.value?(J(),Z("div",TL,"Loading badges...")):(J(),Z("div",IL,[(J(!0),Z(ft,null,kn(a.value,(b,S)=>(J(),Z("div",{key:S,class:"w-16 h-16 flex items-center justify-center bg-gray-800 rounded-lg"},[b?(J(),Z("img",{key:0,src:b.iconUrl,alt:b.name,title:b.name+" - "+b.description,class:"w-12 h-12 object-contain",onError:d},null,40,bL)):(J(),Z("span",CL,"add"))]))),128))])),C("p",AL,[ht(" Total badges: "+ye(o.value)+" | ",1),qe(v,{to:"/badges",class:"text-orange-400 hover:text-orange-300 underline"},{default:cn(()=>m[3]||(m[3]=[ht("View all badges")])),_:1,__:[3]})])]),C("button",{onClick:u,class:"bg-orange-500 hover:bg-orange-600 text-white py-2 px-6 rounded-full transition unselectable"}," Edit Profile ")]),s.value?(J(),Z("div",SL)):Be("",!0),s.value?(J(),Z("div",RL,[C("div",xL,[m[6]||(m[6]=C("h3",{class:"text-xl font-bold mb-4"},"Edit Username",-1)),vn(C("input",{"onUpdate:modelValue":m[0]||(m[0]=b=>t.value=b),type:"text",class:"w-full px-4 py-2 rounded bg-gray-800 text-white mb-4 unselectable",placeholder:"Enter new username"},null,512),[[Hn,t.value]]),C("div",PL,[C("button",{onClick:m[1]||(m[1]=b=>s.value=!1),class:"px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded unselectable"},"Cancel"),C("button",{onClick:h,class:"px-4 py-2 bg-orange-500 hover:bg-orange-600 rounded unselectable"},"Save")])])])):Be("",!0)])}}},NL=Jt(kL,[["__scopeId","data-v-904319aa"]]),DL="/TapNPlayHost/assets/vue-DrX0Z5OQ.png",OL="/TapNPlayHost/assets/tailwindcss-pp2QO6R3.png",ML="/TapNPlayHost/assets/javascript-DZlgK55J.png",LL="/TapNPlayHost/assets/firebase-CJHM9ODV.png",VL={},FL={class:"pt-28 pb-20 pl-20 pr-6 md:pl-32 md:pr-12 text-white font-sci-fi"};function UL(n,e){return J(),Z("section",FL,e[0]||(e[0]=[Hi('<h1 class="text-4xl font-bold text-center mb-4" data-v-93bcc0d5>ABOUT US</h1><div class="h-1 w-48 bg-white mx-auto mb-10 rounded-full" data-v-93bcc0d5></div><h2 class="text-2xl md:text-3xl font-bold text-orange-500 mb-6" data-v-93bcc0d5>Developers:</h2><div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-16" data-v-93bcc0d5><div class="flex flex-col items-center text-center" data-v-93bcc0d5><div class="w-24 h-24 rounded-full border-4 border-orange-500 flex items-center justify-center mb-4" data-v-93bcc0d5><span class="material-symbols-outlined text-orange-500 text-4xl unselectable" style="font-size:70px !important;" data-v-93bcc0d5>person</span></div><p class="text-orange-500 font-bold text-lg" data-v-93bcc0d5>Oleksii Malanii</p><p class="text-white text-sm" data-v-93bcc0d5>Team Leader</p><p class="text-white text-sm" data-v-93bcc0d5>Front-end Developer</p></div><div class="flex flex-col items-center text-center" data-v-93bcc0d5><div class="w-24 h-24 rounded-full border-4 border-orange-500 flex items-center justify-center mb-4" data-v-93bcc0d5><span class="material-symbols-outlined text-orange-500 text-4xl unselectable" style="font-size:70px !important;" data-v-93bcc0d5>person</span></div><p class="text-orange-500 font-bold text-lg" data-v-93bcc0d5>Denys Novosad</p><p class="text-white text-sm" data-v-93bcc0d5>Designer</p><p class="text-white text-sm" data-v-93bcc0d5>Front-end Developer</p></div><div class="flex flex-col items-center text-center" data-v-93bcc0d5><div class="w-24 h-24 rounded-full border-4 border-orange-500 flex items-center justify-center mb-4" data-v-93bcc0d5><span class="material-symbols-outlined text-orange-500 text-4xl unselectable" style="font-size:70px !important;" data-v-93bcc0d5>person</span></div><p class="text-orange-500 font-bold text-lg" data-v-93bcc0d5>Andrii Kohut</p><p class="text-white text-sm" data-v-93bcc0d5>Tech Leader</p><p class="text-white text-sm" data-v-93bcc0d5>Back-end Developer</p></div><div class="flex flex-col items-center text-center" data-v-93bcc0d5><div class="w-24 h-24 rounded-full border-4 border-orange-500 flex items-center justify-center mb-4" data-v-93bcc0d5><span class="material-symbols-outlined text-orange-500 text-4xl unselectable" style="font-size:70px !important;" data-v-93bcc0d5>person</span></div><p class="text-orange-500 font-bold text-lg" data-v-93bcc0d5>Labunskiy Yaroslav</p><p class="text-white text-sm" data-v-93bcc0d5>QA</p><p class="text-white text-sm" data-v-93bcc0d5>Back-end Developer</p></div></div><h2 class="text-2xl md:text-3xl font-bold text-orange-500 mb-4" data-v-93bcc0d5>Project Information:</h2><p class="text-white text-2xl mb-16 max-w-8xl" data-v-93bcc0d5> Tap&amp;Play is a collection of minigames designed for web, where users can enjoy simple, fast, and visually styled experiences. Built with modern web technologies, this platform aims to be engaging and easily extensible. </p><h2 class="text-2xl md:text-3xl font-bold text-orange-500 mb-6" data-v-93bcc0d5>Tools:</h2><div class="grid grid-cols-2 sm:grid-cols-4 gap-10 mt-15" data-v-93bcc0d5><div class="flex flex-col items-center" data-v-93bcc0d5><img src="'+DL+'" alt="Vue Logo" class="h-25 mb-2 unselectable" draggable="false" data-v-93bcc0d5><p class="text-white text-3xl unselectable" data-v-93bcc0d5>Vue</p></div><div class="flex flex-col items-center" data-v-93bcc0d5><img src="'+OL+'" alt="Tailwind Logo" class="h-25 mb-2 unselectable" draggable="false" data-v-93bcc0d5><p class="text-white text-3xl unselectable" data-v-93bcc0d5>TailwindCSS</p></div><div class="flex flex-col items-center" data-v-93bcc0d5><img src="'+ML+'" alt="JavaScript Logo" class="h-25 mb-2 unselectable" draggable="false" data-v-93bcc0d5><p class="text-white text-3xl unselectable" data-v-93bcc0d5>JavaScript</p></div><div class="flex flex-col items-center" data-v-93bcc0d5><img src="'+LL+'" alt="Firebase Logo" class="h-25 mb-2 unselectable" draggable="false" data-v-93bcc0d5><p class="text-white text-3xl unselectable" data-v-93bcc0d5>Firebase</p></div></div>',8)]))}const BL=Jt(VL,[["render",UL],["__scopeId","data-v-93bcc0d5"]]),$L={class:"pt-28 pb-20 pl-20 pr-6 md:pl-32 md:pr-12 text-white min-h-screen font-sci-fi"},jL={key:0,class:"text-gray-300 text-2xl text-center"},HL={key:1,class:"text-gray-400 text-xl text-center"},GL={key:2},WL={class:"text-2xl mb-4 capitalize"},qL={class:"grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4"},zL=["title"],KL=["src","alt"],QL={class:"text-sm text-center"},YL={class:"text-xs text-gray-400 text-center mt-1"},JL={key:3,class:"mt-8 p-4 bg-gray-800 rounded"},XL={class:"text-xs"},ZL={__name:"Badges",setup(n){const e=ie({}),t=ie(!0),s=ie(!1),r=async o=>{var a;try{console.log("Fetching badges for user:",o);const c=await fc(Oi(Bn,"users",o,"badges"));console.log("User badge documents found:",c.size);const u={};for(const h of c.docs){const d=h.id,p=h.data();if(console.log(`Processing game ${d}:`,p),(a=p.badgeIds)!=null&&a.length)try{console.log(`Fetching badge definitions for game: ${d}`);const m=await fc(Oi(Bn,"badges",d,"badgeList"));console.log(`Found ${m.size} badge definitions for ${d}`);const v={};for(const S of m.docs)v[S.id]={...S.data(),id:S.id},console.log("Loaded badge definition:",S.id,S.data());const b=p.badgeIds.filter(S=>{const L=v[S];return L||console.warn(`Badge ${S} not found in available badges for ${d}`),L}).map(S=>{var L,V,B;return{id:S,name:((L=v[S])==null?void 0:L.name)||"Unknown Badge",description:((V=v[S])==null?void 0:V.description)||"No description available",iconUrl:((B=v[S])==null?void 0:B.iconUrl)||Ac}});b.length>0&&(u[d]=b,console.log(`Added ${b.length} badges for ${d}`))}catch(m){console.error(`Error fetching badges for game ${d}:`,m)}else console.log(`No badges found for game ${d}`)}console.log("Final badges object:",u),e.value=u}catch(c){console.error("Error fetching user badges:",c)}finally{t.value=!1}};Mn(()=>{qi(pn,o=>{o?(console.log("User authenticated:",o.uid),r(o.uid)):(console.log("No user authenticated"),t.value=!1)})});const i=o=>{console.warn("Image failed to load:",o.target.src),o.target.src=Ac};return(o,a)=>(J(),Z("section",$L,[a[1]||(a[1]=C("h1",{class:"text-4xl font-bold text-center mb-4"},"BADGES",-1)),a[2]||(a[2]=C("div",{class:"h-1 w-37 bg-white mx-auto mb-10 rounded-full"},null,-1)),t.value?(J(),Z("div",jL,"Loading badges...")):Object.keys(e.value).length===0?(J(),Z("div",HL," No badges earned yet. Start playing games to collect badges! ")):(J(),Z("div",GL,[(J(!0),Z(ft,null,kn(e.value,(c,u)=>(J(),Z("div",{key:u,class:"mb-8"},[C("h2",WL,ye(u)+" ("+ye(c.length)+")",1),C("div",qL,[(J(!0),Z(ft,null,kn(c,h=>(J(),Z("div",{key:h.id,class:"bg-gray-800 rounded-xl flex flex-col items-center justify-center p-4 hover:bg-gray-700 transition-colors cursor-pointer",title:h.description},[C("img",{src:h.iconUrl,alt:h.name,class:"w-16 h-16 object-contain mb-2 unselectable",draggable:"false",onError:i},null,40,KL),C("p",QL,ye(h.name),1),C("p",YL,ye(h.description),1)],8,zL))),128))])]))),128))])),s.value?(J(),Z("div",JL,[a[0]||(a[0]=C("h3",{class:"text-lg mb-2"},"Debug Info:",-1)),C("pre",XL,ye(JSON.stringify(e.value,null,2)),1)])):Be("",!0)]))}},eV=Jt(ZL,[["__scopeId","data-v-7424eedc"]]),tV={class:"pt-28 pb-20 pl-20 pr-6 md:pl-32 md:pr-12 text-white font-sci-fi"},nV={key:0,class:"text-gray-300 text-2xl"},sV={key:1,class:"text-gray-400 text-xl text-center"},rV={key:2,class:"space-y-8"},iV={key:0},oV={class:"list-disc list-inside space-y-1"},aV={key:0},lV={key:1},cV={key:2},uV={key:1},hV={key:2},dV={class:"list-disc list-inside space-y-1"},fV={key:0},pV={key:1},gV={key:3},mV={class:"list-disc list-inside space-y-1"},_V={key:0},yV={key:1},vV={key:2},EV={key:4},wV={class:"list-disc list-inside space-y-1"},TV={key:0},IV={key:1},bV={key:2},CV={__name:"Records",setup(n){const e=ie({}),t=ie(!0);return Mn(async()=>{const r=Wr().currentUser;if(!r)return;const i=gp(),o=LT(i,`records/${r.uid}`),a=await VT(o);a.exists()&&(e.value=a.val()),t.value=!1}),(s,r)=>(J(),Z("section",tV,[r[5]||(r[5]=C("h1",{class:"text-4xl font-bold text-center mb-4"},"RECORDS",-1)),r[6]||(r[6]=C("div",{class:"h-1 w-43 bg-white mx-auto mb-10 rounded-full"},null,-1)),t.value?(J(),Z("div",nV,"Loading...")):Object.keys(e.value).length===0?(J(),Z("div",sV," No records yet. Start playing games! ")):(J(),Z("div",rV,[e.value.minesweeper?(J(),Z("div",iV,[r[0]||(r[0]=C("h2",{class:"text-2xl text-orange-500 mb-2"},"Minesweeper",-1)),C("ul",oV,[e.value.minesweeper.easy?(J(),Z("li",aV,"Easy: "+ye(e.value.minesweeper.easy)+"s",1)):Be("",!0),e.value.minesweeper.medium?(J(),Z("li",lV,"Medium: "+ye(e.value.minesweeper.medium)+"s",1)):Be("",!0),e.value.minesweeper.hard?(J(),Z("li",cV,"Hard: "+ye(e.value.minesweeper.hard)+"s",1)):Be("",!0)])])):Be("",!0),e.value.candycrush?(J(),Z("div",uV,[r[1]||(r[1]=C("h2",{class:"text-2xl text-orange-500 mb-2"},"Candy Crush",-1)),C("p",null,"Best Score: "+ye(e.value.candycrush),1)])):Be("",!0),e.value.tetris?(J(),Z("div",hV,[r[2]||(r[2]=C("h2",{class:"text-2xl text-orange-500 mb-2"},"Tetris",-1)),C("ul",dV,[e.value.tetris.easy?(J(),Z("li",fV,"Easy: "+ye(e.value.tetris.easy),1)):Be("",!0),e.value.tetris.hard?(J(),Z("li",pV,"Hard: "+ye(e.value.tetris.hard),1)):Be("",!0)])])):Be("",!0),e.value.snake?(J(),Z("div",gV,[r[3]||(r[3]=C("h2",{class:"text-2xl text-orange-500 mb-2"},"Snake",-1)),C("ul",mV,[e.value.snake.easy?(J(),Z("li",_V,"Easy: "+ye(e.value.snake.easy),1)):Be("",!0),e.value.snake.medium?(J(),Z("li",yV,"Medium: "+ye(e.value.snake.medium),1)):Be("",!0),e.value.snake.hard?(J(),Z("li",vV,"Hard: "+ye(e.value.snake.hard),1)):Be("",!0)])])):Be("",!0),e.value.spaceshooter?(J(),Z("div",EV,[r[4]||(r[4]=C("h2",{class:"text-2xl text-orange-500 mb-2"},"Space Shooter",-1)),C("ul",wV,[e.value.spaceshooter.easy?(J(),Z("li",TV,"Easy: "+ye(e.value.spaceshooter.easy),1)):Be("",!0),e.value.spaceshooter.medium?(J(),Z("li",IV,"Medium: "+ye(e.value.spaceshooter.medium),1)):Be("",!0),e.value.spaceshooter.hard?(J(),Z("li",bV,"Hard: "+ye(e.value.spaceshooter.hard),1)):Be("",!0)])])):Be("",!0)]))]))}},AV={class:"pt-20 pb-32 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 2xl:px-32 text-white font-sci-fi"},SV={key:0,class:"text-center py-8 sm:py-12 md:py-16"},RV={key:1,class:"mb-16 space-y-4 sm:space-y-6 md:space-y-8"},xV={class:"flex items-start space-x-3 sm:space-x-4"},PV={class:"flex-1 min-w-0"},kV={class:"flex items-start justify-between mb-2"},NV={class:"flex-1 min-w-0"},DV={class:"text-orange-500 font-bold text-sm sm:text-base truncate"},OV={class:"text-gray-400 text-xs sm:text-sm"},MV=["onClick"],LV={class:"text-white mb-3 sm:mb-4 text-sm sm:text-base break-words"},VV={class:"mt-3 sm:mt-4 border-t border-gray-700 pt-3 sm:pt-4"},FV={key:0,class:"space-y-3 sm:space-y-4 mb-3 sm:mb-4"},UV={class:"flex items-start space-x-2 sm:space-x-3"},BV={class:"flex-1 min-w-0"},$V={class:"flex items-center justify-between mb-1"},jV={class:"text-orange-400 text-xs sm:text-sm font-medium truncate"},HV={class:"text-gray-400 text-xs ml-2 flex-shrink-0"},GV={class:"text-gray-200 text-xs sm:text-sm break-words"},WV={class:"flex items-stretch mt-3"},qV=["onUpdate:modelValue","onKeyup"],zV=["onClick"],KV={class:"fixed bottom-0 left-0 right-0 bg-gray-900 bg-opacity-95 backdrop-blur-sm border-t border-gray-700 z-50"},QV={class:"p-3 sm:p-4 pb-safe"},YV={class:"max-w-6xl mx-auto"},JV={__name:"Forum",setup(n){const e=ie([]),t=ie(""),s=ie(null);let r=null,i=null;const o=d=>{if(!d)return"";try{const p=d.toDate(),m=window.innerWidth<640;return p.toLocaleString("en-US",{month:"short",day:"numeric",year:m?"2-digit":"numeric",hour:"2-digit",minute:"2-digit",hour12:!0})}catch{return"Recent"}},a=(d,p="error")=>{const m=document.createElement("div");m.className=`fixed top-5 left-1/2 transform -translate-x-1/2 px-4 sm:px-6 py-2 sm:py-3 rounded-md shadow-lg z-50 ${p==="error"?"bg-red-600":"bg-green-600"} text-white font-sci-fi animate-fade-in text-center text-sm sm:text-base max-w-[90vw] sm:max-w-[400px]`,m.textContent=d,document.body.appendChild(m),setTimeout(()=>{m.classList.replace("animate-fade-in","animate-fade-out"),setTimeout(()=>m.remove(),300)},3e3)};Mn(()=>{r=qi(pn,p=>{s.value=p});const d=Fk(Oi(Bn,"forum"));i=Gk(d,p=>{e.value=p.docs.map(m=>{const v=m.data();return{id:m.id,...v,timestamp:v.timestamp||null,comments:v.comments||[],newComment:""}}).sort((m,v)=>!m.timestamp&&!v.timestamp?0:m.timestamp?v.timestamp?m.timestamp.toDate()-v.timestamp.toDate():1:-1)},p=>{console.error("Firestore error:",p)})}),Mc(()=>{r&&r(),i&&i()});const c=async()=>{if(!t.value.trim()){a("Post cannot be empty!");return}if(!s.value){a("Please sign in to post!");return}try{await Hk(Oi(Bn,"forum"),{content:t.value,author:s.value.displayName||"Anonymous",userId:s.value.uid,timestamp:Wk(),comments:[]}),t.value=""}catch(d){console.error("Error adding post:",d),a("Failed to create post")}},u=async d=>{if(!d.newComment.trim()){a("Comment cannot be empty!");return}if(!s.value){a("Please sign in to comment!");return}try{const p={content:d.newComment,author:s.value.displayName||"Anonymous",userId:s.value.uid,timestamp:new Date,id:Date.now().toString()};await $k(ha(Bn,"forum",d.id),{comments:qk(p)}),d.newComment=""}catch(p){console.error("Error adding comment:",p),a("Failed to add comment")}},h=async d=>{if(!s.value){a("Please sign in to delete posts");return}if(confirm("Are you sure you want to delete this post?"))try{await jk(ha(Bn,"forum",d)),a("Post deleted","success")}catch(p){console.error("Error deleting post:",p),a("Failed to delete post")}};return(d,p)=>(J(),Z("section",AV,[p[8]||(p[8]=C("h1",{class:"text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4"},"FORUM",-1)),p[9]||(p[9]=C("div",{class:"h-1 w-24 sm:w-32 md:w-36 bg-white mx-auto mb-6 sm:mb-8 md:mb-10 rounded-full"},null,-1)),e.value.length===0?(J(),Z("div",SV,p[1]||(p[1]=[C("div",{class:"text-orange-500 text-3xl sm:text-4xl md:text-5xl mb-4"},[C("span",{class:"material-symbols-outlined"},"forum")],-1),C("h3",{class:"text-lg sm:text-xl md:text-2xl font-bold mb-2"},"No Posts Yet",-1),C("p",{class:"text-gray-400 max-w-md mx-auto text-sm sm:text-base px-4"},"Be the first to share your thoughts!",-1)]))):(J(),Z("div",RV,[(J(!0),Z(ft,null,kn(e.value,m=>{var v;return J(),Z("div",{key:m.id,class:"bg-gray-800 bg-opacity-50 rounded-lg p-4 sm:p-5 md:p-6 shadow-lg"},[C("div",xV,[p[5]||(p[5]=C("div",{class:"w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-orange-500 flex items-center justify-center flex-shrink-0"},[C("span",{class:"material-symbols-outlined text-orange-500 text-lg sm:text-xl unselectable"},"person")],-1)),C("div",PV,[C("div",kV,[C("div",NV,[C("p",DV,ye(m.author),1),C("p",OV,ye(o(m.timestamp)),1)]),((v=s.value)==null?void 0:v.uid)===m.userId?(J(),Z("button",{key:0,onClick:b=>h(m.id),class:"text-gray-400 hover:text-orange-500 transition ml-2 flex-shrink-0"},p[2]||(p[2]=[C("span",{class:"material-symbols-outlined text-lg sm:text-xl"},"delete",-1)]),8,MV)):Be("",!0)]),C("p",LV,ye(m.content),1),C("div",VV,[m.comments&&m.comments.length>0?(J(),Z("div",FV,[(J(!0),Z(ft,null,kn(m.comments,b=>(J(),Z("div",{key:b.id,class:"bg-gray-700 bg-opacity-50 rounded-lg p-2 sm:p-3"},[C("div",UV,[p[3]||(p[3]=C("div",{class:"w-6 h-6 sm:w-8 sm:h-8 rounded-full border border-orange-500 flex items-center justify-center flex-shrink-0"},[C("span",{class:"material-symbols-outlined text-orange-500 text-xs sm:text-sm unselectable"},"person")],-1)),C("div",BV,[C("div",$V,[C("p",jV,ye(b.author),1),C("p",HV,ye(o(b.timestamp)),1)]),C("p",GV,ye(b.content),1)])])]))),128))])):Be("",!0),C("div",WV,[vn(C("input",{"onUpdate:modelValue":b=>m.newComment=b,placeholder:"Write a comment...",onKeyup:BC(b=>u(m),["enter"]),class:"flex-1 bg-gray-700 text-white px-3 sm:px-4 py-2 rounded-l focus:outline-none focus:ring-1 focus:ring-orange-500 text-xs sm:text-sm min-w-0"},null,40,qV),[[Hn,m.newComment]]),C("button",{onClick:b=>u(m),class:"bg-orange-500 hover:bg-orange-600 px-3 sm:px-4 py-2 rounded-r transition text-xs sm:text-sm font-medium whitespace-nowrap"},p[4]||(p[4]=[C("span",{class:"hidden sm:inline"},"Comment",-1),C("span",{class:"sm:hidden"},"💬",-1)]),8,zV)])])])])])}),128))])),C("div",KV,[C("div",QV,[C("div",YV,[C("form",{onSubmit:Uc(c,["prevent"]),class:"flex items-stretch space-x-2 sm:space-x-4"},[p[6]||(p[6]=C("div",{class:"w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full border-2 border-orange-500 flex items-center justify-center flex-shrink-0"},[C("span",{class:"material-symbols-outlined text-orange-500 text-sm sm:text-lg md:text-xl unselectable"},"person")],-1)),vn(C("input",{"onUpdate:modelValue":p[0]||(p[0]=m=>t.value=m),placeholder:"What's on your mind?",required:"",class:"flex-1 bg-gray-700 text-white px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-l focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm sm:text-base min-w-0"},null,512),[[Hn,t.value]]),p[7]||(p[7]=C("button",{type:"submit",class:"bg-orange-500 hover:bg-orange-600 px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-r transition font-bold text-sm sm:text-base whitespace-nowrap"},[C("span",{class:"hidden sm:inline"},"POST"),C("span",{class:"sm:hidden"},"📝")],-1))],32)])])])]))}},XV=Jt(JV,[["__scopeId","data-v-047d6527"]]);async function yn(n,e,t){try{if(!n||!e||!t)return console.warn("Missing required parameters for giveBadge:",{uid:n,gameId:e,badgeId:t}),!1;console.log(`Attempting to give badge: ${t} to user: ${n} for game: ${e}`);const s=ha(Bn,"badges",e,"badgeList",t);if(!(await E_(s)).exists()){console.warn(`Badge ${t} does not exist in game ${e}. Creating badge definition...`);const c={first_blood:{name:"First Blood",description:"Complete your first game",iconUrl:"/src/assets/Games/Badge.png"},speedrunner_easy:{name:"Speed Demon",description:"Complete Easy in under 30 seconds",iconUrl:"/src/assets/Games/Badge.png"},fasthead:{name:"Fast Head",description:"Complete Medium in under 60 seconds",iconUrl:"/src/assets/Games/Badge.png"},speedrunner_hard:{name:"Lightning Fast",description:"Complete Hard in under 120 seconds",iconUrl:"/src/assets/Games/Badge.png"},survivor:{name:"Survivor",description:"Complete Hard difficulty",iconUrl:"/src/assets/Games/Badge.png"},flawless_victory:{name:"Flawless Victory",description:"Win without using flags",iconUrl:"/src/assets/Games/Badge.png"},perfectionist:{name:"Perfectionist",description:"Win 5 games without using flags",iconUrl:"/src/assets/Games/Badge.png"},veteran_player:{name:"Veteran Player",description:"Win 10 games",iconUrl:"/src/assets/Games/Badge.png"},space_first_blood:{name:"Space Pilot",description:"Complete your first space mission",iconUrl:"/src/assets/Games/Badge.png"},space_score_1000_easy:{name:"Rookie Scorer",description:"Score 1000 points on Easy difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_1000_medium:{name:"Cadet Scorer",description:"Score 1000 points on Medium difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_1000_hard:{name:"Veteran Scorer",description:"Score 1000 points on Hard difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_3000_easy:{name:"Elite Pilot",description:"Score 3000 points on Easy difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_3000_medium:{name:"Ace Pilot",description:"Score 3000 points on Medium difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_3000_hard:{name:"Commander",description:"Score 3000 points on Hard difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_5000_easy:{name:"Space Legend",description:"Score 5000 points on Easy difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_5000_medium:{name:"Galaxy Hero",description:"Score 5000 points on Medium difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_score_5000_hard:{name:"Universe Master",description:"Score 5000 points on Hard difficulty",iconUrl:"/src/assets/Games/Badge.png"},space_enemies_100:{name:"Squadron Destroyer",description:"Destroy 100 enemies in a single game",iconUrl:"/src/assets/Games/Badge.png"},space_enemies_300:{name:"Fleet Annihilator",description:"Destroy 300 enemies in a single game",iconUrl:"/src/assets/Games/Badge.png"}};if(c[t])await w_(s,c[t]),console.log(`Created badge definition for: ${t}`);else return console.error(`No definition found for badge: ${t}`),!1}const i=ha(Bn,"users",n,"badges",e),o=await E_(i);let a=[];if(o.exists()){if(a=o.data().badgeIds||[],a.includes(t))return console.log(`User ${n} already has badge ${t}`),!1}else console.log(`Creating new badge document for user ${n} and game ${e}`);return a.push(t),await w_(i,{badgeIds:a,lastUpdated:new Date().toISOString()},{merge:!0}),console.log(`Badge '${t}' successfully awarded to user ${n}`),!0}catch(s){return console.error("Error awarding badge:",s),!1}}const ZV="modulepreload",e4=function(n){return"/TapNPlayHost/"+n},Ey={},t4=function(e,t,s){let r=Promise.resolve();if(t&&t.length>0){let o=function(u){return Promise.all(u.map(h=>Promise.resolve(h).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),c=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=o(t.map(u=>{if(u=e4(u),u in Ey)return;Ey[u]=!0;const h=u.endsWith(".css"),d=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${d}`))return;const p=document.createElement("link");if(p.rel=h?"stylesheet":ZV,h||(p.as="script"),p.crossOrigin="",p.href=u,c&&p.setAttribute("nonce",c),document.head.appendChild(p),h)return new Promise((m,v)=>{p.addEventListener("load",m),p.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${u}`)))})}))}function i(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return r.then(o=>{for(const a of o||[])a.status==="rejected"&&i(a.reason);return e().catch(i)})};async function ja(n,e,t=null,s=!0){const{getAuth:r}=await t4(async()=>{const{getAuth:m}=await Promise.resolve().then(()=>xx);return{getAuth:m}},void 0),o=r().currentUser;if(!o)return;const a=gp(),c=t?`records/${o.uid}/${n}/${t}`:`records/${o.uid}/${n}`,u=LT(a,c),d=(await VT(u)).val();(!d||(s?e>d:e<d))&&await qO(u,e)}const $s={FIRST_GAME:"first_blood",SPEEDRUNNER_EASY:"speedrunner_easy",SPEEDRUNNER_MEDIUM:"fasthead",SPEEDRUNNER_HARD:"speedrunner_hard",HARDCORE:"survivor",FLAWLESS:"flawless_victory",PERFECTIONIST:"perfectionist",VETERAN:"veteran_player"},_n={FIRST_GAME:"space_first_blood",SCORE_1000_EASY:"space_score_1000_easy",SCORE_1000_MEDIUM:"space_score_1000_medium",SCORE_1000_HARD:"space_score_1000_hard",SCORE_3000_EASY:"space_score_3000_easy",SCORE_3000_MEDIUM:"space_score_3000_medium",SCORE_3000_HARD:"space_score_3000_hard",SCORE_5000_EASY:"space_score_5000_easy",SCORE_5000_MEDIUM:"space_score_5000_medium",SCORE_5000_HARD:"space_score_5000_hard",ENEMIES_100:"space_enemies_100",ENEMIES_300:"space_enemies_300"},n4={class:"flex h-screen bg-gradient-to-t from-gray-900 to-indigo-950 text-white font-sci-fi overflow-hidden"},s4={class:"flex flex-col justify-center items-center flex-grow p-4"},r4={class:"text-lg mb-1"},i4={class:"text-lg mb-4"},o4=["onClick","onContextmenu"],a4={key:0},l4={key:1},c4={class:"text-red-500 font-bold mt-4"},u4={key:0,class:"mt-4 space-y-2"},h4={class:"w-full md:w-1/3 p-6 flex flex-col justify-center space-y-6 border-l border-white/10"},d4={class:"bg-white/10 rounded-lg p-4 space-y-2"},f4={class:"text-sm"},p4={class:"text-sm"},g4={class:"flex gap-2"},m4=["disabled"],_4=["disabled"],y4=["disabled"],v4={class:"flex gap-4"},_l=40,wy=3,E4={__name:"Minesweeper",setup(n){const e=Os(),t=ie(0),s=ie(null),r=ie([]),i=ie({gamesPlayed:0,gamesWon:0,bestTimes:{easy:null,medium:null,hard:null},firstGameCompleted:!1,perfectGames:0,consecutiveWins:0}),o={easy:{rows:9,cols:9,mines:9},medium:{rows:9,cols:18,mines:20},hard:{rows:11,cols:19,mines:40}},a=ie(o.medium),c=ie([]),u=ie(!0),h=ie(!0),d=ie(!1),p=ie(""),m=ie("New Game"),v=ie(!1),b=pt(()=>{const x=Math.floor(t.value/60),O=t.value%60;return`${String(x).padStart(2,"0")}:${String(O).padStart(2,"0")}`}),S=pt(()=>{const x=a.value;for(const[O,Q]of Object.entries(o))if(Q.rows===x.rows&&Q.cols===x.cols&&Q.mines===x.mines)return O;return"custom"});class L{constructor(O,Q){this.x=O,this.y=Q,this.isClicked=!1,this.isFlagged=!1,this.isMine=!1,this.isExplodedMine=!1,this.numNeighborMines=0}}function V(){const x=[];for(let O=0;O<a.value.rows;O++){x[O]=[];for(let Q=0;Q<a.value.cols;Q++)x[O][Q]=new L(O,Q)}c.value=x}function B(x,O){const Q=new Set;for(let he=-1;he<=1;he++)for(let M=-1;M<=1;M++){const Y=x+he,F=O+M;Y>=0&&Y<a.value.rows&&F>=0&&F<a.value.cols&&Q.add(`${Y},${F}`)}let ce=0;for(;ce<a.value.mines;){let he=Math.floor(Math.random()*a.value.rows),M=Math.floor(Math.random()*a.value.cols);!c.value[he][M].isMine&&!Q.has(`${he},${M}`)&&(c.value[he][M].isMine=!0,ce++)}}function j(){for(let x=0;x<a.value.rows;x++)for(let O=0;O<a.value.cols;O++)if(!c.value[x][O].isMine){let Q=0;for(let ce=-1;ce<=1;ce++)for(let he=-1;he<=1;he++){const M=x+ce,Y=O+he;M>=0&&M<a.value.rows&&Y>=0&&Y<a.value.cols&&c.value[M][Y].isMine&&Q++}c.value[x][O].numNeighborMines=Q}}function fe(){switch(a.value.mines){case 9:return"easy";case 20:return"medium";case 40:return"hard";default:return"custom"}}function ue(x,O){if(!(!u.value||c.value[x][O].isFlagged)){if(m.value="Restart",h.value){V();do B(x,O);while(c.value[x][O].isMine&&!d.value);j(),Ye(),h.value=!1,v.value=!1}if(E(x,O),c.value[x][O].isMine)c.value[x][O].isExplodedMine=!0,R(),p.value="You've lost!",_e(),u.value=!1,i.value.gamesPlayed++,i.value.consecutiveWins=0,ve();else if(P()){p.value="Congrats! You've won!",_e(),u.value=!1,i.value.gamesPlayed++,i.value.gamesWon++,i.value.consecutiveWins++;const Q=fe(),ce=t.value;(!i.value.bestTimes[Q]||ce<i.value.bestTimes[Q])&&(i.value.bestTimes[Q]=ce),v.value||i.value.perfectGames++,ve();const M=Wr().currentUser;M&&(A(M.uid,Q,t.value,!v.value),ja("minesweeper",ce,Q,!1))}}}async function A(x,O,Q,ce){try{const he=[];i.value.firstGameCompleted||await yn(x,"minesweeper",$s.FIRST_GAME)&&(he.push({name:"First Blood",description:"Complete your first game"}),i.value.firstGameCompleted=!0),O==="easy"&&Q<=30&&await yn(x,"minesweeper",$s.SPEEDRUNNER_EASY)&&he.push({name:"Speed Demon",description:"Complete Easy in under 30 seconds"}),O==="medium"&&Q<=60&&await yn(x,"minesweeper",$s.SPEEDRUNNER_MEDIUM)&&he.push({name:"Fast Head",description:"Complete Medium in under 60 seconds"}),O==="hard"&&Q<=120&&await yn(x,"minesweeper",$s.SPEEDRUNNER_HARD)&&he.push({name:"Lightning Fast",description:"Complete Hard in under 120 seconds"}),O==="hard"&&await yn(x,"minesweeper",$s.HARDCORE)&&he.push({name:"Survivor",description:"Complete Hard difficulty"}),ce&&await yn(x,"minesweeper",$s.FLAWLESS)&&he.push({name:"Flawless Victory",description:"Win without using flags"}),i.value.perfectGames>=5&&await yn(x,"minesweeper",$s.PERFECTIONIST)&&he.push({name:"Perfectionist",description:"Win 5 games without using flags"}),i.value.gamesWon>=10&&await yn(x,"minesweeper",$s.VETERAN)&&he.push({name:"Veteran Player",description:"Win 10 games"}),he.length>0&&(r.value=he,setTimeout(()=>{r.value=[]},5e3))}catch(he){console.error("Badge check failed:",he)}}function E(x,O){const Q=c.value[x][O];if(!(Q.isClicked||Q.isFlagged)&&(Q.isClicked=!0,Q.isFlagged=!1,Q.numNeighborMines===0&&!Q.isMine))for(let ce=-1;ce<=1;ce++)for(let he=-1;he<=1;he++){const M=x+ce,Y=O+he;M>=0&&M<a.value.rows&&Y>=0&&Y<a.value.cols&&E(M,Y)}}function I(x,O){if(!u.value)return;const Q=c.value[x][O];Q.isClicked||(Q.isFlagged=!Q.isFlagged,v.value=!0)}function R(){c.value.flat().forEach(x=>{x.isMine&&(x.isClicked=!0)})}function P(){return c.value.flat().every(x=>x.isMine||x.isClicked)}function N(){_e(),p.value="",u.value=!0,h.value=!0,v.value=!1,r.value=[],V()}function T(x){a.value=o[x],N()}function Ye(){t.value=0,s.value=setInterval(()=>t.value++,1e3)}function _e(){clearInterval(s.value),s.value=null,m.value="New Game"}function pe(){e.push("/games")}function ve(){typeof window<"u"&&localStorage.setItem("minesweeper_stats",JSON.stringify(i.value))}function Te(){const x=localStorage.getItem("minesweeper_stats");x&&(i.value={...i.value,...JSON.parse(x)})}const ot=pt(()=>c.value.flat());function rt(x){return x.isExplodedMine?"bg-red-600":x.isMine&&x.isClicked?"bg-black":x.isClicked?"bg-yellow-300":x.isFlagged?"bg-red-500":"bg-green-500"}const it=pt(()=>c.value.flat().filter(x=>x.isFlagged).length);return Mn(()=>{Te(),V()}),(x,O)=>(J(),Z("section",n4,[C("div",s4,[C("p",r4,"Timer: "+ye(b.value),1),C("p",i4,"Flags: "+ye(it.value)+"/"+ye(a.value.mines),1),C("div",{class:"rounded-2xl p-2",style:Yo({width:`${a.value.cols*_l+(a.value.cols-1)+wy*a.value.cols}px`,height:`${a.value.rows*_l+(a.value.rows-1)+wy*a.value.rows}px`})},[C("div",{id:"board",class:"grid gap-[3px]",style:Yo({gridTemplateColumns:`repeat(${a.value.cols}, ${_l}px)`,gridTemplateRows:`repeat(${a.value.rows}, ${_l}px)`})},[(J(!0),Z(ft,null,kn(ot.value,(Q,ce)=>(J(),Z("div",{key:ce,class:ut(["tile",Q.isClicked?"revealed":"",Q.isFlagged?"flagged":"",rt(Q)]),onClick:he=>ue(Q.x,Q.y),onContextmenu:Uc(he=>I(Q.x,Q.y),["prevent"])},[Q.isClicked&&!Q.isMine&&Q.numNeighborMines>0?(J(),Z("span",a4,ye(Q.numNeighborMines),1)):Be("",!0),Q.isClicked&&Q.isMine?(J(),Z("span",l4,ye(Q.isExplodedMine?"💥":"💣"),1)):Be("",!0)],42,o4))),128))],4)],4),C("p",c4,ye(p.value),1),r.value.length>0?(J(),Z("div",u4,[(J(!0),Z(ft,null,kn(r.value,(Q,ce)=>(J(),Z("div",{key:ce,class:"bg-yellow-600 text-black px-4 py-2 rounded-lg animate-pulse"}," 🏆 Achievement Unlocked: "+ye(Q.name)+"! ",1))),128))])):Be("",!0)]),C("div",h4,[O[4]||(O[4]=C("h2",{class:"text-3xl font-bold"},"Minesweeper",-1)),O[5]||(O[5]=C("p",{class:"text-sm"},[ht("By: "),C("span",{class:"text-orange-400"},"Denys Novosad")],-1)),C("div",d4,[O[3]||(O[3]=C("h3",{class:"text-lg font-bold"},"Game Stats",-1)),C("p",f4,"Games Played: "+ye(i.value.gamesPlayed),1),C("p",p4,"Games Won: "+ye(i.value.gamesWon),1)]),C("div",g4,[C("button",{onClick:O[0]||(O[0]=Q=>T("easy")),disabled:u.value&&!h.value,class:ut(["px-4 py-2 rounded-full transition",u.value&&!h.value?"bg-gray-500 cursor-not-allowed":"bg-blue-600 hover:bg-blue-700 cursor-pointer",S.value==="easy"?"ring-2 ring-white":""])}," Easy ",10,m4),C("button",{onClick:O[1]||(O[1]=Q=>T("medium")),disabled:u.value&&!h.value,class:ut(["px-4 py-2 rounded-full transition",u.value&&!h.value?"bg-gray-500 cursor-not-allowed":"bg-yellow-600 hover:bg-yellow-700 cursor-pointer",S.value==="medium"?"ring-2 ring-white":""])}," Medium ",10,_4),C("button",{onClick:O[2]||(O[2]=Q=>T("hard")),disabled:u.value&&!h.value,class:ut(["px-4 py-2 rounded-full transition",u.value&&!h.value?"bg-gray-500 cursor-not-allowed":"bg-red-600 hover:bg-red-700 cursor-pointer",S.value==="hard"?"ring-2 ring-white":""])}," Hard ",10,y4)]),C("div",v4,[C("button",{onClick:N,class:"flex-1 px-4 py-2 rounded-full bg-green-500 hover:bg-green-600 transition cursor-pointer"},ye(m.value),1),C("button",{onClick:pe,class:"flex-1 px-4 py-2 rounded-full bg-red-500 hover:bg-red-800 transition cursor-pointer"}," Close ")])])]))}},w4=Jt(E4,[["__scopeId","data-v-3d606732"]]),T4="/TapNPlayHost/assets/Blue-DAQCwj7p.png",I4="/TapNPlayHost/assets/Green-B1bMTXw4.png",b4="/TapNPlayHost/assets/Orange-Bw5FlbpH.png",C4="/TapNPlayHost/assets/Purple-Ds0YvxNa.png",A4="/TapNPlayHost/assets/Red-BxOBnYU3.png",S4="/TapNPlayHost/assets/Yellow-CGAwsJXF.png",R4="/TapNPlayHost/assets/blank-CZqJ0ugE.png",x4={class:"flex h-screen bg-gradient-to-t from-gray-900 to-indigo-950 text-white font-sci-fi overflow-hidden"},P4={class:"flex flex-col justify-center items-center flex-grow p-4"},k4={class:"text-lg mb-1"},To=9,Io=9,N4={__name:"CandyCrush",setup(n){const e={Blue:T4,Green:I4,Orange:b4,Purple:C4,Red:A4,Yellow:S4,blank:R4},t=Os(),s=ie(0),r=["Blue","Orange","Green","Yellow","Red","Purple"];let i=[],o=null,a=null;function c(){return r[Math.floor(Math.random()*r.length)]}function u(){const b=document.getElementById("board");b.innerHTML="",i=[],s.value=0;for(let S=0;S<To;S++){const L=[];for(let V=0;V<Io;V++){const B=document.createElement("img");B.id=`${S}-${V}`,B.draggable=!0,B.classList.add("tile");let j;do j=c();while(V>1&&L[V-1].src.endsWith(`${j}.png`)&&L[V-2].src.endsWith(`${j}.png`)||S>1&&i[S-1][V].src.endsWith(`${j}.png`)&&i[S-2][V].src.endsWith(`${j}.png`));B.src=e[j],B.addEventListener("dragstart",()=>o=B),B.addEventListener("dragover",fe=>fe.preventDefault()),B.addEventListener("drop",()=>a=B),B.addEventListener("dragend",h),b.append(B),L.push(B)}i.push(L)}}function h(){if(!o||!a)return;const[b,S]=o.id.split("-").map(Number),[L,V]=a.id.split("-").map(Number);if(Math.abs(b-L)+Math.abs(S-V)!==1)return;const B=(V-S)*41,j=(L-b)*41;o.style.transition="transform 0.3s ease",a.style.transition="transform 0.3s ease",o.style.transform=`translate(${B}px, ${j}px)`,a.style.transform=`translate(${-B}px, ${-j}px)`;const fe=()=>{o.style.transition="",a.style.transition="",o.style.transform="",a.style.transform="";const ue=o.src;o.src=a.src,a.src=ue,o.removeEventListener("transitionend",fe),o=a=null};o.addEventListener("transitionend",fe)}function d(){for(let b=0;b<To;b++)for(let S=0;S<Io-2;S++){const[L,V,B]=[i[b][S],i[b][S+1],i[b][S+2]];L.src===V.src&&V.src===B.src&&!L.src.includes("blank")&&([L,V,B].forEach(j=>{j.classList.add("vanish"),setTimeout(()=>{j.src=e.blank,j.classList.remove("vanish")},300)}),s.value+=30)}for(let b=0;b<Io;b++)for(let S=0;S<To-2;S++){const[L,V,B]=[i[S][b],i[S+1][b],i[S+2][b]];L.src===V.src&&V.src===B.src&&!L.src.includes("blank")&&([L,V,B].forEach(j=>{j.classList.add("vanish"),setTimeout(()=>{j.src=e.blank,j.classList.remove("vanish")},300)}),s.value+=30)}}function p(){for(let b=0;b<Io;b++){let S=To-1;for(let L=To-1;L>=0;L--)i[L][b].src.includes("blank")||(i[S][b].src=i[L][b].src,S--);for(let L=S;L>=0;L--)i[L][b].src=e.blank}}function m(){for(let b=0;b<Io;b++)i[0][b].src.includes("blank")&&(i[0][b].src=e[c()])}function v(){ja("candycrush",s.value,null,!0),t.push("/games")}return Mn(()=>{u(),setInterval(()=>{d(),p(),m()},100)}),(b,S)=>(J(),Z("section",x4,[C("div",P4,[C("p",k4,"Score: "+ye(s.value),1),S[0]||(S[0]=C("div",{class:"rounded-2xl bg-gray-800 p-2",style:{width:"380px",height:"450px"}},[C("div",{id:"board",class:"grid grid-cols-9 gap-[2px]",style:{width:"360px",height:"360px",margin:"0 auto"}})],-1))]),C("div",{class:"w-full md:w-1/3 p-6 flex flex-col justify-center space-y-6 border-l border-white/10"},[S[1]||(S[1]=C("h2",{class:"text-3xl font-bold"},"Candy Crush",-1)),S[2]||(S[2]=C("p",{class:"text-sm"},[ht("By: "),C("span",{class:"text-orange-400"},"Oleksii Malanii")],-1)),C("div",{class:"flex gap-4"},[C("button",{onClick:v,class:"flex-1 px-4 py-2 rounded-full bg-green-500 hover:bg-green-600 transition"}," Save and Exit ")])])]))}},D4=Jt(N4,[["__scopeId","data-v-9c647cc7"]]),O4={class:"flex h-screen font-sci-fi text-white"},M4={class:"flex flex-col items-center justify-center flex-1"},L4={class:"text-lg mb-1"},V4={class:"w-full md:w-1/3 p-6 flex flex-col justify-center space-y-6 border-l border-white/10"},F4={class:"flex gap-2"},U4=["disabled"],B4=["disabled"],$4={key:0,class:"bg-gray-700 rounded-lg p-4"},j4={class:"flex gap-4"},br=12,vh=20,ss=24,H4={__name:"Tetris",setup(n){const e=Os(),t=ie(null),s=ie(null),r=ie(null),i=ie(null),o=ie(0),a=ie(!1),c=ie(!1),u=ie(!1),h=ie("easy"),d={easy:{dropSpeed:300,showNext:!0},hard:{dropSpeed:150,showNext:!1}};let p=[],m=null,v=null,b=0,S=0,L=null;const V={1:"#00CED1",2:"#FFD700",3:"#9370DB",4:"#32CD32",5:"#FF6347",6:"#4169E1",7:"#FF8C00"},B={I:[[1,1,1,1]],O:[[2,2],[2,2]],T:[[0,3,0],[3,3,3]],S:[[0,4,4],[4,4,0]],Z:[[5,5,0],[0,5,5]],J:[[6,0,0],[6,6,6]],L:[[0,0,7],[7,7,7]]};Mn(()=>{r.value=t.value.getContext("2d"),j(),document.addEventListener("keydown",M)});function j(){s.value&&(i.value=s.value.getContext("2d"))}function fe(F,H){const oe=[];for(;H--;)oe.push(new Array(F).fill(0));return oe}function ue(){const F="IOTSZJL",H=F[Math.floor(Math.random()*F.length)],oe=B[H];return{pos:{x:Math.floor(br/2)-Math.ceil(oe[0].length/2),y:-oe.length+1},matrix:JSON.parse(JSON.stringify(oe)),type:H}}function A(F,H,oe=r.value,y=ss){F.forEach((w,k)=>{w.forEach(($,W)=>{const G=k+H.y;if($!==0&&G>=0){oe.fillStyle=V[$];const se=(W+H.x)*y,te=G*y;oe.beginPath(),oe.roundRect(se+1,te+1,y-2,y-2,4),oe.fill(),oe.strokeStyle="rgba(255, 255, 255, 0.3)",oe.lineWidth=1,oe.stroke()}})})}function E(){for(let F=0;F<vh;F++)for(let H=0;H<br;H++)r.value.fillStyle=(H+F)%2===0?"#2e2e2e":"#1f1f1f",r.value.fillRect(H*ss,F*ss,ss,ss)}function I(){E(),p.forEach((F,H)=>{F.forEach((oe,y)=>{if(oe!==0){r.value.fillStyle=c.value?"#666666":V[oe];const w=y*ss,k=H*ss;r.value.beginPath(),r.value.roundRect(w+1,k+1,ss-2,ss-2,4),r.value.fill(),r.value.strokeStyle="rgba(255, 255, 255, 0.3)",r.value.lineWidth=1,r.value.stroke()}})}),m&&A(m.matrix,m.pos)}function R(){if(!v||h.value!=="easy"||(!i.value&&s.value&&(i.value=s.value.getContext("2d")),!i.value))return;i.value.fillStyle="#1f1f1f",i.value.fillRect(0,0,96,96);const F=v.matrix[0].length,H=v.matrix.length,oe=Math.floor((4-F)/2),y=Math.floor((4-H)/2);A(v.matrix,{x:oe,y},i.value,24)}function P(F,H){H.matrix.forEach((oe,y)=>{oe.forEach((w,k)=>{w!==0&&y+H.pos.y>=0&&(F[y+H.pos.y][k+H.pos.x]=w)})})}function N(F,H){const{matrix:oe,pos:y}=H;for(let w=0;w<oe.length;++w)for(let k=0;k<oe[w].length;++k)if(oe[w][k]!==0){const $=w+y.y,W=k+y.x;if($<0||$>=vh||W<0||W>=br||$>=0&&F[$][W]!==0)return!0}return!1}function T(){if(m.pos.y++,N(p,m)){if(m.pos.y--,P(p,m),Ye()){rt();return}_e(),pe()}b=0}function Ye(){for(let F=0;F<br;F++)if(p[0][F]!==0)return c.value=!0,!0;return!1}function _e(){if(m=v||ue(),v=ue(),h.value==="easy"&&Zo(()=>{R()}),N(p,m)&&m.pos.y>=0){rt();return}}function pe(){let F=0;e:for(let H=p.length-1;H>=0;--H){for(let oe=0;oe<br;++oe)if(p[H][oe]===0)continue e;p.splice(H,1)[0],p.unshift(new Array(br).fill(0)),o.value+=10,F++,++H}F>0&&(u.value=!0,setTimeout(()=>u.value=!1,200))}function ve(F=0){const H=F-S;S=F,b+=H;const oe=d[h.value].dropSpeed;b>oe&&T(),I(),a.value&&(L=requestAnimationFrame(ve))}function Te(F){h.value=F,F==="easy"&&Zo(()=>{j(),v&&R()}),a.value&&(rt(),ot())}function ot(){o.value=0,c.value=!1,u.value=!1,p=fe(br,vh),v=ue(),_e(),b=0,S=0,a.value=!0,L=requestAnimationFrame(ve)}function rt(){x(),a.value=!1,L&&(cancelAnimationFrame(L),L=null)}function it(){a.value?rt():ot()}const x=()=>{Wr().currentUser&&ja("tetris",o.value,h.value,!0)};function O(F){m.pos.x+=F,N(p,m)&&(m.pos.x-=F)}function Q(F){const H=F.length,oe=new Array(F[0].length).fill(0).map(()=>new Array(H).fill(0));for(let y=0;y<H;y++)for(let w=0;w<F[y].length;w++)oe[w][H-1-y]=F[y][w];return oe}function ce(F){const H=F.length,oe=new Array(F[0].length).fill(0).map(()=>new Array(H).fill(0));for(let y=0;y<H;y++)for(let w=0;w<F[y].length;w++)oe[F[y].length-1-w][y]=F[y][w];return oe}function he(F=!0){const H=m.matrix;m.matrix=F?Q(m.matrix):ce(m.matrix),N(p,m)&&(m.matrix=H)}function M(F){!a.value||!m||e.currentRoute.value.path.includes("/games/tetris")&&(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","w","W","s","S","a","A","d","D","ц","Ц","і","І","ф","Ф","в","В","q","Q","e","E","й","Й","у","У"].includes(F.key)&&F.preventDefault(),["ArrowLeft","a","A","ф","Ф"].includes(F.key)&&O(-1),["ArrowRight","d","D","в","В"].includes(F.key)&&O(1),["ArrowDown","s","S","і","І"].includes(F.key)&&T(),["ArrowUp","w","W","ц","Ц"].includes(F.key)&&he(!0),["q","Q","й","Й"].includes(F.key)&&he(!1),["e","E","у","У"].includes(F.key)&&he(!0))}Mc(()=>{document.removeEventListener("keydown",M),L&&cancelAnimationFrame(L)});function Y(){rt(),e.push("/games")}return(F,H)=>(J(),Z("div",O4,[C("div",M4,[C("div",L4,"Score: "+ye(o.value),1),C("div",{class:ut(["rounded-2xl p-2 transition-all duration-200",c.value?"bg-red-600 shadow-[0_0_30px_#ff0000]":u.value?"bg-blue-600 shadow-[0_0_30px_#0000FF]":"bg-blue-800"]),style:{width:"310px",height:"495px"}},[C("canvas",{ref_key:"canvas",ref:t,width:"288",height:"480",class:"block mx-auto rounded-lg"},null,512)],2)]),C("div",V4,[H[3]||(H[3]=C("h2",{class:"text-3xl font-bold"},"Tetris",-1)),H[4]||(H[4]=C("p",{class:"text-sm"},[ht("By: "),C("span",{class:"text-orange-400"},"Andrii Kohut")],-1)),C("div",F4,[C("button",{onClick:H[0]||(H[0]=oe=>Te("easy")),disabled:a.value,class:ut(["px-4 py-2 rounded-full transition",a.value?"bg-gray-500 cursor-not-allowed":"bg-green-600 hover:bg-green-700 cursor-pointer",h.value==="easy"?"ring-2 ring-white":""])}," Easy ",10,U4),C("button",{onClick:H[1]||(H[1]=oe=>Te("hard")),disabled:a.value,class:ut(["px-4 py-2 rounded-full transition",a.value?"bg-gray-500 cursor-not-allowed":"bg-red-500 hover:bg-red-600 cursor-pointer",h.value==="hard"?"ring-2 ring-white":""])}," Hard ",10,B4)]),h.value==="easy"?(J(),Z("div",$4,[H[2]||(H[2]=C("h3",{class:"text-sm mb-2"},"Next Piece:",-1)),C("canvas",{ref_key:"previewCanvas",ref:s,width:"96",height:"96",class:"bg-gray-800 rounded border-2 border-gray-600"},null,512)])):Be("",!0),C("div",j4,[C("button",{onClick:it,class:ut(["flex-1 px-4 py-2 rounded-full transition cursor-pointer",a.value?"bg-blue-500 hover:bg-blue-600":"bg-green-500 hover:bg-green-600"])},ye(a.value?"Stop":"Start"),3),C("button",{onClick:Y,class:"flex-1 px-4 py-2 rounded-full bg-red-500 hover:bg-red-700 transition cursor-pointer"}," Close ")])])]))}},G4=Jt(H4,[["__scopeId","data-v-2d3c9205"]]),W4={class:"flex h-screen text-white font-sci-fi"},q4={class:"flex flex-col items-center justify-center flex-1"},z4={class:"text-lg mb-1"},K4={class:"w-full md:w-1/3 p-6 flex flex-col justify-center space-y-6 border-l border-white/10"},Q4={class:"flex gap-2"},Y4=["disabled"],J4=["disabled"],X4=["disabled"],Z4={class:"flex gap-4"},yt=25,eF=500,tF={__name:"Snake",setup(n){const e=Os(),t=ie(null),s=ie(null),r=eF/yt;let i=null;const o={easy:150,medium:120,hard:90},a=ie(o.medium),c=ie("medium"),u=ie([{x:5,y:5},{x:4,y:5},{x:3,y:5}]),h=ie({x:1,y:0}),d=ie({x:-1,y:-1,emoji:"🍎"}),p=ie(0),m=ie(!1),v=ie(!1),b=ie(!1),S=ie(!1),L=ie({x:1,y:0}),V=["🍇","🍈","🍉","🍊","🍋","🍋‍","🍌","🍍","🥭","🍎","🍏","🍐","🍑","🍒","🍓","🥝","🍅","🥥"],B=()=>{for(let _e=0;_e<r;_e++)for(let pe=0;pe<r;pe++)s.value.fillStyle=(pe+_e)%2===0?"#2e2e2e":"#1f1f1f",s.value.fillRect(pe*yt,_e*yt,yt,yt)},j=()=>{B(),v.value&&(s.value.font=`${yt}px Segoe UI Emoji, Apple Color Emoji, Noto Color Emoji`,s.value.textAlign="center",s.value.textBaseline="middle",s.value.fillText(d.value.emoji,d.value.x*yt+yt/2,d.value.y*yt+yt/2)),u.value.forEach((_e,pe)=>{s.value.beginPath();const ve=6,Te=pe===0,ot=pe===u.value.length-1;if(s.value.fillStyle=S.value?Te?"#700000":"#c30000":Te?"#009700":"lime",s.value.roundRect(_e.x*yt,_e.y*yt,yt,yt,Te||ot?ve:2),s.value.fill(),Te){const rt=yt/2,it=_e.x*yt+yt/2,x=_e.y*yt+yt/2;s.value.font=`bold ${rt}px Arial`,s.value.textAlign="center",s.value.textBaseline="middle",s.value.fillStyle=S.value?"black":"";const O=S.value?"XX":"👀";h.value.x===1?s.value.fillText(O,it+5,x):h.value.x===-1?s.value.fillText(O,it-5,x):h.value.y===-1?s.value.fillText(O,it,x-5):s.value.fillText(O,it,x+5)}})},fe=()=>{if(v.value)return;let _e,pe;do _e=Math.floor(Math.random()*r),pe=Math.floor(Math.random()*r);while(u.value.some(ve=>ve.x===_e&&ve.y===pe));d.value={x:_e,y:pe,emoji:V[Math.floor(Math.random()*V.length)]},v.value=!0},ue=_e=>{c.value=_e,a.value=o[_e],m.value&&(E(),A())},A=()=>{R(),i=setInterval(P,a.value),m.value=!0},E=()=>{clearInterval(i),T(),i=null,m.value=!1},I=()=>{m.value?E():A()},R=()=>{u.value=[{x:5,y:5},{x:4,y:5},{x:3,y:5}],L.value={x:1,y:0},h.value={x:1,y:0},p.value=0,b.value=!1,S.value=!1,v.value=!1,fe(),j()},P=()=>{h.value={...L.value};const _e={x:u.value[0].x+h.value.x,y:u.value[0].y+h.value.y};if(_e.x<0||_e.y<0||_e.x>=r||_e.y>=r||u.value.some(pe=>pe.x===_e.x&&pe.y===_e.y)){S.value=!0,j(),E();return}u.value.unshift(_e),_e.x===d.value.x&&_e.y===d.value.y?(p.value+=1,v.value=!1,fe(),b.value=!0,setTimeout(()=>b.value=!1,150)):u.value.pop(),j()},N=()=>{E(),e.push("/games")},T=()=>{Wr().currentUser&&ja("snake",p.value,c.value,!0)},Ye=_e=>{switch(_e.key){case"ArrowUp":case"w":case"W":case"ц":case"Ц":h.value.y===0&&(L.value={x:0,y:-1});break;case"ArrowDown":case"s":case"S":case"і":case"І":h.value.y===0&&(L.value={x:0,y:1});break;case"ArrowLeft":case"a":case"A":case"ф":case"Ф":h.value.x===0&&(L.value={x:-1,y:0});break;case"ArrowRight":case"d":case"D":case"в":case"В":h.value.x===0&&(L.value={x:1,y:0});break}};return Mn(()=>{s.value=t.value.getContext("2d"),j(),window.addEventListener("keydown",Ye)}),Od(()=>{E(),window.removeEventListener("keydown",Ye)}),(_e,pe)=>(J(),Z("div",W4,[C("div",q4,[C("div",z4,"Score: "+ye(p.value),1),C("canvas",{ref_key:"canvas",ref:t,width:"500",height:"500",class:ut(["bg-black border-4 rounded-lg transition-shadow duration-200",S.value?"border-red-500 shadow-[0_0_20px_#ff0000]":b.value?"border-blue-600 shadow-[0_0_20px_#0000FF]":"border-blue-800 "])},null,2)]),C("div",K4,[pe[3]||(pe[3]=C("h2",{class:"text-3xl font-bold"},"Snake Game",-1)),pe[4]||(pe[4]=C("p",{class:"text-sm"},[ht("By: "),C("span",{class:"text-orange-400"},"Yaroslav Labunskiy")],-1)),C("div",Q4,[C("button",{onClick:pe[0]||(pe[0]=ve=>ue("easy")),disabled:m.value,class:ut(["px-4 py-2 rounded-full transition",m.value?"bg-gray-500 cursor-not-allowed":"bg-blue-600 hover:bg-blue-700 cursor-pointer",c.value==="easy"?"ring-2 ring-white":""])}," Easy ",10,Y4),C("button",{onClick:pe[1]||(pe[1]=ve=>ue("medium")),disabled:m.value,class:ut(["px-4 py-2 rounded-full transition",m.value?"bg-gray-500 cursor-not-allowed":"bg-yellow-600 hover:bg-yellow-700 cursor-pointer",c.value==="medium"?"ring-2 ring-white":""])}," Medium ",10,J4),C("button",{onClick:pe[2]||(pe[2]=ve=>ue("hard")),disabled:m.value,class:ut(["px-4 py-2 rounded-full transition",m.value?"bg-gray-500 cursor-not-allowed":"bg-red-500 hover:bg-red-800 cursor-pointer",c.value==="hard"?"ring-2 ring-white":""])}," Hard ",10,X4)]),C("div",Z4,[C("button",{onClick:I,class:ut(["flex-1 px-4 py-2 rounded-full transition",m.value?"bg-blue-500 hover:bg-blue-600":"bg-green-500 hover:bg-green-600 cursor-pointer"])},ye(m.value?"Stop":"Start"),3),C("button",{onClick:N,class:"flex-1 px-4 py-2 rounded-full bg-red-500 hover:bg-red-700 transition cursor-pointer"}," Close ")])])]))}},nF={class:"flex h-screen font-sci-fi text-white bg-gray-900"},sF={class:"flex flex-col items-center justify-center flex-1"},rF={class:"text-lg mb-1"},iF={key:0,class:"mt-4 space-y-2"},oF={class:"w-full md:w-1/3 p-6 flex flex-col justify-center space-y-6 border-l border-white/10"},aF={class:"bg-white/10 rounded-lg p-4 space-y-2"},lF={class:"text-sm"},cF={class:"text-sm"},uF={class:"flex gap-2"},hF=["disabled"],dF=["disabled"],fF=["disabled"],pF={class:"flex gap-4"},Xt=600,gF={__name:"SpaceShooter",setup(n){const e=Os(),t=ie(null),s=ie(null),r={easy:{enemySpeed:2,spawnRate:.04,bulletSpeed:8},medium:{enemySpeed:3,spawnRate:.06,bulletSpeed:7},hard:{enemySpeed:4,spawnRate:.08,bulletSpeed:6}},i=ie({player:{x:Xt/2-15,y:Xt-60,width:30,height:40},bullets:[],enemies:[],keys:{},animationId:null,difficulty:r.medium,lastShotTime:0,shootInterval:150,isShooting:!1,gameOverTriggered:!1,stars:[],gameOverAnimation:{active:!1,startTime:0,duration:3e3,particles:[]}}),o=ie(0),a=ie(!1),c=ie("medium"),u=ie(!1),h=ie(!1),d=ie([]),p=ie({gamesPlayed:0,highScore:0,enemiesDestroyed:0,enemiesDestroyedThisGame:0,firstGameCompleted:!1,consecutiveWins:0,hardModeWins:0,perfectGames:0}),m=()=>{const x=[];for(let O=0;O<80;O++)x.push({x:Math.random()*Xt,y:Math.random()*Xt,size:Math.random()*2+.5,speed:Math.random()*.8+.3,brightness:Math.random()*.8+.2});i.value.stars=x},v=()=>{const x=[],O={x:i.value.player.x+i.value.player.width/2,y:i.value.player.y+i.value.player.height/2};for(let Q=0;Q<20;Q++)x.push({x:O.x,y:O.y,vx:(Math.random()-.5)*8,vy:(Math.random()-.5)*8,size:Math.random()*4+2,color:Math.random()>.5?"#ff4444":"#ffaa00",life:1});i.value.gameOverAnimation.particles=x},b=()=>{const x=s.value.createLinearGradient(0,0,0,Xt);x.addColorStop(0,"#0a0a2e"),x.addColorStop(.5,"#16213e"),x.addColorStop(1,"#0f0f23"),s.value.fillStyle=x,s.value.fillRect(0,0,Xt,Xt),s.value.save(),i.value.stars.forEach(O=>{s.value.fillStyle=`rgba(255, 255, 255, ${O.brightness})`,s.value.beginPath(),s.value.arc(O.x,O.y,O.size,0,Math.PI*2),s.value.fill(),O.y+=O.speed,O.y>Xt&&(O.y=-5,O.x=Math.random()*Xt)}),s.value.restore()},S=()=>{if(i.value.gameOverAnimation.active)return;const x=i.value.player;s.value.save(),s.value.translate(x.x+x.width/2,x.y+x.height/2);const O=s.value.createLinearGradient(0,-20,0,20);O.addColorStop(0,u.value?"#ff4444":"#FFFFFF"),O.addColorStop(1,u.value?"#aa0000":"#888888"),s.value.fillStyle=O,s.value.beginPath(),s.value.moveTo(0,-20),s.value.lineTo(-15,20),s.value.lineTo(-8,15),s.value.lineTo(8,15),s.value.lineTo(15,20),s.value.closePath(),s.value.fill(),s.value.strokeStyle=u.value?"#444444":"#110000",s.value.lineWidth=1,s.value.stroke(),s.value.fillStyle="#151515",s.value.beginPath(),s.value.arc(0,-4,5,0,Math.PI*2),s.value.fill(),s.value.fillStyle="#AAAAAA",s.value.strokeStyle="#000000",s.value.fillRect(-12,10,4,12),s.value.fillRect(8,10,4,12),a.value&&!u.value&&(s.value.fillStyle="#ffaa00",s.value.fillRect(-11,22,2,Math.random()*8+5),s.value.fillStyle="#ff6600",s.value.fillRect(9,22,2,Math.random()*8+5)),s.value.fillStyle="#AAAAAA",s.value.beginPath(),s.value.moveTo(-35,5),s.value.lineTo(-15,0),s.value.lineTo(-5,15),s.value.closePath(),s.value.fill(),s.value.beginPath(),s.value.moveTo(35,5),s.value.lineTo(15,0),s.value.lineTo(5,15),s.value.closePath(),s.value.fill(),s.value.fillStyle="#666666",s.value.fillRect(-25,-3,5,10),s.value.fillRect(20,-3,5,10),s.value.restore()},L=()=>{i.value.bullets.forEach(x=>{s.value.save();const O=s.value.createRadialGradient(x.x+x.width/2,x.y+x.height/2,0,x.x+x.width/2,x.y+x.height/2,8);O.addColorStop(0,"#ffff44"),O.addColorStop(.7,"#ffaa00"),O.addColorStop(1,"transparent"),s.value.fillStyle=O,s.value.fillRect(x.x-2,x.y-2,x.width+4,x.height+4),s.value.fillStyle="#ffff00",s.value.fillRect(x.x,x.y,x.width,x.height),s.value.fillStyle="#ffaa00",s.value.fillRect(x.x+.5,x.y+x.height,x.width-1,3),s.value.restore()})},V=()=>{i.value.enemies.forEach(x=>{s.value.save(),s.value.translate(x.x+x.width/2,x.y+x.height/2);const O=s.value.createLinearGradient(0,-15,0,15);x.type==="fast"?(O.addColorStop(0,"#ff0088"),O.addColorStop(1,"#aa0044")):(O.addColorStop(0,"#ff4444"),O.addColorStop(1,"#aa0000")),s.value.fillStyle=O,s.value.beginPath(),s.value.moveTo(0,15),s.value.lineTo(-12,-15),s.value.lineTo(-6,-10),s.value.lineTo(6,-10),s.value.lineTo(12,-15),s.value.closePath(),s.value.fill(),s.value.strokeStyle=x.type==="fast"?"#ffaaff":"#ffaaaa",s.value.lineWidth=1,s.value.stroke(),s.value.fillStyle="#ff6600",s.value.fillRect(-8,-18,3,8),s.value.fillRect(5,-18,3,8),s.value.fillStyle="#ffaa00",s.value.fillRect(-7.5,-10,2,Math.random()*4+2),s.value.fillRect(5.5,-10,2,Math.random()*4+2),x.type==="fast"&&x.health>1&&(s.value.strokeStyle="#ff00ff",s.value.lineWidth=2,s.value.beginPath(),s.value.arc(0,0,18,0,Math.PI*2),s.value.stroke()),s.value.restore()})},B=()=>{if(!i.value.gameOverAnimation.active)return;const O=Date.now()-i.value.gameOverAnimation.startTime,Q=Math.min(O/i.value.gameOverAnimation.duration,1);i.value.gameOverAnimation.particles.forEach(ce=>{ce.life<=0||(s.value.save(),ce.x+=ce.vx,ce.y+=ce.vy,ce.vy+=.2,ce.life-=.02,s.value.globalAlpha=ce.life,s.value.fillStyle=ce.color,s.value.beginPath(),s.value.arc(ce.x,ce.y,ce.size,0,Math.PI*2),s.value.fill(),s.value.restore())}),O>500&&(s.value.save(),s.value.restore()),Q>=1&&i.value.gameOverAnimation.particles.forEach(ce=>{ce.vx*=.95,ce.vy*=.95})},j=()=>{if(u.value)return;const x=i.value.player,O=i.value.keys;if((O.ArrowLeft||O.a||O.A||O.ф||O.Ф)&&(x.x=Math.max(0,x.x-5)),(O.ArrowRight||O.d||O.D||O.в||O.В)&&(x.x=Math.min(Xt-x.width,x.x+5)),i.value.isShooting){const Q=Date.now();Q-i.value.lastShotTime>i.value.shootInterval&&(P(),i.value.lastShotTime=Q)}},fe=()=>{i.value.bullets=i.value.bullets.filter(x=>(x.y-=i.value.difficulty.bulletSpeed,x.y>-x.height))},ue=()=>{if(Math.random()<i.value.difficulty.spawnRate){const x=Math.random()<.3?"fast":"normal";i.value.enemies.push({x:Math.random()*(Xt-25),y:-30,width:25,height:30,type:x,speed:x==="fast"?i.value.difficulty.enemySpeed*1.5:i.value.difficulty.enemySpeed,health:x==="fast"?2:1})}i.value.enemies=i.value.enemies.filter(x=>(x.y+=x.speed,x.y<Xt+x.height))},A=()=>{if(u.value||i.value.gameOverTriggered)return;for(let O=i.value.bullets.length-1;O>=0;O--){const Q=i.value.bullets[O];for(let ce=i.value.enemies.length-1;ce>=0;ce--){const he=i.value.enemies[ce];if(Q.x<he.x+he.width&&Q.x+Q.width>he.x&&Q.y<he.y+he.height&&Q.y+Q.height>he.y){i.value.bullets.splice(O,1),he.health--,he.health<=0&&(i.value.enemies.splice(ce,1),o.value+=he.type==="fast"?20:10,p.value.enemiesDestroyed++,p.value.enemiesDestroyedThisGame++),h.value=!0,setTimeout(()=>h.value=!1,150);break}}}const x=i.value.player;for(const O of i.value.enemies)if(x.x<O.x+O.width&&x.x+x.width>O.x&&x.y<O.y+O.height&&x.y+x.height>O.y){u.value=!0,E();return}},E=()=>{if(i.value.gameOverTriggered)return;i.value.gameOverTriggered=!0,i.value.gameOverAnimation.active=!0,i.value.gameOverAnimation.startTime=Date.now(),v(),p.value.gamesPlayed++,o.value>p.value.highScore&&(p.value.highScore=o.value),ot();const O=Wr().currentUser;O&&(I(O.uid,o.value,c.value),ja("spaceshooter",o.value,c.value,!0)),setTimeout(()=>{pe()},700)};async function I(x,O,Q){try{const ce=[];p.value.gamesPlayed===1&&await yn(x,"spaceshooter",_n.FIRST_GAME)&&ce.push({name:"Space Pilot"});const he=[{threshold:1e3,badges:{easy:_n.SCORE_1000_EASY,medium:_n.SCORE_1000_MEDIUM,hard:_n.SCORE_1000_HARD},names:{easy:"Rookie Scorer",medium:"Cadet Scorer",hard:"Veteran Scorer"}},{threshold:3e3,badges:{easy:_n.SCORE_3000_EASY,medium:_n.SCORE_3000_MEDIUM,hard:_n.SCORE_3000_HARD},names:{easy:"Elite Pilot",medium:"Ace Pilot",hard:"Commander"}},{threshold:5e3,badges:{easy:_n.SCORE_5000_EASY,medium:_n.SCORE_5000_MEDIUM,hard:_n.SCORE_5000_HARD},names:{easy:"Space Legend",medium:"Galaxy Hero",hard:"Universe Master"}}];for(const Y of he)O>=Y.threshold&&Y.badges[Q]&&await yn(x,"spaceshooter",Y.badges[Q])&&ce.push({name:Y.names[Q]});const M=p.value.enemiesDestroyedThisGame;M>=100&&await yn(x,"spaceshooter",_n.ENEMIES_100)&&ce.push({name:"Squadron Destroyer"}),M>=300&&await yn(x,"spaceshooter",_n.ENEMIES_300)&&ce.push({name:"Fleet Annihilator"}),ce.length>0&&(d.value=ce,setTimeout(()=>{d.value=[]},5e3))}catch(ce){console.error("Badge check failed:",ce)}}const R=()=>{!a.value&&!i.value.gameOverAnimation.active||(a.value&&(j(),fe(),ue(),A()),b(),S(),L(),V(),B(),i.value.animationId=requestAnimationFrame(R))},P=()=>{if(u.value)return;const x=i.value.player;i.value.bullets.push({x:x.x-8,y:x.y+5,width:3,height:12},{x:x.x+x.width+5,y:x.y+5,width:3,height:12})},N=x=>{i.value.keys[x.key]=!0,(x.key===" "||x.key==="Spacebar"||x.key==="ArrowUp"||x.key==="w"||x.key==="W"||x.key==="ц"||x.key==="Ц")&&(x.preventDefault(),i.value.isShooting||(i.value.isShooting=!0,P(),i.value.lastShotTime=Date.now()))},T=x=>{i.value.keys[x.key]=!1,(x.key===" "||x.key==="Spacebar"||x.key==="ArrowUp"||x.key==="w"||x.key==="W"||x.key==="ц"||x.key==="Ц")&&(x.preventDefault(),i.value.isShooting=!1,i.value.lastShotTime=0)},Ye=x=>{a.value||(c.value=x,i.value.difficulty=r[x])},_e=()=>{Te(),a.value=!0,R()},pe=()=>{a.value=!1,i.value.animationId&&cancelAnimationFrame(i.value.animationId)},ve=()=>{a.value?pe():_e()},Te=()=>{i.value.player={x:Xt/2-15,y:Xt-60,width:30,height:40},i.value.bullets=[],i.value.enemies=[],i.value.keys={},i.value.isShooting=!1,i.value.lastShotTime=0,i.value.gameOverAnimation.active=!1,i.value.gameOverAnimation.particles=[],i.value.gameOverTriggered=!1,o.value=0,u.value=!1,h.value=!1,p.value.enemiesDestroyedThisGame=0,b(),S()},ot=()=>{typeof window<"u"&&localStorage.setItem("spaceshooter_stats",JSON.stringify(p.value))},rt=()=>{const x=localStorage.getItem("spaceshooter_stats");x&&(p.value={...p.value,...JSON.parse(x)})},it=()=>{pe(),e.push("/games")};return Mn(()=>{s.value=t.value.getContext("2d"),m(),window.addEventListener("keydown",N),window.addEventListener("keyup",T),rt(),Te()}),Od(()=>{pe(),window.removeEventListener("keydown",N),window.removeEventListener("keyup",T),i.value.animationId&&cancelAnimationFrame(i.value.animationId)}),(x,O)=>(J(),Z("div",nF,[C("div",sF,[C("div",rF,"Score: "+ye(o.value),1),C("canvas",{ref_key:"canvas",ref:t,width:"600",height:"600",class:ut(["bg-black border-4 rounded-lg transition-shadow duration-200",u.value?"border-red-500 shadow-[0_0_20px_#ff0000]":h.value?"border-blue-600 shadow-[0_0_20px_#0000FF]":"border-blue-800"])},null,2),d.value.length>0?(J(),Z("div",iF,[(J(!0),Z(ft,null,kn(d.value,(Q,ce)=>(J(),Z("div",{key:ce,class:"bg-yellow-600 text-black px-4 py-2 rounded-lg animate-pulse"}," 🏆 Achievement Unlocked: "+ye(Q.name)+"! ",1))),128))])):Be("",!0)]),C("div",oF,[O[4]||(O[4]=C("h2",{class:"text-3xl font-bold"},"Space Shooter",-1)),O[5]||(O[5]=C("p",{class:"text-sm"},[ht("By: "),C("span",{class:"text-orange-400"},"Yaroslav Labunskiy")],-1)),C("div",aF,[O[3]||(O[3]=C("h3",{class:"text-lg font-bold"},"Game Stats",-1)),C("p",lF,"Games Played: "+ye(p.value.gamesPlayed),1),C("p",cF,"Enemies Destroyed: "+ye(p.value.enemiesDestroyed),1)]),C("div",uF,[C("button",{onClick:O[0]||(O[0]=Q=>Ye("easy")),disabled:a.value,class:ut(["px-4 py-2 rounded-full transition",a.value?"bg-gray-500 cursor-not-allowed":"bg-blue-600 hover:bg-blue-700 cursor-pointer",c.value==="easy"?"ring-2 ring-white":""])}," Easy ",10,hF),C("button",{onClick:O[1]||(O[1]=Q=>Ye("medium")),disabled:a.value,class:ut(["px-4 py-2 rounded-full transition",a.value?"bg-gray-500 cursor-not-allowed":"bg-yellow-600 hover:bg-yellow-700 cursor-pointer",c.value==="medium"?"ring-2 ring-white":""])}," Medium ",10,dF),C("button",{onClick:O[2]||(O[2]=Q=>Ye("hard")),disabled:a.value,class:ut(["px-4 py-2 rounded-full transition",a.value?"bg-gray-500 cursor-not-allowed":"bg-red-500 hover:bg-red-800 cursor-pointer",c.value==="hard"?"ring-2 ring-white":""])}," Hard ",10,fF)]),C("div",pF,[C("button",{onClick:ve,class:ut(["flex-1 px-4 py-2 rounded-full transition",a.value?"bg-blue-500 hover:bg-blue-600":"bg-green-500 hover:bg-green-600 cursor-pointer"])},ye(a.value?"Stop":"Start"),3),C("button",{onClick:it,class:"flex-1 px-4 py-2 rounded-full bg-red-500 hover:bg-red-700 transition cursor-pointer"}," Close ")]),O[6]||(O[6]=C("div",{class:"text-sm text-gray-300 space-y-2"},[C("h3",{class:"font-bold text-white"},"Game Rules:"),C("ul",{class:"space-y-1"},[C("li",null,"🚀 Move left-right with arrow keys or A/D"),C("li",null,"🔫 Shoot with SPACE (hold for auto-fire)"),C("li",null,"👾 Destroy enemies to earn points"),C("li",null,"💥 Avoid collisions with enemies"),C("li",null,"⚡ Fast enemies (purple) = +20 points (2 hits required)"),C("li",null,"🎯 Normal enemies = +10 points (1 hit required)")])],-1))])]))}},mF=Jt(gF,[["__scopeId","data-v-9676c89a"]]);let _F=new Promise(n=>{const e=qi(pn,()=>{e(),n()})});const XT=async()=>{await _F},rs=async(n,e,t)=>{await XT(),pn.currentUser?t():t("/login")},Ty=async(n,e,t)=>{await XT(),pn.currentUser?t("/profile"):t()},yF=[{path:"/",component:k2},{path:"/games",component:_L,beforeEnter:rs},{path:"/about",component:BL},{path:"/forum",component:XV},{path:"/login",component:H2,beforeEnter:Ty},{path:"/register",component:X2,beforeEnter:Ty},{path:"/profile",component:NL,beforeEnter:rs},{path:"/badges",component:eV,beforeEnter:rs},{path:"/records",component:CV,beforeEnter:rs},{path:"/games/minesweeper",component:w4,beforeEnter:rs},{path:"/games/candycrush",component:D4,beforeEnter:rs},{path:"/games/tetris",component:G4,beforeEnter:rs},{path:"/games/snake",component:tF,beforeEnter:rs},{path:"/games/spaceshooter",component:mF,beforeEnter:rs}],vF=i2({history:OM(),routes:yF}),Ep=HC(b2);Ep.use(vF);Ep.directive("click-outside",{beforeMount(n,e){n.clickOutsideEvent=t=>{n===t.target||n.contains(t.target)||e.value(t)},document.addEventListener("click",n.clickOutsideEvent)},unmounted(n){document.removeEventListener("click",n.clickOutsideEvent)}});Ep.mount("#app");
